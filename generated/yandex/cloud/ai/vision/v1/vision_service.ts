            ...
            switch (tag >>> 3) {
                ...
                case 3:
                    message.features.push(
                        Feature.decode(reader, reader.uint32())
                    );
                    break;
                case 4:
...
export const Feature = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): Feature {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    message.classificationConfig =
                        FeatureClassificationConfig.decode(
                            reader,
                            reader.uint32()
                        );
                    break;
                case 3:
                    message.textDetectionConfig =
                        FeatureTextDetectionConfig.decode(
                            reader,
                            reader.uint32()
                        );
                    break;
    ...
    fromJSON(object: any): Feature {
        ...
        if (
            ...
            message.classificationConfig = FeatureClassificationConfig.fromJSON(
                object.classificationConfig
            );
        } else {
        ...
        if (
            ...
            message.textDetectionConfig = FeatureTextDetectionConfig.fromJSON(
    ...
    toJSON(message: Feature): unknown {
        ...
        message.classificationConfig !== undefined &&
            (obj.classificationConfig = message.classificationConfig
                ? FeatureClassificationConfig.toJSON(
                      message.classificationConfig
                  )
                : undefined);
        message.textDetectionConfig !== undefined &&
    ...
    fromPartial(object: DeepPartial<Feature>): Feature {
        ...
        if (
            ...
            message.classificationConfig =
                FeatureClassificationConfig.fromPartial(
                    object.classificationConfig
                );
        } else {
            message.classificationConfig = undefined;
        ...
        if (
            ...
            message.textDetectionConfig =
                FeatureTextDetectionConfig.fromPartial(
                    object.textDetectionConfig
                );
        } else {
            message.textDetectionConfig = undefined;
...
export const FeatureClassificationConfig = {
    ...
    fromPartial(
        object: DeepPartial<FeatureClassificationConfig>
    ): FeatureClassificationConfig {
        const message = {
            ...baseFeatureClassificationConfig,
        } as FeatureClassificationConfig;
...
export const FeatureTextDetectionConfig = {
    ...
    fromJSON(object: any): FeatureTextDetectionConfig {
        ...
        message.languageCodes = [];
        if (
            object.languageCodes !== undefined &&
    ...
    fromPartial(
        object: DeepPartial<FeatureTextDetectionConfig>
    ): FeatureTextDetectionConfig {
        const message = {
            ...baseFeatureTextDetectionConfig,
        } as FeatureTextDetectionConfig;
...
export const BatchAnalyzeResponse = {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.results.push(
                        AnalyzeResult.decode(reader, reader.uint32())
                    );
                    break;
                default:
                    reader.skipType(tag & 7);
    ...
    fromPartial(
        object: DeepPartial<BatchAnalyzeResponse>
    ): BatchAnalyzeResponse {
        const message = { ...baseBatchAnalyzeResponse } as BatchAnalyzeResponse;
        message.results = [];
        if (object.results !== undefined && object.results !== null) {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): AnalyzeResult {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 2:
                    message.results.push(
                        FeatureResult.decode(reader, reader.uint32())
                    );
                    break;
                case 1:
...
export const FeatureResult = {
    ...
    fromJSON(object: any): FeatureResult {
        const message = { ...baseFeatureResult } as FeatureResult;
        if (
            object.textDetection !== undefined &&
            object.textDetection !== null
        ) {
            message.textDetection = TextAnnotation.fromJSON(
        ...
        if (
            ...
            message.classification = ClassAnnotation.fromJSON(
        ...
        if (
            object.faceDetection !== undefined &&
            object.faceDetection !== null
        ) {
            message.faceDetection = FaceAnnotation.fromJSON(
        ...
        if (
            object.imageCopySearch !== undefined &&
            object.imageCopySearch !== null
        ) {
            message.imageCopySearch = ImageCopySearchAnnotation.fromJSON(
                object.imageCopySearch
            );
        } else {
    ...
    fromPartial(object: DeepPartial<FeatureResult>): FeatureResult {
        ...
        if (
            ...
            message.textDetection = TextAnnotation.fromPartial(
                object.textDetection
            );
        } else {
            message.textDetection = undefined;
        ...
        if (
            ...
            message.classification = ClassAnnotation.fromPartial(
                object.classification
            );
        } else {
            message.classification = undefined;
        ...
        if (
            ...
            message.faceDetection = FaceAnnotation.fromPartial(
                object.faceDetection
            );
        } else {
            message.faceDetection = undefined;
        ...
        if (
            ...
            message.imageCopySearch = ImageCopySearchAnnotation.fromPartial(
                object.imageCopySearch
            );
        } else {
            message.imageCopySearch = undefined;
