...
export const ListHostTypesRequest = {
    ...
    fromPartial(
        object: DeepPartial<ListHostTypesRequest>
    ): ListHostTypesRequest {
        const message = { ...baseListHostTypesRequest } as ListHostTypesRequest;
        if (object.pageSize !== undefined && object.pageSize !== null) {
...
export const ListHostTypesResponse = {
    ...
    decode(
        ...
        } as ListHostTypesResponse;
        message.hostTypes = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
                    message.hostTypes.push(
                        HostType.decode(reader, reader.uint32())
                    );
                    break;
                case 2:
    ...
    toJSON(message: ListHostTypesResponse): unknown {
        ...
        if (message.hostTypes) {
            obj.hostTypes = message.hostTypes.map((e) =>
                e ? HostType.toJSON(e) : undefined
            );
        } else {
            obj.hostTypes = [];
        }
    ...
    fromPartial(
        object: DeepPartial<ListHostTypesResponse>
    ): ListHostTypesResponse {
        const message = {
            ...baseListHostTypesResponse,
        } as ListHostTypesResponse;
...
export const HostTypeServiceService = {
    ...
    get: {
        ...
        responseSerialize: (value: HostType) =>
            Buffer.from(HostType.encode(value).finish()),
...
export interface HostTypeServiceClient extends Client {
    ...
    list(
        ...
        callback: (
            ...
            response: ListHostTypesResponse
        ) => void
    ): ClientUnaryCall;
    list(
        request: ListHostTypesRequest,
