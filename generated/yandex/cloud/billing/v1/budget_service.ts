...
export const ListBudgetsResponse = {
    ...
    decode(
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.budgets.push(
                        Budget.decode(reader, reader.uint32())
                    );
                    break;
                case 2:
    ...
    toJSON(message: ListBudgetsResponse): unknown {
        const obj: any = {};
        if (message.budgets) {
            obj.budgets = message.budgets.map((e) =>
                e ? Budget.toJSON(e) : undefined
            );
        } else {
            obj.budgets = [];
        }
...
export const CreateBudgetRequest = {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    message.costBudgetSpec = CostBudgetSpec.decode(
                        reader,
                        reader.uint32()
                    );
                    break;
                case 4:
                    message.expenseBudgetSpec = ExpenseBudgetSpec.decode(
                        reader,
                        reader.uint32()
                    );
                    break;
                case 5:
                    message.balanceBudgetSpec = BalanceBudgetSpec.decode(
                        reader,
                        reader.uint32()
                    );
                    break;
    ...
    fromJSON(object: any): CreateBudgetRequest {
        ...
        if (
            object.costBudgetSpec !== undefined &&
            object.costBudgetSpec !== null
        ) {
            message.costBudgetSpec = CostBudgetSpec.fromJSON(
                object.costBudgetSpec
            );
        } else {
        ...
        if (
            ...
            message.expenseBudgetSpec = ExpenseBudgetSpec.fromJSON(
                object.expenseBudgetSpec
            );
        } else {
        ...
        if (
            ...
            message.balanceBudgetSpec = BalanceBudgetSpec.fromJSON(
                object.balanceBudgetSpec
            );
        } else {
    ...
    fromPartial(object: DeepPartial<CreateBudgetRequest>): CreateBudgetRequest {
        ...
        if (
            ...
            message.costBudgetSpec = CostBudgetSpec.fromPartial(
                object.costBudgetSpec
            );
        } else {
            message.costBudgetSpec = undefined;
        ...
        if (
            ...
            message.expenseBudgetSpec = ExpenseBudgetSpec.fromPartial(
                object.expenseBudgetSpec
            );
        } else {
            message.expenseBudgetSpec = undefined;
        ...
        if (
            ...
            message.balanceBudgetSpec = BalanceBudgetSpec.fromPartial(
                object.balanceBudgetSpec
            );
        } else {
            message.balanceBudgetSpec = undefined;
...
export const CreateBudgetMetadata = {
    ...
    fromPartial(
        object: DeepPartial<CreateBudgetMetadata>
    ): CreateBudgetMetadata {
        const message = { ...baseCreateBudgetMetadata } as CreateBudgetMetadata;
        if (object.budgetId !== undefined && object.budgetId !== null) {
...
export const BudgetServiceService = {
    ...
    get: {
        ...
        responseSerialize: (value: Budget) =>
            Buffer.from(Budget.encode(value).finish()),
    ...
    list: {
        ...
        responseDeserialize: (value: Buffer) =>
            ListBudgetsResponse.decode(value),
    },
    ...
    create: {
        ...
        requestDeserialize: (value: Buffer) =>
            CreateBudgetRequest.decode(value),
