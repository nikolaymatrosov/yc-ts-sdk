...
import { ResourcePreset } from '../../../../../yandex/cloud/mdb/clickhouse/v1/resource_preset';
import {
...
export interface GetResourcePresetRequest {
    $type: 'yandex.cloud.mdb.clickhouse.v1.GetResourcePresetRequest';
    /**
...
export interface ListResourcePresetsRequest {
    $type: 'yandex.cloud.mdb.clickhouse.v1.ListResourcePresetsRequest';
    /**
...
export interface ListResourcePresetsResponse {
    $type: 'yandex.cloud.mdb.clickhouse.v1.ListResourcePresetsResponse';
...
export const GetResourcePresetRequest = {
    $type: 'yandex.cloud.mdb.clickhouse.v1.GetResourcePresetRequest' as const,
...
export const ListResourcePresetsRequest = {
    $type: 'yandex.cloud.mdb.clickhouse.v1.ListResourcePresetsRequest' as const,
...
export const ListResourcePresetsResponse = {
    $type: 'yandex.cloud.mdb.clickhouse.v1.ListResourcePresetsResponse' as const,
