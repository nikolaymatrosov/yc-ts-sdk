...
export const GetBackupRequest = {
    $type: 'yandex.cloud.mdb.clickhouse.v1.GetBackupRequest' as const,
...
export const ListBackupsRequest = {
    $type: 'yandex.cloud.mdb.clickhouse.v1.ListBackupsRequest' as const,
...
export const ListBackupsResponse = {
    $type: 'yandex.cloud.mdb.clickhouse.v1.ListBackupsResponse' as const,
