...
export const ClusterConfig = {
    ...
    fromJSON(object: any): ClusterConfig {
        ...
        if (object.clickhouse !== undefined && object.clickhouse !== null) {
            message.clickhouse = ClusterConfig_Clickhouse.fromJSON(
                object.clickhouse
            );
        } else {
        ...
        if (object.zookeeper !== undefined && object.zookeeper !== null) {
            message.zookeeper = ClusterConfig_Zookeeper.fromJSON(
                object.zookeeper
            );
        } else {
    ...
    fromPartial(object: DeepPartial<ClusterConfig>): ClusterConfig {
        ...
        if (object.clickhouse !== undefined && object.clickhouse !== null) {
            message.clickhouse = ClusterConfig_Clickhouse.fromPartial(
                object.clickhouse
            );
        } else {
            message.clickhouse = undefined;
        ...
        if (object.zookeeper !== undefined && object.zookeeper !== null) {
            message.zookeeper = ClusterConfig_Zookeeper.fromPartial(
                object.zookeeper
            );
        } else {
            message.zookeeper = undefined;
...
export const ClusterConfig_Clickhouse = {
    ...
    decode(
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.config = ClickhouseConfigSet.decode(
                        reader,
                        reader.uint32()
                    );
                    break;
    ...
    fromJSON(object: any): ClusterConfig_Clickhouse {
        ...
        if (object.config !== undefined && object.config !== null) {
            message.config = ClickhouseConfigSet.fromJSON(object.config);
        } else {
            message.config = undefined;
        }
    ...
    fromPartial(
        object: DeepPartial<ClusterConfig_Clickhouse>
    ): ClusterConfig_Clickhouse {
        const message = {
            ...baseClusterConfig_Clickhouse,
        } as ClusterConfig_Clickhouse;
        if (object.config !== undefined && object.config !== null) {
            message.config = ClickhouseConfigSet.fromPartial(object.config);
        } else {
            message.config = undefined;
        }
        if (object.resources !== undefined && object.resources !== null) {
...
export const ClusterConfig_Zookeeper = {
    ...
    fromPartial(
        object: DeepPartial<ClusterConfig_Zookeeper>
    ): ClusterConfig_Zookeeper {
        const message = {
            ...baseClusterConfig_Zookeeper,
        } as ClusterConfig_Zookeeper;
...
export const Shard = {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    message.config = ShardConfig.decode(
                        reader,
                        reader.uint32()
                    );
                    break;
    ...
    fromJSON(object: any): Shard {
        ...
        if (object.config !== undefined && object.config !== null) {
            message.config = ShardConfig.fromJSON(object.config);
        } else {
            message.config = undefined;
        }
        return message;
    ...
    fromPartial(object: DeepPartial<Shard>): Shard {
        ...
        if (object.config !== undefined && object.config !== null) {
            message.config = ShardConfig.fromPartial(object.config);
        } else {
            message.config = undefined;
        }
        return message;
...
export const ShardConfig = {
    ...
    fromJSON(object: any): ShardConfig {
        const message = { ...baseShardConfig } as ShardConfig;
        if (object.clickhouse !== undefined && object.clickhouse !== null) {
            message.clickhouse = ShardConfig_Clickhouse.fromJSON(
                object.clickhouse
            );
        } else {
            message.clickhouse = undefined;
    ...
    fromPartial(object: DeepPartial<ShardConfig>): ShardConfig {
        const message = { ...baseShardConfig } as ShardConfig;
        if (object.clickhouse !== undefined && object.clickhouse !== null) {
            message.clickhouse = ShardConfig_Clickhouse.fromPartial(
                object.clickhouse
            );
        } else {
            message.clickhouse = undefined;
...
export const ShardConfig_Clickhouse = {
    ...
    fromPartial(
        object: DeepPartial<ShardConfig_Clickhouse>
    ): ShardConfig_Clickhouse {
        const message = {
            ...baseShardConfig_Clickhouse,
        } as ShardConfig_Clickhouse;
