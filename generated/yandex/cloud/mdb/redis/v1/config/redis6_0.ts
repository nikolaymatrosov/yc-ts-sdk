...
export function redisconfig60_MaxmemoryPolicyFromJSON(
    object: any
): Redisconfig60_MaxmemoryPolicy {
    switch (object) {
        case 0:
...
export function redisconfig60_MaxmemoryPolicyToJSON(
    object: Redisconfig60_MaxmemoryPolicy
): string {
    switch (object) {
...
export const Redisconfig60 = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): Redisconfig60 {
        ...
        const message = { ...baseRedisconfig60 } as Redisconfig60;
    ...
    fromJSON(object: any): Redisconfig60 {
        ...
        if (
            ...
            message.maxmemoryPolicy = redisconfig60_MaxmemoryPolicyFromJSON(
    ...
    toJSON(message: Redisconfig60): unknown {
        ...
        message.maxmemoryPolicy !== undefined &&
            (obj.maxmemoryPolicy = redisconfig60_MaxmemoryPolicyToJSON(
...
export const Redisconfigset60 = {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number): Redisconfigset60 {
        const reader =
            input instanceof _m0.Reader ? input : new _m0.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseRedisconfigset60 } as Redisconfigset60;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
                    message.effectiveConfig = Redisconfig60.decode(
                        reader,
                        reader.uint32()
                    );
                    break;
                case 2:
                    message.userConfig = Redisconfig60.decode(
                        reader,
                        reader.uint32()
                    );
                    break;
                case 3:
                    message.defaultConfig = Redisconfig60.decode(
                        reader,
                        reader.uint32()
                    );
                    break;
    ...
    fromJSON(object: any): Redisconfigset60 {
        ...
        if (
            ...
            message.effectiveConfig = Redisconfig60.fromJSON(
        ...
        if (
            ...
            message.defaultConfig = Redisconfig60.fromJSON(
    ...
    fromPartial(object: DeepPartial<Redisconfigset60>): Redisconfigset60 {
        ...
        if (
            ...
            message.effectiveConfig = Redisconfig60.fromPartial(
                object.effectiveConfig
            );
        } else {
            message.effectiveConfig = undefined;
        ...
        if (
            ...
            message.defaultConfig = Redisconfig60.fromPartial(
                object.defaultConfig
            );
        } else {
            message.defaultConfig = undefined;
