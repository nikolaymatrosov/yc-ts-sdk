...
export interface GetBackupRequest {
    $type: 'yandex.cloud.mdb.redis.v1.GetBackupRequest';
    /**
...
export interface ListBackupsRequest {
    $type: 'yandex.cloud.mdb.redis.v1.ListBackupsRequest';
    /**
...
export interface ListBackupsResponse {
    $type: 'yandex.cloud.mdb.redis.v1.ListBackupsResponse';
...
export const GetBackupRequest = {
    $type: 'yandex.cloud.mdb.redis.v1.GetBackupRequest' as const,
...
export const ListBackupsRequest = {
    $type: 'yandex.cloud.mdb.redis.v1.ListBackupsRequest' as const,
...
export const ListBackupsResponse = {
    $type: 'yandex.cloud.mdb.redis.v1.ListBackupsResponse' as const,
