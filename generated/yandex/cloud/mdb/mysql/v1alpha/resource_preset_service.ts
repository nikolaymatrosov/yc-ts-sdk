...
import { ResourcePreset } from '../../../../../yandex/cloud/mdb/mysql/v1alpha/resource_preset';
import {
...
export const GetResourcePresetRequest = {
    $type: 'yandex.cloud.mdb.mysql.v1alpha.GetResourcePresetRequest' as const,
...
export const ListResourcePresetsRequest = {
    $type: 'yandex.cloud.mdb.mysql.v1alpha.ListResourcePresetsRequest' as const,
...
export const ListResourcePresetsResponse = {
    $type: 'yandex.cloud.mdb.mysql.v1alpha.ListResourcePresetsResponse' as const,
