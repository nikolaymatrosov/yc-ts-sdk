...
export const GetResourcePresetRequest = {
    $type: 'yandex.cloud.mdb.mysql.v1.GetResourcePresetRequest' as const,
...
export const ListResourcePresetsRequest = {
    $type: 'yandex.cloud.mdb.mysql.v1.ListResourcePresetsRequest' as const,
...
export const ListResourcePresetsResponse = {
    $type: 'yandex.cloud.mdb.mysql.v1.ListResourcePresetsResponse' as const,
