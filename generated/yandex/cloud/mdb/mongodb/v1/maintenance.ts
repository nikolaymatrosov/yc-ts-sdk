...
export const MaintenanceWindow = {
    $type: 'yandex.cloud.mdb.mongodb.v1.MaintenanceWindow' as const,
...
export const AnytimeMaintenanceWindow = {
    $type: 'yandex.cloud.mdb.mongodb.v1.AnytimeMaintenanceWindow' as const,
...
export const WeeklyMaintenanceWindow = {
    $type: 'yandex.cloud.mdb.mongodb.v1.WeeklyMaintenanceWindow' as const,
...
export const MaintenanceOperation = {
    $type: 'yandex.cloud.mdb.mongodb.v1.MaintenanceOperation' as const,
