...
export function postgresqlhostconfig111c_ConstraintExclusionFromJSON(
    object: any
): Postgresqlhostconfig111c_ConstraintExclusion {
    switch (object) {
        case 0:
...
export function postgresqlhostconfig111c_ConstraintExclusionToJSON(
    object: Postgresqlhostconfig111c_ConstraintExclusion
): string {
    switch (object) {
...
export function postgresqlhostconfig111c_ForceParallelModeFromJSON(
    object: any
): Postgresqlhostconfig111c_ForceParallelMode {
    switch (object) {
        case 0:
...
export function postgresqlhostconfig111c_ForceParallelModeToJSON(
    object: Postgresqlhostconfig111c_ForceParallelMode
): string {
    switch (object) {
...
export function postgresqlhostconfig111c_LogLevelFromJSON(
    object: any
): Postgresqlhostconfig111c_LogLevel {
    switch (object) {
        case 0:
...
export function postgresqlhostconfig111c_LogLevelToJSON(
    object: Postgresqlhostconfig111c_LogLevel
): string {
    switch (object) {
...
export function postgresqlhostconfig111c_LogErrorVerbosityFromJSON(
    object: any
): Postgresqlhostconfig111c_LogErrorVerbosity {
    switch (object) {
        case 0:
...
export function postgresqlhostconfig111c_LogErrorVerbosityToJSON(
    object: Postgresqlhostconfig111c_LogErrorVerbosity
): string {
    switch (object) {
...
export function postgresqlhostconfig111c_LogStatementFromJSON(
    object: any
): Postgresqlhostconfig111c_LogStatement {
    switch (object) {
        case 0:
...
export function postgresqlhostconfig111c_LogStatementToJSON(
    object: Postgresqlhostconfig111c_LogStatement
): string {
    switch (object) {
...
export function postgresqlhostconfig111c_TransactionIsolationFromJSON(
    object: any
): Postgresqlhostconfig111c_TransactionIsolation {
    switch (object) {
        case 0:
...
export function postgresqlhostconfig111c_TransactionIsolationToJSON(
    object: Postgresqlhostconfig111c_TransactionIsolation
): string {
    switch (object) {
...
export function postgresqlhostconfig111c_ByteaOutputFromJSON(
    object: any
): Postgresqlhostconfig111c_ByteaOutput {
    switch (object) {
        case 0:
...
export function postgresqlhostconfig111c_ByteaOutputToJSON(
...
export function postgresqlhostconfig111c_XmlBinaryFromJSON(
    object: any
): Postgresqlhostconfig111c_XmlBinary {
    switch (object) {
        case 0:
...
export function postgresqlhostconfig111c_XmlBinaryToJSON(
    object: Postgresqlhostconfig111c_XmlBinary
): string {
    switch (object) {
...
export function postgresqlhostconfig111c_XmlOptionFromJSON(
    object: any
): Postgresqlhostconfig111c_XmlOption {
    switch (object) {
        case 0:
...
export function postgresqlhostconfig111c_XmlOptionToJSON(
    object: Postgresqlhostconfig111c_XmlOption
): string {
    switch (object) {
...
export function postgresqlhostconfig111c_BackslashQuoteFromJSON(
    object: any
): Postgresqlhostconfig111c_BackslashQuote {
    switch (object) {
        case 0:
...
export function postgresqlhostconfig111c_BackslashQuoteToJSON(
    object: Postgresqlhostconfig111c_BackslashQuote
): string {
    switch (object) {
...
const basePostgresqlhostconfig111c: object = {
    $type: 'yandex.cloud.mdb.postgresql.v1.config.PostgresqlHostConfig11_1C',
...
export const Postgresqlhostconfig111c = {
    $type: 'yandex.cloud.mdb.postgresql.v1.config.PostgresqlHostConfig11_1C' as const,
    ...
    fromJSON(object: any): Postgresqlhostconfig111c {
        ...
        if (
            ...
            message.constraintExclusion =
                postgresqlhostconfig111c_ConstraintExclusionFromJSON(
        ...
        if (
            ...
            message.forceParallelMode =
                postgresqlhostconfig111c_ForceParallelModeFromJSON(
        ...
        if (
            ...
            message.clientMinMessages =
                postgresqlhostconfig111c_LogLevelFromJSON(
        ...
        if (
            ...
            message.logMinMessages = postgresqlhostconfig111c_LogLevelFromJSON(
        ...
        if (
            ...
            message.logErrorVerbosity =
                postgresqlhostconfig111c_LogErrorVerbosityFromJSON(
        ...
        if (object.logStatement !== undefined && object.logStatement !== null) {
            message.logStatement =
                postgresqlhostconfig111c_LogStatementFromJSON(
                    object.logStatement
                );
        } else {
        ...
        if (
            ...
            message.defaultTransactionIsolation =
                postgresqlhostconfig111c_TransactionIsolationFromJSON(
        ...
        if (object.byteaOutput !== undefined && object.byteaOutput !== null) {
            message.byteaOutput = postgresqlhostconfig111c_ByteaOutputFromJSON(
                object.byteaOutput
            );
        } else {
        ...
        if (object.xmlbinary !== undefined && object.xmlbinary !== null) {
            message.xmlbinary = postgresqlhostconfig111c_XmlBinaryFromJSON(
                object.xmlbinary
            );
        } else {
            message.xmlbinary = 0;
        ...
        if (object.xmloption !== undefined && object.xmloption !== null) {
            message.xmloption = postgresqlhostconfig111c_XmlOptionFromJSON(
                object.xmloption
            );
        } else {
            message.xmloption = 0;
        ...
        if (
            ...
            message.backslashQuote =
                postgresqlhostconfig111c_BackslashQuoteFromJSON(
    ...
    toJSON(message: Postgresqlhostconfig111c): unknown {
        ...
        message.forceParallelMode !== undefined &&
            (obj.forceParallelMode =
                postgresqlhostconfig111c_ForceParallelModeToJSON(
                    message.forceParallelMode
                ));
        message.clientMinMessages !== undefined &&
            (obj.clientMinMessages = postgresqlhostconfig111c_LogLevelToJSON(
                message.clientMinMessages
            ));
        message.logMinMessages !== undefined &&
            (obj.logMinMessages = postgresqlhostconfig111c_LogLevelToJSON(
                message.logMinMessages
            ));
        message.logMinErrorStatement !== undefined &&
            (obj.logMinErrorStatement = postgresqlhostconfig111c_LogLevelToJSON(
                message.logMinErrorStatement
            ));
        message.logMinDurationStatement !== undefined &&
        ...
        message.logErrorVerbosity !== undefined &&
            (obj.logErrorVerbosity =
                postgresqlhostconfig111c_LogErrorVerbosityToJSON(
                    message.logErrorVerbosity
                ));
        message.logLockWaits !== undefined &&
            (obj.logLockWaits = message.logLockWaits);
        message.logStatement !== undefined &&
            (obj.logStatement = postgresqlhostconfig111c_LogStatementToJSON(
                message.logStatement
            ));
        message.logTempFiles !== undefined &&
        ...
        message.defaultTransactionIsolation !== undefined &&
            (obj.defaultTransactionIsolation =
                postgresqlhostconfig111c_TransactionIsolationToJSON(
                    message.defaultTransactionIsolation
                ));
        message.statementTimeout !== undefined &&
        ...
        message.byteaOutput !== undefined &&
            (obj.byteaOutput = postgresqlhostconfig111c_ByteaOutputToJSON(
                message.byteaOutput
            ));
        message.xmlbinary !== undefined &&
            (obj.xmlbinary = postgresqlhostconfig111c_XmlBinaryToJSON(
                message.xmlbinary
            ));
        message.xmloption !== undefined &&
            (obj.xmloption = postgresqlhostconfig111c_XmlOptionToJSON(
                message.xmloption
            ));
        message.ginPendingListLimit !== undefined &&
        ...
        message.backslashQuote !== undefined &&
            (obj.backslashQuote = postgresqlhostconfig111c_BackslashQuoteToJSON(
                message.backslashQuote
            ));
        message.defaultWithOids !== undefined &&
    ...
    fromPartial(
        object: DeepPartial<Postgresqlhostconfig111c>
    ): Postgresqlhostconfig111c {
        const message = {
            ...basePostgresqlhostconfig111c,
        } as Postgresqlhostconfig111c;
