...
export const Postgresqlconfig101c = {
    ...
    fromJSON(object: any): Postgresqlconfig101c {
        ...
        if (object.walLevel !== undefined && object.walLevel !== null) {
            message.walLevel = postgresqlconfig101c_WalLevelFromJSON(
                object.walLevel
            );
        } else {
            message.walLevel = 0;
        ...
        if (
            ...
            message.clientMinMessages = postgresqlconfig101c_LogLevelFromJSON(
        ...
        if (
            ...
            message.logMinMessages = postgresqlconfig101c_LogLevelFromJSON(
        ...
        if (
            ...
            message.logMinErrorStatement =
                postgresqlconfig101c_LogLevelFromJSON(
        ...
        if (object.logStatement !== undefined && object.logStatement !== null) {
            message.logStatement = postgresqlconfig101c_LogStatementFromJSON(
                object.logStatement
            );
        } else {
        ...
        if (object.byteaOutput !== undefined && object.byteaOutput !== null) {
            message.byteaOutput = postgresqlconfig101c_ByteaOutputFromJSON(
                object.byteaOutput
            );
        } else {
        ...
        if (object.xmlbinary !== undefined && object.xmlbinary !== null) {
            message.xmlbinary = postgresqlconfig101c_XmlBinaryFromJSON(
                object.xmlbinary
            );
        } else {
            message.xmlbinary = 0;
        ...
        if (object.xmloption !== undefined && object.xmloption !== null) {
            message.xmloption = postgresqlconfig101c_XmlOptionFromJSON(
                object.xmloption
            );
        } else {
            message.xmloption = 0;
        ...
        if (
            ...
            message.backslashQuote =
                postgresqlconfig101c_BackslashQuoteFromJSON(
        ...
        if (
            ...
            for (const e of object.sharedPreloadLibraries) {
                message.sharedPreloadLibraries.push(
                    postgresqlconfig101c_SharedPreloadLibrariesFromJSON(e)
                );
            }
        }
        if (
        ...
        if (
            ...
            message.plantunerFixEmptyTable = Boolean(
                object.plantunerFixEmptyTable
            );
        } else {
    ...
    toJSON(message: Postgresqlconfig101c): unknown {
        ...
        message.walLevel !== undefined &&
            (obj.walLevel = postgresqlconfig101c_WalLevelToJSON(
                message.walLevel
            ));
        message.synchronousCommit !== undefined &&
            (obj.synchronousCommit =
                postgresqlconfig101c_SynchronousCommitToJSON(
                    message.synchronousCommit
                ));
        message.checkpointTimeout !== undefined &&
        ...
        message.constraintExclusion !== undefined &&
            (obj.constraintExclusion =
                postgresqlconfig101c_ConstraintExclusionToJSON(
                    message.constraintExclusion
                ));
        message.cursorTupleFraction !== undefined &&
        ...
        message.forceParallelMode !== undefined &&
            (obj.forceParallelMode =
                postgresqlconfig101c_ForceParallelModeToJSON(
                    message.forceParallelMode
                ));
        ...
        message.logErrorVerbosity !== undefined &&
            (obj.logErrorVerbosity =
                postgresqlconfig101c_LogErrorVerbosityToJSON(
                    message.logErrorVerbosity
                ));
        message.logLockWaits !== undefined &&
        ...
        message.xmlbinary !== undefined &&
            (obj.xmlbinary = postgresqlconfig101c_XmlBinaryToJSON(
                message.xmlbinary
            ));
        message.xmloption !== undefined &&
            (obj.xmloption = postgresqlconfig101c_XmlOptionToJSON(
                message.xmloption
            ));
        message.ginPendingListLimit !== undefined &&
        ...
        if (message.sharedPreloadLibraries) {
            obj.sharedPreloadLibraries = message.sharedPreloadLibraries.map(
                (e) => postgresqlconfig101c_SharedPreloadLibrariesToJSON(e)
            );
        } else {
    ...
    fromPartial(
        object: DeepPartial<Postgresqlconfig101c>
    ): Postgresqlconfig101c {
        const message = { ...basePostgresqlconfig101c } as Postgresqlconfig101c;
        message.sharedPreloadLibraries = [];
        if (
...
export const Postgresqlconfigset101c = {
    ...
    fromJSON(object: any): Postgresqlconfigset101c {
        ...
        if (
            ...
            message.effectiveConfig = Postgresqlconfig101c.fromJSON(
        ...
        if (object.userConfig !== undefined && object.userConfig !== null) {
            message.userConfig = Postgresqlconfig101c.fromJSON(
                object.userConfig
            );
        } else {
        ...
        if (
            ...
            message.defaultConfig = Postgresqlconfig101c.fromJSON(
    ...
    fromPartial(
        object: DeepPartial<Postgresqlconfigset101c>
    ): Postgresqlconfigset101c {
        const message = {
            ...basePostgresqlconfigset101c,
        } as Postgresqlconfigset101c;
        if (
            ...
            message.effectiveConfig = Postgresqlconfig101c.fromPartial(
                object.effectiveConfig
            );
        } else {
            message.effectiveConfig = undefined;
        ...
        if (object.userConfig !== undefined && object.userConfig !== null) {
            message.userConfig = Postgresqlconfig101c.fromPartial(
                object.userConfig
            );
        } else {
            message.userConfig = undefined;
        ...
        if (
            ...
            message.defaultConfig = Postgresqlconfig101c.fromPartial(
                object.defaultConfig
            );
        } else {
            message.defaultConfig = undefined;
