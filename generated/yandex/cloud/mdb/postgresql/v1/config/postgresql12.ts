...
export const PostgresqlConfig12 = {
    ...
    fromJSON(object: any): PostgresqlConfig12 {
        ...
        if (object.walLevel !== undefined && object.walLevel !== null) {
            message.walLevel = postgresqlConfig12_WalLevelFromJSON(
                object.walLevel
            );
        } else {
            message.walLevel = 0;
        ...
        if (
            ...
            message.synchronousCommit =
                postgresqlConfig12_SynchronousCommitFromJSON(
        ...
        if (
            ...
            message.forceParallelMode =
                postgresqlConfig12_ForceParallelModeFromJSON(
        ...
        if (
            ...
            message.clientMinMessages = postgresqlConfig12_LogLevelFromJSON(
        ...
        if (
            ...
            message.logMinMessages = postgresqlConfig12_LogLevelFromJSON(
        ...
        if (
            ...
            message.logMinErrorStatement = postgresqlConfig12_LogLevelFromJSON(
        ...
        if (
            ...
            message.logErrorVerbosity =
                postgresqlConfig12_LogErrorVerbosityFromJSON(
        ...
        if (object.logStatement !== undefined && object.logStatement !== null) {
            message.logStatement = postgresqlConfig12_LogStatementFromJSON(
                object.logStatement
            );
        } else {
        ...
        if (object.byteaOutput !== undefined && object.byteaOutput !== null) {
            message.byteaOutput = postgresqlConfig12_ByteaOutputFromJSON(
                object.byteaOutput
            );
        } else {
        ...
        if (object.xmlbinary !== undefined && object.xmlbinary !== null) {
            message.xmlbinary = postgresqlConfig12_XmlBinaryFromJSON(
                object.xmlbinary
            );
        } else {
            message.xmlbinary = 0;
        ...
        if (object.xmloption !== undefined && object.xmloption !== null) {
            message.xmloption = postgresqlConfig12_XmlOptionFromJSON(
                object.xmloption
            );
        } else {
            message.xmloption = 0;
        ...
        if (
            ...
            message.backslashQuote = postgresqlConfig12_BackslashQuoteFromJSON(
        ...
        if (
            ...
            message.planCacheMode = postgresqlConfig12_PlanCacheModeFromJSON(
        ...
        if (
            ...
            for (const e of object.sharedPreloadLibraries) {
                message.sharedPreloadLibraries.push(
                    postgresqlConfig12_SharedPreloadLibrariesFromJSON(e)
                );
            }
        }
        if (
        ...
        if (
            ...
            message.pgHintPlanMessageLevel =
                postgresqlConfig12_LogLevelFromJSON(
    ...
    toJSON(message: PostgresqlConfig12): unknown {
        ...
        message.walLevel !== undefined &&
            (obj.walLevel = postgresqlConfig12_WalLevelToJSON(
                message.walLevel
            ));
        ...
        message.constraintExclusion !== undefined &&
            (obj.constraintExclusion =
                postgresqlConfig12_ConstraintExclusionToJSON(
                    message.constraintExclusion
                ));
        message.cursorTupleFraction !== undefined &&
        ...
        message.xmlbinary !== undefined &&
            (obj.xmlbinary = postgresqlConfig12_XmlBinaryToJSON(
                message.xmlbinary
            ));
        message.xmloption !== undefined &&
            (obj.xmloption = postgresqlConfig12_XmlOptionToJSON(
                message.xmloption
            ));
        message.ginPendingListLimit !== undefined &&
        ...
        if (message.sharedPreloadLibraries) {
            obj.sharedPreloadLibraries = message.sharedPreloadLibraries.map(
                (e) => postgresqlConfig12_SharedPreloadLibrariesToJSON(e)
            );
        } else {
        ...
        message.pgHintPlanDebugPrint !== undefined &&
            (obj.pgHintPlanDebugPrint =
                postgresqlConfig12_PgHintPlanDebugPrintToJSON(
                    message.pgHintPlanDebugPrint
                ));
...
export const PostgresqlConfigSet12 = {
    ...
    fromJSON(object: any): PostgresqlConfigSet12 {
        ...
        if (
            ...
            message.effectiveConfig = PostgresqlConfig12.fromJSON(
        ...
        if (
            ...
            message.defaultConfig = PostgresqlConfig12.fromJSON(
    ...
    fromPartial(
        object: DeepPartial<PostgresqlConfigSet12>
    ): PostgresqlConfigSet12 {
        const message = {
            ...basePostgresqlConfigSet12,
        } as PostgresqlConfigSet12;
        if (
            ...
            message.effectiveConfig = PostgresqlConfig12.fromPartial(
                object.effectiveConfig
            );
        } else {
            message.effectiveConfig = undefined;
        ...
        if (object.userConfig !== undefined && object.userConfig !== null) {
            message.userConfig = PostgresqlConfig12.fromPartial(
                object.userConfig
            );
        } else {
            message.userConfig = undefined;
        ...
        if (
            ...
            message.defaultConfig = PostgresqlConfig12.fromPartial(
                object.defaultConfig
            );
        } else {
            message.defaultConfig = undefined;
