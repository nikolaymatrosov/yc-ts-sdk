...
export enum Postgresqlhostconfig121c_ConstraintExclusion {
...
export function postgresqlhostconfig121c_ConstraintExclusionFromJSON(
    object: any
): Postgresqlhostconfig121c_ConstraintExclusion {
    switch (object) {
        case 0:
...
export function postgresqlhostconfig121c_ConstraintExclusionToJSON(
    object: Postgresqlhostconfig121c_ConstraintExclusion
): string {
    switch (object) {
...
export enum Postgresqlhostconfig121c_ForceParallelMode {
...
export function postgresqlhostconfig121c_ForceParallelModeFromJSON(
    object: any
): Postgresqlhostconfig121c_ForceParallelMode {
    switch (object) {
        case 0:
...
export function postgresqlhostconfig121c_ForceParallelModeToJSON(
    object: Postgresqlhostconfig121c_ForceParallelMode
): string {
    switch (object) {
...
export enum Postgresqlhostconfig121c_LogLevel {
...
export function postgresqlhostconfig121c_LogLevelFromJSON(
    object: any
): Postgresqlhostconfig121c_LogLevel {
    switch (object) {
        case 0:
...
export function postgresqlhostconfig121c_LogLevelToJSON(
    object: Postgresqlhostconfig121c_LogLevel
): string {
    switch (object) {
...
export enum Postgresqlhostconfig121c_LogErrorVerbosity {
...
export function postgresqlhostconfig121c_LogErrorVerbosityFromJSON(
    object: any
): Postgresqlhostconfig121c_LogErrorVerbosity {
    switch (object) {
        case 0:
...
export enum Postgresqlhostconfig121c_LogStatement {
...
export function postgresqlhostconfig121c_LogStatementFromJSON(
    object: any
): Postgresqlhostconfig121c_LogStatement {
    switch (object) {
        case 0:
...
export function postgresqlhostconfig121c_LogStatementToJSON(
    object: Postgresqlhostconfig121c_LogStatement
): string {
    switch (object) {
...
export enum Postgresqlhostconfig121c_TransactionIsolation {
...
export function postgresqlhostconfig121c_TransactionIsolationFromJSON(
    object: any
): Postgresqlhostconfig121c_TransactionIsolation {
    switch (object) {
        case 0:
...
export function postgresqlhostconfig121c_TransactionIsolationToJSON(
    object: Postgresqlhostconfig121c_TransactionIsolation
): string {
    switch (object) {
...
export enum Postgresqlhostconfig121c_ByteaOutput {
...
export function postgresqlhostconfig121c_ByteaOutputFromJSON(
    object: any
): Postgresqlhostconfig121c_ByteaOutput {
    switch (object) {
        case 0:
...
export function postgresqlhostconfig121c_ByteaOutputToJSON(
    object: Postgresqlhostconfig121c_ByteaOutput
): string {
    switch (object) {
...
export enum Postgresqlhostconfig121c_XmlBinary {
...
export function postgresqlhostconfig121c_XmlBinaryFromJSON(
    object: any
): Postgresqlhostconfig121c_XmlBinary {
    switch (object) {
        case 0:
...
export function postgresqlhostconfig121c_XmlBinaryToJSON(
    object: Postgresqlhostconfig121c_XmlBinary
): string {
    switch (object) {
...
export enum Postgresqlhostconfig121c_XmlOption {
...
export function postgresqlhostconfig121c_XmlOptionFromJSON(
    object: any
): Postgresqlhostconfig121c_XmlOption {
    switch (object) {
        case 0:
...
export function postgresqlhostconfig121c_XmlOptionToJSON(
    object: Postgresqlhostconfig121c_XmlOption
): string {
    switch (object) {
...
export enum Postgresqlhostconfig121c_BackslashQuote {
...
export function postgresqlhostconfig121c_BackslashQuoteFromJSON(
    object: any
): Postgresqlhostconfig121c_BackslashQuote {
    switch (object) {
        case 0:
...
export function postgresqlhostconfig121c_BackslashQuoteToJSON(
    object: Postgresqlhostconfig121c_BackslashQuote
): string {
    switch (object) {
...
const basePostgresqlhostconfig121c: object = {
    $type: 'yandex.cloud.mdb.postgresql.v1.config.PostgresqlHostConfig12_1C',
...
export const Postgresqlhostconfig121c = {
    $type: 'yandex.cloud.mdb.postgresql.v1.config.PostgresqlHostConfig12_1C' as const,

    encode(
        message: Postgresqlhostconfig121c,
    ...
    fromJSON(object: any): Postgresqlhostconfig121c {
        ...
        if (
            ...
            message.constraintExclusion =
                postgresqlhostconfig121c_ConstraintExclusionFromJSON(
        ...
        if (
            ...
            message.forceParallelMode =
                postgresqlhostconfig121c_ForceParallelModeFromJSON(
        ...
        if (
            ...
            message.clientMinMessages =
                postgresqlhostconfig121c_LogLevelFromJSON(
        ...
        if (
            ...
            message.logMinMessages = postgresqlhostconfig121c_LogLevelFromJSON(
        ...
        if (
            ...
            message.logErrorVerbosity =
                postgresqlhostconfig121c_LogErrorVerbosityFromJSON(
        ...
        if (object.logStatement !== undefined && object.logStatement !== null) {
            message.logStatement =
                postgresqlhostconfig121c_LogStatementFromJSON(
                    object.logStatement
                );
        } else {
        ...
        if (
            ...
            message.defaultTransactionIsolation =
                postgresqlhostconfig121c_TransactionIsolationFromJSON(
        ...
        if (object.byteaOutput !== undefined && object.byteaOutput !== null) {
            message.byteaOutput = postgresqlhostconfig121c_ByteaOutputFromJSON(
                object.byteaOutput
            );
        } else {
        ...
        if (object.xmlbinary !== undefined && object.xmlbinary !== null) {
            message.xmlbinary = postgresqlhostconfig121c_XmlBinaryFromJSON(
                object.xmlbinary
            );
        } else {
            message.xmlbinary = 0;
        ...
        if (object.xmloption !== undefined && object.xmloption !== null) {
            message.xmloption = postgresqlhostconfig121c_XmlOptionFromJSON(
                object.xmloption
            );
        } else {
            message.xmloption = 0;
        ...
        if (
            ...
            message.backslashQuote =
                postgresqlhostconfig121c_BackslashQuoteFromJSON(
    ...
    toJSON(message: Postgresqlhostconfig121c): unknown {
        ...
        message.constraintExclusion !== undefined &&
            (obj.constraintExclusion =
                postgresqlhostconfig121c_ConstraintExclusionToJSON(
                    message.constraintExclusion
                ));
        message.cursorTupleFraction !== undefined &&
        ...
        message.forceParallelMode !== undefined &&
            (obj.forceParallelMode =
                postgresqlhostconfig121c_ForceParallelModeToJSON(
                    message.forceParallelMode
                ));
        message.clientMinMessages !== undefined &&
            (obj.clientMinMessages = postgresqlhostconfig121c_LogLevelToJSON(
                message.clientMinMessages
            ));
        message.logMinMessages !== undefined &&
            (obj.logMinMessages = postgresqlhostconfig121c_LogLevelToJSON(
                message.logMinMessages
            ));
        message.logMinErrorStatement !== undefined &&
            (obj.logMinErrorStatement = postgresqlhostconfig121c_LogLevelToJSON(
                message.logMinErrorStatement
            ));
        message.logMinDurationStatement !== undefined &&
        ...
        message.logErrorVerbosity !== undefined &&
            (obj.logErrorVerbosity =
                postgresqlhostconfig121c_LogErrorVerbosityToJSON(
                    message.logErrorVerbosity
                ));
        message.logLockWaits !== undefined &&
            (obj.logLockWaits = message.logLockWaits);
        message.logStatement !== undefined &&
            (obj.logStatement = postgresqlhostconfig121c_LogStatementToJSON(
                message.logStatement
            ));
        message.logTempFiles !== undefined &&
        ...
        message.defaultTransactionIsolation !== undefined &&
            (obj.defaultTransactionIsolation =
                postgresqlhostconfig121c_TransactionIsolationToJSON(
                    message.defaultTransactionIsolation
                ));
        message.statementTimeout !== undefined &&
        ...
        message.byteaOutput !== undefined &&
            (obj.byteaOutput = postgresqlhostconfig121c_ByteaOutputToJSON(
                message.byteaOutput
            ));
        message.xmlbinary !== undefined &&
            (obj.xmlbinary = postgresqlhostconfig121c_XmlBinaryToJSON(
                message.xmlbinary
            ));
        message.xmloption !== undefined &&
            (obj.xmloption = postgresqlhostconfig121c_XmlOptionToJSON(
                message.xmloption
            ));
        message.ginPendingListLimit !== undefined &&
        ...
        message.backslashQuote !== undefined &&
            (obj.backslashQuote = postgresqlhostconfig121c_BackslashQuoteToJSON(
                message.backslashQuote
            ));
        message.defaultWithOids !== undefined &&
    ...
    fromPartial(
        object: DeepPartial<Postgresqlhostconfig121c>
    ): Postgresqlhostconfig121c {
        const message = {
            ...basePostgresqlhostconfig121c,
        } as Postgresqlhostconfig121c;
