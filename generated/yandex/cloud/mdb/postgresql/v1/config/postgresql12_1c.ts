...
export function postgresqlconfig121c_WalLevelFromJSON(
    object: any
): Postgresqlconfig121c_WalLevel {
    switch (object) {
        case 0:
...
export function postgresqlconfig121c_WalLevelToJSON(
    object: Postgresqlconfig121c_WalLevel
): string {
    switch (object) {
...
export function postgresqlconfig121c_SynchronousCommitFromJSON(
    object: any
...
export function postgresqlconfig121c_SynchronousCommitToJSON(
    object: Postgresqlconfig121c_SynchronousCommit
): string {
    switch (object) {
...
export function postgresqlconfig121c_ForceParallelModeFromJSON(
    object: any
): Postgresqlconfig121c_ForceParallelMode {
    switch (object) {
        case 0:
...
export function postgresqlconfig121c_ForceParallelModeToJSON(
    object: Postgresqlconfig121c_ForceParallelMode
): string {
    switch (object) {
...
export function postgresqlconfig121c_LogLevelFromJSON(
    object: any
): Postgresqlconfig121c_LogLevel {
    switch (object) {
        case 0:
...
export function postgresqlconfig121c_LogLevelToJSON(
    object: Postgresqlconfig121c_LogLevel
): string {
    switch (object) {
...
export function postgresqlconfig121c_LogErrorVerbosityFromJSON(
    object: any
): Postgresqlconfig121c_LogErrorVerbosity {
    switch (object) {
        case 0:
...
export function postgresqlconfig121c_LogErrorVerbosityToJSON(
    object: Postgresqlconfig121c_LogErrorVerbosity
): string {
    switch (object) {
...
export function postgresqlconfig121c_LogStatementFromJSON(
    object: any
): Postgresqlconfig121c_LogStatement {
    switch (object) {
        case 0:
...
export function postgresqlconfig121c_LogStatementToJSON(
    object: Postgresqlconfig121c_LogStatement
): string {
    switch (object) {
...
export function postgresqlconfig121c_ByteaOutputFromJSON(
    object: any
): Postgresqlconfig121c_ByteaOutput {
    switch (object) {
        case 0:
...
export function postgresqlconfig121c_ByteaOutputToJSON(
    object: Postgresqlconfig121c_ByteaOutput
): string {
    switch (object) {
...
export function postgresqlconfig121c_XmlBinaryFromJSON(
    object: any
): Postgresqlconfig121c_XmlBinary {
    switch (object) {
        case 0:
...
export function postgresqlconfig121c_XmlBinaryToJSON(
    object: Postgresqlconfig121c_XmlBinary
): string {
    switch (object) {
...
export function postgresqlconfig121c_XmlOptionFromJSON(
    object: any
): Postgresqlconfig121c_XmlOption {
    switch (object) {
        case 0:
...
export function postgresqlconfig121c_XmlOptionToJSON(
    object: Postgresqlconfig121c_XmlOption
): string {
    switch (object) {
...
export function postgresqlconfig121c_BackslashQuoteFromJSON(
    object: any
...
export function postgresqlconfig121c_BackslashQuoteToJSON(
    object: Postgresqlconfig121c_BackslashQuote
): string {
    switch (object) {
...
export function postgresqlconfig121c_PlanCacheModeFromJSON(
    object: any
): Postgresqlconfig121c_PlanCacheMode {
    switch (object) {
        case 0:
...
export function postgresqlconfig121c_PlanCacheModeToJSON(
    object: Postgresqlconfig121c_PlanCacheMode
): string {
    switch (object) {
...
const basePostgresqlconfig121c: object = {
    $type: 'yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfig12_1C',
    walLevel: 0,
    synchronousCommit: 0,
...
export const Postgresqlconfig121c = {
    ...
    decode(
        ...
        const message = { ...basePostgresqlconfig121c } as Postgresqlconfig121c;
    ...
    fromJSON(object: any): Postgresqlconfig121c {
        ...
        if (object.walLevel !== undefined && object.walLevel !== null) {
            message.walLevel = postgresqlconfig121c_WalLevelFromJSON(
                object.walLevel
            );
        } else {
            message.walLevel = 0;
        ...
        if (
            ...
            message.synchronousCommit =
                postgresqlconfig121c_SynchronousCommitFromJSON(
        ...
        if (
            ...
            message.constraintExclusion =
                postgresqlconfig121c_ConstraintExclusionFromJSON(
        ...
        if (
            ...
            message.forceParallelMode =
                postgresqlconfig121c_ForceParallelModeFromJSON(
        ...
        if (
            ...
            message.clientMinMessages = postgresqlconfig121c_LogLevelFromJSON(
        ...
        if (
            ...
            message.logMinMessages = postgresqlconfig121c_LogLevelFromJSON(
        ...
        if (
            ...
            message.logMinErrorStatement =
                postgresqlconfig121c_LogLevelFromJSON(
        ...
        if (
            ...
            message.logErrorVerbosity =
                postgresqlconfig121c_LogErrorVerbosityFromJSON(
        ...
        if (object.logStatement !== undefined && object.logStatement !== null) {
            message.logStatement = postgresqlconfig121c_LogStatementFromJSON(
                object.logStatement
            );
        } else {
        ...
        if (
            ...
            message.defaultTransactionIsolation =
                postgresqlconfig121c_TransactionIsolationFromJSON(
        ...
        if (object.byteaOutput !== undefined && object.byteaOutput !== null) {
            message.byteaOutput = postgresqlconfig121c_ByteaOutputFromJSON(
                object.byteaOutput
            );
        } else {
        ...
        if (object.xmlbinary !== undefined && object.xmlbinary !== null) {
            message.xmlbinary = postgresqlconfig121c_XmlBinaryFromJSON(
                object.xmlbinary
            );
        } else {
            message.xmlbinary = 0;
        ...
        if (object.xmloption !== undefined && object.xmloption !== null) {
            message.xmloption = postgresqlconfig121c_XmlOptionFromJSON(
                object.xmloption
            );
        } else {
            message.xmloption = 0;
        ...
        if (
            ...
            message.backslashQuote =
                postgresqlconfig121c_BackslashQuoteFromJSON(
        ...
        if (
            ...
            message.logTransactionSampleRate = Number(
                object.logTransactionSampleRate
            );
        } else {
            message.logTransactionSampleRate = undefined;
        }
        if (
            object.planCacheMode !== undefined &&
            object.planCacheMode !== null
        ) {
            message.planCacheMode = postgresqlconfig121c_PlanCacheModeFromJSON(
                object.planCacheMode
            );
        } else {
        ...
        if (
            ...
            for (const e of object.sharedPreloadLibraries) {
                message.sharedPreloadLibraries.push(
                    postgresqlconfig121c_SharedPreloadLibrariesFromJSON(e)
                );
            }
        }
        if (
        ...
        if (
            ...
            message.pgHintPlanDebugPrint =
                postgresqlconfig121c_PgHintPlanDebugPrintFromJSON(
    ...
    toJSON(message: Postgresqlconfig121c): unknown {
        ...
        message.walLevel !== undefined &&
            (obj.walLevel = postgresqlconfig121c_WalLevelToJSON(
                message.walLevel
            ));
        message.synchronousCommit !== undefined &&
            (obj.synchronousCommit =
                postgresqlconfig121c_SynchronousCommitToJSON(
                    message.synchronousCommit
                ));
        message.checkpointTimeout !== undefined &&
        ...
        message.constraintExclusion !== undefined &&
            (obj.constraintExclusion =
                postgresqlconfig121c_ConstraintExclusionToJSON(
                    message.constraintExclusion
                ));
        message.cursorTupleFraction !== undefined &&
        ...
        message.forceParallelMode !== undefined &&
            (obj.forceParallelMode =
                postgresqlconfig121c_ForceParallelModeToJSON(
                    message.forceParallelMode
                ));
        message.clientMinMessages !== undefined &&
            (obj.clientMinMessages = postgresqlconfig121c_LogLevelToJSON(
                message.clientMinMessages
            ));
        message.logMinMessages !== undefined &&
            (obj.logMinMessages = postgresqlconfig121c_LogLevelToJSON(
                message.logMinMessages
            ));
        message.logMinErrorStatement !== undefined &&
            (obj.logMinErrorStatement = postgresqlconfig121c_LogLevelToJSON(
                message.logMinErrorStatement
            ));
        message.logMinDurationStatement !== undefined &&
        ...
        message.logErrorVerbosity !== undefined &&
            (obj.logErrorVerbosity =
                postgresqlconfig121c_LogErrorVerbosityToJSON(
                    message.logErrorVerbosity
                ));
        message.logLockWaits !== undefined &&
            (obj.logLockWaits = message.logLockWaits);
        message.logStatement !== undefined &&
            (obj.logStatement = postgresqlconfig121c_LogStatementToJSON(
        ...
        message.defaultTransactionIsolation !== undefined &&
            (obj.defaultTransactionIsolation =
                postgresqlconfig121c_TransactionIsolationToJSON(
                    message.defaultTransactionIsolation
                ));
        message.statementTimeout !== undefined &&
        ...
        message.byteaOutput !== undefined &&
            (obj.byteaOutput = postgresqlconfig121c_ByteaOutputToJSON(
                message.byteaOutput
            ));
        message.xmlbinary !== undefined &&
            (obj.xmlbinary = postgresqlconfig121c_XmlBinaryToJSON(
                message.xmlbinary
            ));
        message.xmloption !== undefined &&
            (obj.xmloption = postgresqlconfig121c_XmlOptionToJSON(
                message.xmloption
            ));
        message.ginPendingListLimit !== undefined &&
        ...
        message.backslashQuote !== undefined &&
            (obj.backslashQuote = postgresqlconfig121c_BackslashQuoteToJSON(
                message.backslashQuote
            ));
        message.defaultWithOids !== undefined &&
        ...
        message.planCacheMode !== undefined &&
            (obj.planCacheMode = postgresqlconfig121c_PlanCacheModeToJSON(
        ...
        if (message.sharedPreloadLibraries) {
            obj.sharedPreloadLibraries = message.sharedPreloadLibraries.map(
                (e) => postgresqlconfig121c_SharedPreloadLibrariesToJSON(e)
            );
        } else {
        ...
        message.pgHintPlanDebugPrint !== undefined &&
            (obj.pgHintPlanDebugPrint =
                postgresqlconfig121c_PgHintPlanDebugPrintToJSON(
                    message.pgHintPlanDebugPrint
                ));
    ...
    fromPartial(
        object: DeepPartial<Postgresqlconfig121c>
    ): Postgresqlconfig121c {
        const message = { ...basePostgresqlconfig121c } as Postgresqlconfig121c;
        message.sharedPreloadLibraries = [];
        if (
...
const basePostgresqlconfigset121c: object = {
    $type: 'yandex.cloud.mdb.postgresql.v1.config.PostgresqlConfigSet12_1C',
};
...
export const Postgresqlconfigset121c = {
    ...
    encode(
        message: Postgresqlconfigset121c,
        writer: _m0.Writer = _m0.Writer.create()
    ): _m0.Writer {
    ...
    decode(
        ...
        } as Postgresqlconfigset121c;
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
                    message.effectiveConfig = Postgresqlconfig121c.decode(
                        reader,
                        reader.uint32()
                    );
                    break;
                case 2:
                    message.userConfig = Postgresqlconfig121c.decode(
                        reader,
                        reader.uint32()
                    );
                    break;
                case 3:
                    message.defaultConfig = Postgresqlconfig121c.decode(
                        reader,
                        reader.uint32()
                    );
                    break;
    ...
    fromJSON(object: any): Postgresqlconfigset121c {
        ...
        if (
            ...
            message.effectiveConfig = Postgresqlconfig121c.fromJSON(
        ...
        if (object.userConfig !== undefined && object.userConfig !== null) {
            message.userConfig = Postgresqlconfig121c.fromJSON(
                object.userConfig
            );
        } else {
        ...
        if (
            ...
            message.defaultConfig = Postgresqlconfig121c.fromJSON(
    ...
    fromPartial(
        object: DeepPartial<Postgresqlconfigset121c>
    ): Postgresqlconfigset121c {
        const message = {
            ...basePostgresqlconfigset121c,
        } as Postgresqlconfigset121c;
        if (
            ...
            message.effectiveConfig = Postgresqlconfig121c.fromPartial(
                object.effectiveConfig
            );
        } else {
            message.effectiveConfig = undefined;
        ...
        if (object.userConfig !== undefined && object.userConfig !== null) {
            message.userConfig = Postgresqlconfig121c.fromPartial(
                object.userConfig
            );
        } else {
            message.userConfig = undefined;
        ...
        if (
            ...
            message.defaultConfig = Postgresqlconfig121c.fromPartial(
                object.defaultConfig
            );
        } else {
            message.defaultConfig = undefined;
