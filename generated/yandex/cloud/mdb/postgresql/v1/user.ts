        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    message.connLimit = Int64Value.decode(
                        reader,
                        reader.uint32()
                    ).value;
                    break;
...
export const UserSettings = {
    ...
    fromJSON(object: any): UserSettings {
        ...
        if (
            ...
            message.synchronousCommit = userSettings_SynchronousCommitFromJSON(
        ...
        if (object.logStatement !== undefined && object.logStatement !== null) {
            message.logStatement = userSettings_LogStatementFromJSON(
                object.logStatement
            );
        } else {
