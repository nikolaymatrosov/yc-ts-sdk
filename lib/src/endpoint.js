...
import { ApiEndpointServiceService, ListApiEndpointsRequest, } from '../generated/yandex/cloud/endpoint/api_endpoint_service';
...
export class EndpointResolver {
    ...
    async updateEndpointList(cloudApiEndpoint) {
        const channel = createChannel(cloudApiEndpoint, credentials.createSsl());
