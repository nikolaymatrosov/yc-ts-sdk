...
export var DiskPlacementGroup_Status;
...
})(DiskPlacementGroup_Status || (DiskPlacementGroup_Status = {}));
export function diskPlacementGroup_StatusFromJSON(object) {
    switch (object) {
        case 0:
...
export function diskPlacementGroup_StatusToJSON(object) {
    switch (object) {
...
export const DiskPlacementGroup = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        Object.entries(message.labels).forEach(([key, value]) => {
            DiskPlacementGroup_LabelsEntry.encode({ key: key, value }, writer.uint32(50).fork()).ldelim();
        });
        if (message.zoneId !== '') {
...
const baseDiskPlacementGroup_LabelsEntry = { key: '', value: '' };
