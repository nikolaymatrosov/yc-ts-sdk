...
export function image_StatusFromJSON(object) {
    switch (object) {
        case 0:
...
export function image_StatusToJSON(object) {
    switch (object) {
...
export function os_TypeFromJSON(object) {
    switch (object) {
        case 0:
...
export function os_TypeToJSON(object) {
    switch (object) {
...
export const Image = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        Object.entries(message.labels).forEach(([key, value]) => {
            Image_LabelsEntry.encode({ key: key, value }, writer.uint32(50).fork()).ldelim();
        });
        if (message.family !== '') {
