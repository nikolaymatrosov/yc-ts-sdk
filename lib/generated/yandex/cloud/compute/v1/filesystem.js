...
export function filesystem_StatusFromJSON(object) {
    switch (object) {
        case 0:
...
export function filesystem_StatusToJSON(object) {
    switch (object) {
...
export const Filesystem = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        Object.entries(message.labels).forEach(([key, value]) => {
            Filesystem_LabelsEntry.encode({ key: key, value }, writer.uint32(50).fork()).ldelim();
        });
        if (message.typeId !== '') {
...
const baseFilesystem_LabelsEntry = { key: '', value: '' };
