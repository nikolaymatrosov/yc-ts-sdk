...
export var AttachedFilesystemSpec_Mode;
...
})(AttachedFilesystemSpec_Mode || (AttachedFilesystemSpec_Mode = {}));
export function attachedFilesystemSpec_ModeFromJSON(object) {
    switch (object) {
        case 0:
        case 'MODE_UNSPECIFIED':
...
export function attachedFilesystemSpec_ModeToJSON(object) {
    switch (object) {
...
export const CreateInstanceRequest = {
    ...
    fromJSON(object) {
        ...
        if (object.filesystemSpecs !== undefined &&
            ...
            for (const e of object.filesystemSpecs) {
                message.filesystemSpecs.push(AttachedFilesystemSpec.fromJSON(e));
            }
        }
    ...
    toJSON(message) {
        ...
        if (message.filesystemSpecs) {
            obj.filesystemSpecs = message.filesystemSpecs.map((e) => e ? AttachedFilesystemSpec.toJSON(e) : undefined);
        }
        else {
            obj.filesystemSpecs = [];
        }
    ...
    fromPartial(object) {
        ...
        if (object.filesystemSpecs !== undefined &&
            object.filesystemSpecs !== null) {
            for (const e of object.filesystemSpecs) {
                message.filesystemSpecs.push(AttachedFilesystemSpec.fromPartial(e));
            }
        }
        if (object.networkInterfaceSpecs !== undefined &&
            object.networkInterfaceSpecs !== null) {
...
export const AttachInstanceFilesystemRequest = {
    ...
    fromJSON(object) {
        ...
        if (object.attachedFilesystemSpec !== undefined &&
            ...
            message.attachedFilesystemSpec = AttachedFilesystemSpec.fromJSON(object.attachedFilesystemSpec);
        }
        else {
    ...
    fromPartial(object) {
        ...
        if (object.attachedFilesystemSpec !== undefined &&
            object.attachedFilesystemSpec !== null) {
            message.attachedFilesystemSpec = AttachedFilesystemSpec.fromPartial(object.attachedFilesystemSpec);
        }
        else {
            message.attachedFilesystemSpec = undefined;
        }
...
export const InstanceServiceService = {
    ...
    attachFilesystem: {
        ...
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(AttachInstanceFilesystemRequest.encode(value).finish()),
        requestDeserialize: (value) => AttachInstanceFilesystemRequest.decode(value),
        responseSerialize: (value) => Buffer.from(Operation.encode(value).finish()),
        responseDeserialize: (value) => Operation.decode(value),
    },
    /**
    ...
    detachFilesystem: {
        ...
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(DetachInstanceFilesystemRequest.encode(value).finish()),
        requestDeserialize: (value) => DetachInstanceFilesystemRequest.decode(value),
        responseSerialize: (value) => Buffer.from(Operation.encode(value).finish()),
        responseDeserialize: (value) => Operation.decode(value),
    },
