...
exports.InstanceGroup = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        Object.entries(message.labels).forEach(([key, value]) => {
            exports.InstanceGroup_LabelsEntry.encode({ key: key, value }, writer.uint32(50).fork()).ldelim();
        });
...
exports.ScalePolicy_CustomRule = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        Object.entries(message.labels).forEach(([key, value]) => {
            exports.ScalePolicy_CustomRule_LabelsEntry.encode({ key: key, value }, writer.uint32(42).fork()).ldelim();
        });
        if (message.target !== 0) {
...
exports.InstanceTemplate = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        Object.entries(message.labels).forEach(([key, value]) => {
            exports.InstanceTemplate_LabelsEntry.encode({ key: key, value }, writer.uint32(18).fork()).ldelim();
        });
        ...
        Object.entries(message.metadata).forEach(([key, value]) => {
            exports.InstanceTemplate_MetadataEntry.encode({ key: key, value }, writer.uint32(42).fork()).ldelim();
        });
...
exports.TargetGroupSpec = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        Object.entries(message.labels).forEach(([key, value]) => {
            exports.TargetGroupSpec_LabelsEntry.encode({ key: key, value }, writer.uint32(26).fork()).ldelim();
        });
        return writer;
    },
    decode(input, length) {
...
exports.ApplicationTargetGroupSpec = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        Object.entries(message.labels).forEach(([key, value]) => {
            exports.ApplicationTargetGroupSpec_LabelsEntry.encode({ key: key, value }, writer.uint32(26).fork()).ldelim();
        });
        return writer;
    },
    decode(input, length) {
