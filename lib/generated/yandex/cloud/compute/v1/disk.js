...
export function disk_StatusFromJSON(object) {
    switch (object) {
        case 0:
...
export function disk_StatusToJSON(object) {
    switch (object) {
...
export const Disk = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        Object.entries(message.labels).forEach(([key, value]) => {
            Disk_LabelsEntry.encode({ key: key, value }, writer.uint32(50).fork()).ldelim();
        });
        if (message.typeId !== '') {
...
const baseDisk_LabelsEntry = { key: '', value: '' };
...
const baseDiskPlacementPolicy = { placementGroupId: '' };
