...
exports.ListPlacementGroupsResponse = {
    ...
    fromJSON(object) {
        ...
        if (object.placementGroups !== undefined &&
            ...
            for (const e of object.placementGroups) {
                message.placementGroups.push(placement_group_1.PlacementGroup.fromJSON(e));
            }
        }
    ...
    fromPartial(object) {
        ...
        if (object.placementGroups !== undefined &&
            object.placementGroups !== null) {
            for (const e of object.placementGroups) {
                message.placementGroups.push(placement_group_1.PlacementGroup.fromPartial(e));
            }
        }
        if (object.nextPageToken !== undefined &&
            object.nextPageToken !== null) {
...
exports.CreatePlacementGroupRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        Object.entries(message.labels).forEach(([key, value]) => {
            exports.CreatePlacementGroupRequest_LabelsEntry.encode({ key: key, value }, writer.uint32(34).fork()).ldelim();
        });
            ...
            switch (tag >>> 3) {
                ...
                case 5:
                    message.spreadPlacementStrategy =
                        placement_group_1.SpreadPlacementStrategy.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        ...
        if (object.spreadPlacementStrategy !== undefined &&
            ...
            message.spreadPlacementStrategy = placement_group_1.SpreadPlacementStrategy.fromJSON(object.spreadPlacementStrategy);
        }
        else {
...
exports.UpdatePlacementGroupRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        Object.entries(message.labels).forEach(([key, value]) => {
            exports.UpdatePlacementGroupRequest_LabelsEntry.encode({ key: key, value }, writer.uint32(42).fork()).ldelim();
        });
        return writer;
    },
    decode(input, length) {
