...
export function snapshot_StatusFromJSON(object) {
    switch (object) {
        case 0:
...
export function snapshot_StatusToJSON(object) {
    switch (object) {
...
export const Snapshot = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        Object.entries(message.labels).forEach(([key, value]) => {
            Snapshot_LabelsEntry.encode({ key: key, value }, writer.uint32(50).fork()).ldelim();
        });
...
const baseSnapshot_LabelsEntry = { key: '', value: '' };
