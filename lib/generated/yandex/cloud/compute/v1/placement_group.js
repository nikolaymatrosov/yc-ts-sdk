...
exports.PlacementGroup = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        Object.entries(message.labels).forEach(([key, value]) => {
            exports.PlacementGroup_LabelsEntry.encode({ key: key, value }, writer.uint32(50).fork()).ldelim();
        });
    ...
    decode(input, length) {
        ...
        const message = { ...basePlacementGroup };
        message.labels = {};
            ...
            switch (tag >>> 3) {
                ...
                case 7:
                    message.spreadPlacementStrategy =
                        exports.SpreadPlacementStrategy.decode(reader, reader.uint32());
                    break;
                default:
    ...
    fromJSON(object) {
        ...
        if (object.spreadPlacementStrategy !== undefined &&
            ...
            message.spreadPlacementStrategy = exports.SpreadPlacementStrategy.fromJSON(object.spreadPlacementStrategy);
        }
        else {
...
const basePlacementGroup_LabelsEntry = { key: '', value: '' };
