...
export function maintenancePolicyFromJSON(object) {
    switch (object) {
        case 0:
...
export function maintenancePolicyToJSON(object) {
    switch (object) {
...
})(HostGroup_Status || (HostGroup_Status = {}));
export function hostGroup_StatusFromJSON(object) {
    switch (object) {
        case 0:
...
export function hostGroup_StatusToJSON(object) {
    switch (object) {
...
export function host_StatusFromJSON(object) {
    switch (object) {
        case 0:
        case 'STATUS_UNSPECIFIED':
...
export function host_StatusToJSON(object) {
    switch (object) {
...
export const HostGroup = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        Object.entries(message.labels).forEach(([key, value]) => {
            HostGroup_LabelsEntry.encode({ key: key, value }, writer.uint32(50).fork()).ldelim();
        });
        if (message.zoneId !== '') {
