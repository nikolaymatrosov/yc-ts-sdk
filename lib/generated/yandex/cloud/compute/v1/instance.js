...
exports.Instance = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        Object.entries(message.labels).forEach(([key, value]) => {
            exports.Instance_LabelsEntry.encode({ key: key, value }, writer.uint32(50).fork()).ldelim();
        });
        if (message.zoneId !== '') {
        ...
        Object.entries(message.metadata).forEach(([key, value]) => {
            exports.Instance_MetadataEntry.encode({ key: key, value }, writer.uint32(90).fork()).ldelim();
        });
