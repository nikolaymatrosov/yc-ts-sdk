...
export function deviceViewFromJSON(object) {
    switch (object) {
        case 0:
        case 'BASIC':
...
export function deviceViewToJSON(object) {
    switch (object) {
...
export function device_StatusFromJSON(object) {
    switch (object) {
        case 0:
...
export function device_StatusToJSON(object) {
    switch (object) {
...
export const Device = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        Object.entries(message.topicAliases).forEach(([key, value]) => {
            Device_TopicAliasesEntry.encode({ key: key, value }, writer.uint32(50).fork()).ldelim();
        });
        if (message.status !== 0) {
    ...
    fromJSON(object) {
        ...
        if (object.monitoringData !== undefined &&
            ...
            message.monitoringData = DeviceMonitoringData.fromJSON(object.monitoringData);
        }
        else {
    ...
    fromPartial(object) {
        ...
        if (object.monitoringData !== undefined &&
            object.monitoringData !== null) {
            message.monitoringData = DeviceMonitoringData.fromPartial(object.monitoringData);
        }
        else {
            message.monitoringData = undefined;
        }
...
const baseDevice_TopicAliasesEntry = { key: '', value: '' };
...
const baseDevicePassword = { deviceId: '', id: '' };
...
const baseDeviceMonitoringData = { lastAuthIp: '' };
