...
export const DeviceDataServiceService = {
    ...
    publish: {
        ...
        requestSerialize: (value) => Buffer.from(PublishDeviceDataRequest.encode(value).finish()),
        requestDeserialize: (value) => PublishDeviceDataRequest.decode(value),
        responseSerialize: (value) => Buffer.from(PublishDeviceDataResponse.encode(value).finish()),
        responseDeserialize: (value) => PublishDeviceDataResponse.decode(value),
    },
};
export const DeviceDataServiceClient = makeGenericClientConstructor(DeviceDataServiceService, 'yandex.cloud.iot.devices.v1.DeviceDataService');
var globalThis = (() => {
