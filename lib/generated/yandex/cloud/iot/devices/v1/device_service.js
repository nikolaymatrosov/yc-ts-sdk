...
exports.CreateDeviceRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        Object.entries(message.topicAliases).forEach(([key, value]) => {
            exports.CreateDeviceRequest_TopicAliasesEntry.encode({ key: key, value }, writer.uint32(42).fork()).ldelim();
        });
        if (message.password !== '') {
...
exports.UpdateDeviceRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        Object.entries(message.topicAliases).forEach(([key, value]) => {
            exports.UpdateDeviceRequest_TopicAliasesEntry.encode({ key: key, value }, writer.uint32(42).fork()).ldelim();
        });
        return writer;
    },
    decode(input, length) {
