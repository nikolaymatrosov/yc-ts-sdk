...
})(ScanResult_Status || (ScanResult_Status = {}));
export function scanResult_StatusFromJSON(object) {
    switch (object) {
        case 0:
...
export function scanResult_StatusToJSON(object) {
    switch (object) {
...
export var Vulnerability_Severity;
...
export function vulnerability_SeverityFromJSON(object) {
    switch (object) {
        case 0:
...
export function vulnerability_SeverityToJSON(object) {
    switch (object) {
...
const baseScanResult = { id: '', imageId: '', status: 0 };
export const ScanResult = {
    ...
    fromJSON(object) {
        ...
        if (object.vulnerabilities !== undefined &&
            ...
            message.vulnerabilities = VulnerabilityStats.fromJSON(object.vulnerabilities);
        }
        else {
    ...
    fromPartial(object) {
        ...
        if (object.vulnerabilities !== undefined &&
            object.vulnerabilities !== null) {
            message.vulnerabilities = VulnerabilityStats.fromPartial(object.vulnerabilities);
        }
        else {
            message.vulnerabilities = undefined;
        }
...
const baseVulnerability = { severity: 0 };
