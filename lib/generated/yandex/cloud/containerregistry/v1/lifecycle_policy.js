...
export var LifecyclePolicy_Status;
...
})(LifecyclePolicy_Status || (LifecyclePolicy_Status = {}));
export function lifecyclePolicy_StatusFromJSON(object) {
    switch (object) {
        case 0:
...
export function lifecyclePolicy_StatusToJSON(object) {
    switch (object) {
