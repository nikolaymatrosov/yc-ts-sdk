...
export const Project_Limits = {
    encode(message, writer = _m0.Writer.create()) {
        if (message.maxUnitsPerHour !== undefined) {
            Int64Value.encode({ value: message.maxUnitsPerHour }, writer.uint32(18).fork()).ldelim();
        }
        if (message.maxUnitsPerExecution !== undefined) {
            Int64Value.encode({ value: message.maxUnitsPerExecution }, writer.uint32(26).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
