...
exports.Project_Limits = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.maxUnitsPerHour !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxUnitsPerHour }, writer.uint32(18).fork()).ldelim();
        }
        if (message.maxUnitsPerExecution !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxUnitsPerExecution }, writer.uint32(26).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
