...
exports.GetUnitBalanceResponse = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.unitBalance !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.unitBalance }, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
...
exports.SetUnitBalanceRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.unitBalance !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.unitBalance }, writer.uint32(18).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
