...
exports.TargetGroup = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        Object.entries(message.labels).forEach(([key, value]) => {
            exports.TargetGroup_LabelsEntry.encode({ key: key, value }, writer.uint32(50).fork()).ldelim();
        });
        if (message.regionId !== '') {
    ...
    fromJSON(object) {
        ...
        if (object.targets !== undefined && object.targets !== null) {
            for (const e of object.targets) {
                message.targets.push(exports.Target.fromJSON(e));
            }
        }
        return message;
    },
    ...
    fromPartial(object) {
        ...
        if (object.targets !== undefined && object.targets !== null) {
            for (const e of object.targets) {
                message.targets.push(exports.Target.fromPartial(e));
            }
        }
        return message;
    },
...
const baseTarget = { subnetId: '', address: '' };
exports.Target = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.subnetId !== '') {
