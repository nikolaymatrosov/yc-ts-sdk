...
export function loadBalancingModeFromJSON(object) {
    switch (object) {
        case 0:
        case 'ROUND_ROBIN':
...
export function loadBalancingModeToJSON(object) {
    switch (object) {
...
export const StreamBackendGroup = {
    ...
    fromJSON(object) {
        ...
        if (object.connection !== undefined && object.connection !== null) {
            message.connection = ConnectionSessionAffinity.fromJSON(object.connection);
        }
        else {
    ...
    fromPartial(object) {
        ...
        if (object.connection !== undefined && object.connection !== null) {
            message.connection = ConnectionSessionAffinity.fromPartial(object.connection);
        }
        else {
            message.connection = undefined;
        }
...
export const HttpBackend = {
    ...
    fromJSON(object) {
        ...
        if (object.storageBucket !== undefined &&
            ...
            message.storageBucket = StorageBucketBackend.fromJSON(object.storageBucket);
        }
        else {
    ...
    fromPartial(object) {
        ...
        if (object.storageBucket !== undefined &&
            object.storageBucket !== null) {
            message.storageBucket = StorageBucketBackend.fromPartial(object.storageBucket);
        }
        else {
            message.storageBucket = undefined;
        }
