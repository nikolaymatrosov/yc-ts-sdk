...
exports.UpdateNodeGroupRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        Object.entries(message.labels).forEach(([key, value]) => {
            exports.UpdateNodeGroupRequest_LabelsEntry.encode({ key: key, value }, writer.uint32(42).fork()).ldelim();
        });
        ...
        Object.entries(message.nodeLabels).forEach(([key, value]) => {
            exports.UpdateNodeGroupRequest_NodeLabelsEntry.encode({ key: key, value }, writer.uint32(114).fork()).ldelim();
        });
        return writer;
    },
    decode(input, length) {
...
exports.CreateNodeGroupRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        Object.entries(message.labels).forEach(([key, value]) => {
            exports.CreateNodeGroupRequest_LabelsEntry.encode({ key: key, value }, writer.uint32(34).fork()).ldelim();
        });
        if (message.nodeTemplate !== undefined) {
        ...
        Object.entries(message.nodeLabels).forEach(([key, value]) => {
            exports.CreateNodeGroupRequest_NodeLabelsEntry.encode({ key: key, value }, writer.uint32(98).fork()).ldelim();
        });
        return writer;
    },
    decode(input, length) {
