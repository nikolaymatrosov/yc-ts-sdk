...
export function nodeGroup_StatusFromJSON(object) {
    switch (object) {
        case 0:
...
export function nodeGroup_StatusToJSON(object) {
    switch (object) {
...
export const NodeGroup = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        Object.entries(message.labels).forEach(([key, value]) => {
            NodeGroup_LabelsEntry.encode({ key: key, value }, writer.uint32(50).fork()).ldelim();
        });
        if (message.status !== 0) {
        ...
        if (message.allocationPolicy !== undefined) {
            NodeGroupAllocationPolicy.encode(message.allocationPolicy, writer.uint32(82).fork()).ldelim();
        }
        ...
        if (message.maintenancePolicy !== undefined) {
            NodeGroupMaintenancePolicy.encode(message.maintenancePolicy, writer.uint32(114).fork()).ldelim();
        }
        ...
        Object.entries(message.nodeLabels).forEach(([key, value]) => {
            NodeGroup_NodeLabelsEntry.encode({ key: key, value }, writer.uint32(138).fork()).ldelim();
        });
        return writer;
    },
    decode(input, length) {
...
export const NodeGroupAllocationPolicy = {
    ...
    toJSON(message) {
        ...
        if (message.locations) {
            obj.locations = message.locations.map((e) => e ? NodeGroupLocation.toJSON(e) : undefined);
        }
        else {
            obj.locations = [];
        }
