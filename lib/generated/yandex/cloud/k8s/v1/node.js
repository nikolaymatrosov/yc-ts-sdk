...
export function node_StatusFromJSON(object) {
    switch (object) {
        case 0:
...
export function node_StatusToJSON(object) {
    switch (object) {
...
export function taint_EffectFromJSON(object) {
    switch (object) {
        case 0:
...
export function taint_EffectToJSON(object) {
    switch (object) {
...
export var NodeTemplate_NetworkSettings_Type;
...
})(NodeTemplate_NetworkSettings_Type || (NodeTemplate_NetworkSettings_Type = {}));
export function nodeTemplate_NetworkSettings_TypeFromJSON(object) {
    switch (object) {
        case 0:
...
export function nodeTemplate_NetworkSettings_TypeToJSON(object) {
    switch (object) {
...
export const Node = {
    ...
    fromJSON(object) {
        ...
        if (object.kubernetesStatus !== undefined &&
            ...
            message.kubernetesStatus = Node_KubernetesStatus.fromJSON(object.kubernetesStatus);
        }
        else {
    ...
    fromPartial(object) {
        ...
        if (object.cloudStatus !== undefined && object.cloudStatus !== null) {
            message.cloudStatus = Node_CloudStatus.fromPartial(object.cloudStatus);
        }
        else {
            message.cloudStatus = undefined;
        }
        if (object.kubernetesStatus !== undefined &&
            object.kubernetesStatus !== null) {
            message.kubernetesStatus = Node_KubernetesStatus.fromPartial(object.kubernetesStatus);
        }
        else {
            message.kubernetesStatus = undefined;
        }
...
export const Node_KubernetesStatus = {
    ...
    toJSON(message) {
        ...
        if (message.attachedVolumes) {
            obj.attachedVolumes = message.attachedVolumes.map((e) => e ? AttachedVolume.toJSON(e) : undefined);
        }
        else {
            obj.attachedVolumes = [];
        }
...
export const NodeTemplate = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        Object.entries(message.metadata).forEach(([key, value]) => {
            NodeTemplate_MetadataEntry.encode({ key: key, value }, writer.uint32(34).fork()).ldelim();
        });
            ...
            switch (tag >>> 3) {
                ...
                case 11:
                    message.networkSettings =
                        NodeTemplate_NetworkSettings.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        ...
        if (object.v4AddressSpec !== undefined &&
            ...
            message.v4AddressSpec = NodeAddressSpec.fromJSON(object.v4AddressSpec);
        }
        else {
        ...
        if (object.networkSettings !== undefined &&
            ...
            message.networkSettings = NodeTemplate_NetworkSettings.fromJSON(object.networkSettings);
        }
        else {
    ...
    fromPartial(object) {
        ...
        if (object.v4AddressSpec !== undefined &&
            object.v4AddressSpec !== null) {
            message.v4AddressSpec = NodeAddressSpec.fromPartial(object.v4AddressSpec);
        }
        else {
            message.v4AddressSpec = undefined;
        }
        ...
        if (object.networkSettings !== undefined &&
            object.networkSettings !== null) {
            message.networkSettings = NodeTemplate_NetworkSettings.fromPartial(object.networkSettings);
        }
        else {
            message.networkSettings = undefined;
        }
...
export const NetworkInterfaceSpec = {
    ...
    fromJSON(object) {
        ...
        if (object.primaryV4AddressSpec !== undefined &&
            ...
            message.primaryV4AddressSpec = NodeAddressSpec.fromJSON(object.primaryV4AddressSpec);
        }
        else {
        ...
        if (object.primaryV6AddressSpec !== undefined &&
            ...
            message.primaryV6AddressSpec = NodeAddressSpec.fromJSON(object.primaryV6AddressSpec);
        }
        else {
    ...
    fromPartial(object) {
        ...
        if (object.primaryV4AddressSpec !== undefined &&
            object.primaryV4AddressSpec !== null) {
            message.primaryV4AddressSpec = NodeAddressSpec.fromPartial(object.primaryV4AddressSpec);
        }
        else {
            message.primaryV4AddressSpec = undefined;
        }
        if (object.primaryV6AddressSpec !== undefined &&
            object.primaryV6AddressSpec !== null) {
            message.primaryV6AddressSpec = NodeAddressSpec.fromPartial(object.primaryV6AddressSpec);
        }
        else {
            message.primaryV6AddressSpec = undefined;
        }
