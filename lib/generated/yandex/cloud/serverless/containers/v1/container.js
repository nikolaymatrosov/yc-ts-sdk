...
exports.Container = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        Object.entries(message.labels).forEach(([key, value]) => {
            exports.Container_LabelsEntry.encode({ key: key, value }, writer.uint32(50).fork()).ldelim();
        });
        if (message.url !== '') {
...
exports.Image = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        Object.entries(message.environment).forEach(([key, value]) => {
            exports.Image_EnvironmentEntry.encode({ key: key, value }, writer.uint32(42).fork()).ldelim();
        });
