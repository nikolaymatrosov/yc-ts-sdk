...
export function function_StatusFromJSON(object) {
    switch (object) {
        case 0:
...
export function function_StatusToJSON(object) {
    switch (object) {
...
export const Function = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        Object.entries(message.labels).forEach(([key, value]) => {
            Function_LabelsEntry.encode({ key: key, value }, writer.uint32(50).fork()).ldelim();
        });
...
export const Version = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        Object.entries(message.environment).forEach(([key, value]) => {
            Version_EnvironmentEntry.encode({ key: key, value }, writer.uint32(130).fork()).ldelim();
        });
        ...
        Object.entries(message.namedServiceAccounts).forEach(([key, value]) => {
            Version_NamedServiceAccountsEntry.encode({ key: key, value }, writer.uint32(146).fork()).ldelim();
        });
        return writer;
    },
    decode(input, length) {
