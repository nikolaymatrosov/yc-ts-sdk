...
import { logLevel_LevelFromJSON, logLevel_LevelToJSON, } from '../../../../../yandex/cloud/logging/v1/log_entry';
...
export const Trigger_Rule = {
    ...
    fromJSON(object) {
        ...
        if (object.billingBudget !== undefined &&
            ...
            message.billingBudget = BillingBudget.fromJSON(object.billingBudget);
        }
        else {
    ...
    fromPartial(object) {
        ...
        if (object.billingBudget !== undefined &&
            object.billingBudget !== null) {
            message.billingBudget = BillingBudget.fromPartial(object.billingBudget);
        }
        else {
            message.billingBudget = undefined;
        }
            ...
            switch (tag >>> 3) {
                ...
                case 104:
                    message.invokeContainerWithRetry =
                        InvokeContainerWithRetry.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
...
export const Trigger_MessageQueue = {
    ...
    fromJSON(object) {
        ...
        if (object.invokeContainer !== undefined &&
            ...
            message.invokeContainer = InvokeContainerOnce.fromJSON(object.invokeContainer);
        }
        else {
    ...
    fromPartial(object) {
        ...
        if (object.invokeContainer !== undefined &&
            object.invokeContainer !== null) {
            message.invokeContainer = InvokeContainerOnce.fromPartial(object.invokeContainer);
        }
        else {
            message.invokeContainer = undefined;
        }
...
export const Trigger_IoTMessage = {
    ...
    fromJSON(object) {
        ...
        if (object.invokeContainer !== undefined &&
            object.invokeContainer !== null) {
            message.invokeContainer = InvokeContainerWithRetry.fromJSON(object.invokeContainer);
        }
        else {
            message.invokeContainer = undefined;
        }
    ...
    fromPartial(object) {
        ...
        if (object.invokeContainer !== undefined &&
            object.invokeContainer !== null) {
            message.invokeContainer = InvokeContainerWithRetry.fromPartial(object.invokeContainer);
        }
        else {
            message.invokeContainer = undefined;
        }
...
export const Trigger_Logging = {
    ...
    fromJSON(object) {
        ...
        if (object.batchSettings !== undefined &&
            object.batchSettings !== null) {
            message.batchSettings = LoggingBatchSettings.fromJSON(object.batchSettings);
        }
        else {
            message.batchSettings = undefined;
        }
    ...
    fromPartial(object) {
        ...
        if (object.batchSettings !== undefined &&
            object.batchSettings !== null) {
            message.batchSettings = LoggingBatchSettings.fromPartial(object.batchSettings);
        }
        else {
            message.batchSettings = undefined;
        }
...
const baseLoggingBatchSettings = { size: 0 };
...
const baseBillingBudget = { billingAccountId: '', budgetId: '' };
...
const baseDataStreamBatchSettings = { size: 0 };
...
export const DataStream = {
    ...
    fromJSON(object) {
        ...
        if (object.batchSettings !== undefined &&
            object.batchSettings !== null) {
            message.batchSettings = DataStreamBatchSettings.fromJSON(object.batchSettings);
        }
        else {
            message.batchSettings = undefined;
        }
    ...
    fromPartial(object) {
        ...
        if (object.batchSettings !== undefined &&
            object.batchSettings !== null) {
            message.batchSettings = DataStreamBatchSettings.fromPartial(object.batchSettings);
        }
        else {
            message.batchSettings = undefined;
        }
