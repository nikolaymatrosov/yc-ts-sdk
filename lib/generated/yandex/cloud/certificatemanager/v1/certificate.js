...
export function challengeTypeFromJSON(object) {
    switch (object) {
        case 0:
...
export function challengeTypeToJSON(object) {
    switch (object) {
...
export function certificate_StatusFromJSON(object) {
    switch (object) {
        case 0:
...
export function certificate_StatusToJSON(object) {
    switch (object) {
...
export function challenge_StatusFromJSON(object) {
    switch (object) {
        case 0:
        case 'STATUS_UNSPECIFIED':
...
export function challenge_StatusToJSON(object) {
    switch (object) {
...
export const Certificate = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        Object.entries(message.labels).forEach(([key, value]) => {
            Certificate_LabelsEntry.encode({ key: key, value }, writer.uint32(50).fork()).ldelim();
        });
        if (message.type !== 0) {
...
export const Challenge = {
    ...
    fromJSON(object) {
        ...
        if (object.dnsChallenge !== undefined && object.dnsChallenge !== null) {
            message.dnsChallenge = Challenge_DnsRecord.fromJSON(object.dnsChallenge);
        }
        else {
        ...
        if (object.httpChallenge !== undefined &&
            ...
            message.httpChallenge = Challenge_HttpFile.fromJSON(object.httpChallenge);
        }
        else {
    ...
    fromPartial(object) {
        ...
        if (object.dnsChallenge !== undefined && object.dnsChallenge !== null) {
            message.dnsChallenge = Challenge_DnsRecord.fromPartial(object.dnsChallenge);
        }
        else {
            message.dnsChallenge = undefined;
        }
        if (object.httpChallenge !== undefined &&
            object.httpChallenge !== null) {
            message.httpChallenge = Challenge_HttpFile.fromPartial(object.httpChallenge);
        }
        else {
            message.httpChallenge = undefined;
        }
