...
import { healthFromJSON, healthToJSON, } from '../../../../yandex/cloud/dataproc/v1/common';
...
export var HadoopConfig_Service;
...
})(HadoopConfig_Service || (HadoopConfig_Service = {}));
export function hadoopConfig_ServiceFromJSON(object) {
    switch (object) {
        case 0:
...
export function hadoopConfig_ServiceToJSON(object) {
    switch (object) {
...
const baseHadoopConfig = { services: 0, sshPublicKeys: '' };
export const HadoopConfig = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        Object.entries(message.properties).forEach(([key, value]) => {
            HadoopConfig_PropertiesEntry.encode({ key: key, value }, writer.uint32(18).fork()).ldelim();
        });
...
const baseHadoopConfig_PropertiesEntry = { key: '', value: '' };
...
const baseClusterConfig = { versionId: '' };
