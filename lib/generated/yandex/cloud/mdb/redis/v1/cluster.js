...
export const ClusterConfig = {
    ...
    fromJSON(object) {
        ...
        if (object.redisConfig50 !== undefined &&
            ...
            message.redisConfig50 = Redisconfigset50.fromJSON(object.redisConfig50);
        }
        else {
        ...
        if (object.redisConfig60 !== undefined &&
            ...
            message.redisConfig60 = Redisconfigset60.fromJSON(object.redisConfig60);
        }
        else {
        ...
        if (object.redisConfig62 !== undefined &&
            ...
            message.redisConfig62 = Redisconfigset62.fromJSON(object.redisConfig62);
        }
        else {
    ...
    fromPartial(object) {
        ...
        if (object.redisConfig50 !== undefined &&
            object.redisConfig50 !== null) {
            message.redisConfig50 = Redisconfigset50.fromPartial(object.redisConfig50);
        }
        else {
            message.redisConfig50 = undefined;
        }
        if (object.redisConfig60 !== undefined &&
            object.redisConfig60 !== null) {
            message.redisConfig60 = Redisconfigset60.fromPartial(object.redisConfig60);
        }
        else {
            message.redisConfig60 = undefined;
        }
        if (object.redisConfig62 !== undefined &&
            object.redisConfig62 !== null) {
            message.redisConfig62 = Redisconfigset62.fromPartial(object.redisConfig62);
        }
        else {
            message.redisConfig62 = undefined;
        }
