...
import { Cluster, Host, Shard, Resources, Access, cluster_EnvironmentFromJSON, cluster_EnvironmentToJSON, } from '../../../../../yandex/cloud/mdb/redis/v1/cluster';
...
export const CreateClusterRequest = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.tlsEnabled !== undefined) {
            BoolValue.encode({ value: message.tlsEnabled }, writer.uint32(106).fork()).ldelim();
        }
...
export const RestoreClusterRequest = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.tlsEnabled !== undefined) {
            BoolValue.encode({ value: message.tlsEnabled }, writer.uint32(90).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
...
export const ConfigSpec = {
    ...
    fromJSON(object) {
        ...
        if (object.redisConfig50 !== undefined &&
            ...
            message.redisConfig50 = Redisconfig50.fromJSON(object.redisConfig50);
        }
        else {
        ...
        if (object.redisConfig60 !== undefined &&
            ...
            message.redisConfig60 = Redisconfig60.fromJSON(object.redisConfig60);
        }
        else {
        ...
        if (object.redisConfig62 !== undefined &&
            ...
            message.redisConfig62 = Redisconfig62.fromJSON(object.redisConfig62);
        }
        else {
    ...
    fromPartial(object) {
        ...
        if (object.redisConfig50 !== undefined &&
            object.redisConfig50 !== null) {
            message.redisConfig50 = Redisconfig50.fromPartial(object.redisConfig50);
        }
        else {
            message.redisConfig50 = undefined;
        }
        if (object.redisConfig60 !== undefined &&
            object.redisConfig60 !== null) {
            message.redisConfig60 = Redisconfig60.fromPartial(object.redisConfig60);
        }
        else {
            message.redisConfig60 = undefined;
        }
        if (object.redisConfig62 !== undefined &&
            object.redisConfig62 !== null) {
            message.redisConfig62 = Redisconfig62.fromPartial(object.redisConfig62);
        }
        else {
            message.redisConfig62 = undefined;
        }
...
export const ClusterServiceService = {
    ...
    rebalance: {
        ...
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(RebalanceClusterRequest.encode(value).finish()),
        requestDeserialize: (value) => RebalanceClusterRequest.decode(value),
        responseSerialize: (value) => Buffer.from(Operation.encode(value).finish()),
        responseDeserialize: (value) => Operation.decode(value),
    },
};
export const ClusterServiceClient = makeGenericClientConstructor(ClusterServiceService, 'yandex.cloud.mdb.redis.v1.ClusterService');
var globalThis = (() => {
