...
exports.Redisconfigset60 = exports.Redisconfig60 = exports.redisconfig60_MaxmemoryPolicyToJSON = exports.redisconfig60_MaxmemoryPolicyFromJSON = exports.Redisconfig60_MaxmemoryPolicy = exports.protobufPackage = void 0;
/* eslint-disable */
...
var Redisconfig60_MaxmemoryPolicy;
...
})(Redisconfig60_MaxmemoryPolicy = exports.Redisconfig60_MaxmemoryPolicy || (exports.Redisconfig60_MaxmemoryPolicy = {}));
function redisconfig60_MaxmemoryPolicyFromJSON(object) {
    switch (object) {
        case 0:
...
exports.redisconfig60_MaxmemoryPolicyFromJSON = redisconfig60_MaxmemoryPolicyFromJSON;
function redisconfig60_MaxmemoryPolicyToJSON(object) {
    switch (object) {
...
exports.redisconfig60_MaxmemoryPolicyToJSON = redisconfig60_MaxmemoryPolicyToJSON;
...
typeRegistry_1.messageTypeRegistry.set(exports.Redisconfig60.$type, exports.Redisconfig60);
const baseRedisconfigset60 = {
    $type: 'yandex.cloud.mdb.redis.v1.config.RedisConfigSet6_0',
};
exports.Redisconfigset60 = {
    $type: 'yandex.cloud.mdb.redis.v1.config.RedisConfigSet6_0',
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.effectiveConfig !== undefined) {
            exports.Redisconfig60.encode(message.effectiveConfig, writer.uint32(10).fork()).ldelim();
        }
        if (message.userConfig !== undefined) {
            exports.Redisconfig60.encode(message.userConfig, writer.uint32(18).fork()).ldelim();
        }
        if (message.defaultConfig !== undefined) {
            exports.Redisconfig60.encode(message.defaultConfig, writer.uint32(26).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.effectiveConfig = exports.Redisconfig60.decode(reader, reader.uint32());
                    break;
                case 2:
                    message.userConfig = exports.Redisconfig60.decode(reader, reader.uint32());
                    break;
                case 3:
                    message.defaultConfig = exports.Redisconfig60.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        ...
        if (object.effectiveConfig !== undefined &&
            ...
            message.effectiveConfig = exports.Redisconfig60.fromJSON(object.effectiveConfig);
        }
        else {
            message.effectiveConfig = undefined;
        }
        if (object.userConfig !== undefined && object.userConfig !== null) {
            message.userConfig = exports.Redisconfig60.fromJSON(object.userConfig);
        }
        else {
        ...
        if (object.defaultConfig !== undefined &&
            ...
            message.defaultConfig = exports.Redisconfig60.fromJSON(object.defaultConfig);
        }
        else {
    ...
    toJSON(message) {
        ...
        message.effectiveConfig !== undefined &&
            (obj.effectiveConfig = message.effectiveConfig
                ? exports.Redisconfig60.toJSON(message.effectiveConfig)
                : undefined);
        message.userConfig !== undefined &&
            (obj.userConfig = message.userConfig
                ? exports.Redisconfig60.toJSON(message.userConfig)
                : undefined);
        message.defaultConfig !== undefined &&
            (obj.defaultConfig = message.defaultConfig
                ? exports.Redisconfig60.toJSON(message.defaultConfig)
                : undefined);
        return obj;
    },
    fromPartial(object) {
        ...
        if (object.effectiveConfig !== undefined &&
            object.effectiveConfig !== null) {
            message.effectiveConfig = exports.Redisconfig60.fromPartial(object.effectiveConfig);
        }
        else {
            message.effectiveConfig = undefined;
        }
        if (object.userConfig !== undefined && object.userConfig !== null) {
            message.userConfig = exports.Redisconfig60.fromPartial(object.userConfig);
        }
        else {
            message.userConfig = undefined;
        }
        if (object.defaultConfig !== undefined &&
            object.defaultConfig !== null) {
            message.defaultConfig = exports.Redisconfig60.fromPartial(object.defaultConfig);
        }
        else {
            message.defaultConfig = undefined;
        }
...
typeRegistry_1.messageTypeRegistry.set(exports.Redisconfigset60.$type, exports.Redisconfigset60);
