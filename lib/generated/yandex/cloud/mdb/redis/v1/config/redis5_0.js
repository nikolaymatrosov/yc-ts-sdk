...
export var Redisconfig50_MaxmemoryPolicy;
...
})(Redisconfig50_MaxmemoryPolicy || (Redisconfig50_MaxmemoryPolicy = {}));
export function redisconfig50_MaxmemoryPolicyFromJSON(object) {
    switch (object) {
        case 0:
...
export function redisconfig50_MaxmemoryPolicyToJSON(object) {
    switch (object) {
...
export const Redisconfigset50 = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.userConfig !== undefined) {
            Redisconfig50.encode(message.userConfig, writer.uint32(18).fork()).ldelim();
        }
        if (message.defaultConfig !== undefined) {
            Redisconfig50.encode(message.defaultConfig, writer.uint32(26).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.effectiveConfig = Redisconfig50.decode(reader, reader.uint32());
                    break;
                case 2:
    ...
    fromJSON(object) {
        ...
        if (object.effectiveConfig !== undefined &&
            ...
            message.effectiveConfig = Redisconfig50.fromJSON(object.effectiveConfig);
        }
        else {
        ...
        if (object.defaultConfig !== undefined &&
            ...
            message.defaultConfig = Redisconfig50.fromJSON(object.defaultConfig);
        }
        else {
    ...
    fromPartial(object) {
        ...
        if (object.effectiveConfig !== undefined &&
            object.effectiveConfig !== null) {
            message.effectiveConfig = Redisconfig50.fromPartial(object.effectiveConfig);
        }
        else {
            message.effectiveConfig = undefined;
        }
        ...
        if (object.defaultConfig !== undefined &&
            object.defaultConfig !== null) {
            message.defaultConfig = Redisconfig50.fromPartial(object.defaultConfig);
        }
        else {
            message.defaultConfig = undefined;
        }
