...
exports.AddClusterHostsRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.copySchema !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.copySchema }, writer.uint32(26).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
...
exports.AddClusterShardRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.copySchema !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.copySchema }, writer.uint32(42).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
...
exports.ConfigSpec = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.sqlDatabaseManagement !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.sqlDatabaseManagement }, writer.uint32(58).fork()).ldelim();
        }
        if (message.sqlUserManagement !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.sqlUserManagement }, writer.uint32(66).fork()).ldelim();
        }
...
exports.ShardConfigSpec_Clickhouse = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.weight !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.weight }, writer.uint32(26).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
