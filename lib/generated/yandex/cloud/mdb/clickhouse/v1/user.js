...
exports.UserSettings = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.readonly !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.readonly }, writer.uint32(10).fork()).ldelim();
        }
        if (message.allowDdl !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.allowDdl }, writer.uint32(18).fork()).ldelim();
        }
        if (message.insertQuorum !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.insertQuorum }, writer.uint32(26).fork()).ldelim();
        }
        if (message.connectTimeout !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.connectTimeout }, writer.uint32(314).fork()).ldelim();
        }
        if (message.receiveTimeout !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.receiveTimeout }, writer.uint32(322).fork()).ldelim();
        }
        if (message.sendTimeout !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.sendTimeout }, writer.uint32(330).fork()).ldelim();
        }
        if (message.insertQuorumTimeout !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.insertQuorumTimeout }, writer.uint32(34).fork()).ldelim();
        }
        if (message.selectSequentialConsistency !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.selectSequentialConsistency }, writer.uint32(42).fork()).ldelim();
        }
        if (message.maxReplicaDelayForDistributedQueries !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxReplicaDelayForDistributedQueries }, writer.uint32(50).fork()).ldelim();
        }
        ...
        if (message.replicationAlterPartitionsSync !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.replicationAlterPartitionsSync }, writer.uint32(338).fork()).ldelim();
        }
        ...
        if (message.distributedAggregationMemoryEfficient !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.distributedAggregationMemoryEfficient }, writer.uint32(578).fork()).ldelim();
        }
        if (message.distributedDdlTaskTimeout !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.distributedDdlTaskTimeout }, writer.uint32(586).fork()).ldelim();
        }
        if (message.skipUnavailableShards !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.skipUnavailableShards }, writer.uint32(650).fork()).ldelim();
        }
        if (message.compile !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.compile }, writer.uint32(354).fork()).ldelim();
        }
        if (message.minCountToCompile !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.minCountToCompile }, writer.uint32(362).fork()).ldelim();
        }
        if (message.compileExpressions !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.compileExpressions }, writer.uint32(370).fork()).ldelim();
        }
        if (message.minCountToCompileExpression !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.minCountToCompileExpression }, writer.uint32(378).fork()).ldelim();
        }
        if (message.maxBlockSize !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxBlockSize }, writer.uint32(74).fork()).ldelim();
        }
        if (message.minInsertBlockSizeRows !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.minInsertBlockSizeRows }, writer.uint32(386).fork()).ldelim();
        }
        if (message.minInsertBlockSizeBytes !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.minInsertBlockSizeBytes }, writer.uint32(394).fork()).ldelim();
        }
        if (message.maxInsertBlockSize !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxInsertBlockSize }, writer.uint32(82).fork()).ldelim();
        }
        if (message.minBytesToUseDirectIo !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.minBytesToUseDirectIo }, writer.uint32(402).fork()).ldelim();
        }
        if (message.useUncompressedCache !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.useUncompressedCache }, writer.uint32(410).fork()).ldelim();
        }
        if (message.mergeTreeMaxRowsToUseCache !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.mergeTreeMaxRowsToUseCache }, writer.uint32(418).fork()).ldelim();
        }
        if (message.mergeTreeMaxBytesToUseCache !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.mergeTreeMaxBytesToUseCache }, writer.uint32(426).fork()).ldelim();
        }
        if (message.mergeTreeMinRowsForConcurrentRead !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.mergeTreeMinRowsForConcurrentRead }, writer.uint32(434).fork()).ldelim();
        }
        if (message.mergeTreeMinBytesForConcurrentRead !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.mergeTreeMinBytesForConcurrentRead }, writer.uint32(442).fork()).ldelim();
        }
        if (message.maxBytesBeforeExternalGroupBy !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxBytesBeforeExternalGroupBy }, writer.uint32(594).fork()).ldelim();
        }
        if (message.maxBytesBeforeExternalSort !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxBytesBeforeExternalSort }, writer.uint32(602).fork()).ldelim();
        }
        if (message.groupByTwoLevelThreshold !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.groupByTwoLevelThreshold }, writer.uint32(610).fork()).ldelim();
        }
        if (message.groupByTwoLevelThresholdBytes !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.groupByTwoLevelThresholdBytes }, writer.uint32(618).fork()).ldelim();
        }
        if (message.priority !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.priority }, writer.uint32(450).fork()).ldelim();
        }
        if (message.maxThreads !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxThreads }, writer.uint32(66).fork()).ldelim();
        }
        if (message.maxMemoryUsage !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxMemoryUsage }, writer.uint32(90).fork()).ldelim();
        }
        if (message.maxMemoryUsageForUser !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxMemoryUsageForUser }, writer.uint32(98).fork()).ldelim();
        }
        if (message.maxNetworkBandwidth !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxNetworkBandwidth }, writer.uint32(458).fork()).ldelim();
        }
        if (message.maxNetworkBandwidthForUser !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxNetworkBandwidthForUser }, writer.uint32(466).fork()).ldelim();
        }
        if (message.forceIndexByDate !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.forceIndexByDate }, writer.uint32(474).fork()).ldelim();
        }
        if (message.forcePrimaryKey !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.forcePrimaryKey }, writer.uint32(482).fork()).ldelim();
        }
        if (message.maxRowsToRead !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxRowsToRead }, writer.uint32(106).fork()).ldelim();
        }
        if (message.maxBytesToRead !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxBytesToRead }, writer.uint32(114).fork()).ldelim();
        }
        if (message.readOverflowMode !== 0) {
            writer.uint32(120).int32(message.readOverflowMode);
        }
        if (message.maxRowsToGroupBy !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxRowsToGroupBy }, writer.uint32(130).fork()).ldelim();
        }
        if (message.groupByOverflowMode !== 0) {
            writer.uint32(136).int32(message.groupByOverflowMode);
        }
        if (message.maxRowsToSort !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxRowsToSort }, writer.uint32(146).fork()).ldelim();
        }
        if (message.maxBytesToSort !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxBytesToSort }, writer.uint32(154).fork()).ldelim();
        }
        if (message.sortOverflowMode !== 0) {
            writer.uint32(160).int32(message.sortOverflowMode);
        }
        if (message.maxResultRows !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxResultRows }, writer.uint32(170).fork()).ldelim();
        }
        if (message.maxResultBytes !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxResultBytes }, writer.uint32(178).fork()).ldelim();
        }
        if (message.resultOverflowMode !== 0) {
            writer.uint32(184).int32(message.resultOverflowMode);
        }
        if (message.maxRowsInDistinct !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxRowsInDistinct }, writer.uint32(194).fork()).ldelim();
        }
        if (message.maxBytesInDistinct !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxBytesInDistinct }, writer.uint32(202).fork()).ldelim();
        }
        ...
        if (message.maxRowsToTransfer !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxRowsToTransfer }, writer.uint32(218).fork()).ldelim();
        }
        if (message.maxBytesToTransfer !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxBytesToTransfer }, writer.uint32(226).fork()).ldelim();
        }
        ...
        if (message.maxExecutionTime !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxExecutionTime }, writer.uint32(242).fork()).ldelim();
        }
        if (message.timeoutOverflowMode !== 0) {
            writer.uint32(248).int32(message.timeoutOverflowMode);
        }
        if (message.maxRowsInSet !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxRowsInSet }, writer.uint32(698).fork()).ldelim();
        }
        if (message.maxBytesInSet !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxBytesInSet }, writer.uint32(706).fork()).ldelim();
        }
        if (message.setOverflowMode !== 0) {
            writer.uint32(712).int32(message.setOverflowMode);
        }
        if (message.maxRowsInJoin !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxRowsInJoin }, writer.uint32(722).fork()).ldelim();
        }
        if (message.maxBytesInJoin !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxBytesInJoin }, writer.uint32(730).fork()).ldelim();
        }
        if (message.joinOverflowMode !== 0) {
            writer.uint32(736).int32(message.joinOverflowMode);
        }
        if (message.maxColumnsToRead !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxColumnsToRead }, writer.uint32(258).fork()).ldelim();
        }
        if (message.maxTemporaryColumns !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxTemporaryColumns }, writer.uint32(266).fork()).ldelim();
        }
        if (message.maxTemporaryNonConstColumns !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxTemporaryNonConstColumns }, writer.uint32(274).fork()).ldelim();
        }
        if (message.maxQuerySize !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxQuerySize }, writer.uint32(282).fork()).ldelim();
        }
        if (message.maxAstDepth !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxAstDepth }, writer.uint32(290).fork()).ldelim();
        }
        if (message.maxAstElements !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxAstElements }, writer.uint32(298).fork()).ldelim();
        }
        if (message.maxExpandedAstElements !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxExpandedAstElements }, writer.uint32(306).fork()).ldelim();
        }
        if (message.minExecutionSpeed !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.minExecutionSpeed }, writer.uint32(674).fork()).ldelim();
        }
        if (message.minExecutionSpeedBytes !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.minExecutionSpeedBytes }, writer.uint32(682).fork()).ldelim();
        }
        ...
        if (message.inputFormatValuesInterpretExpressions !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.inputFormatValuesInterpretExpressions }, writer.uint32(490).fork()).ldelim();
        }
        if (message.inputFormatDefaultsForOmittedFields !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.inputFormatDefaultsForOmittedFields }, writer.uint32(498).fork()).ldelim();
        }
        if (message.outputFormatJsonQuote64bitIntegers !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.outputFormatJsonQuote64bitIntegers }, writer.uint32(506).fork()).ldelim();
        }
        if (message.outputFormatJsonQuoteDenormals !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.outputFormatJsonQuoteDenormals }, writer.uint32(514).fork()).ldelim();
        }
        if (message.lowCardinalityAllowInNativeFormat !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.lowCardinalityAllowInNativeFormat }, writer.uint32(626).fork()).ldelim();
        }
        if (message.emptyResultForAggregationByEmptySet !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.emptyResultForAggregationByEmptySet }, writer.uint32(634).fork()).ldelim();
        }
        if (message.joinedSubqueryRequiresAlias !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.joinedSubqueryRequiresAlias }, writer.uint32(746).fork()).ldelim();
        }
        if (message.joinUseNulls !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.joinUseNulls }, writer.uint32(754).fork()).ldelim();
        }
        if (message.transformNullIn !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.transformNullIn }, writer.uint32(762).fork()).ldelim();
        }
        if (message.httpConnectionTimeout !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.httpConnectionTimeout }, writer.uint32(522).fork()).ldelim();
        }
        if (message.httpReceiveTimeout !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.httpReceiveTimeout }, writer.uint32(530).fork()).ldelim();
        }
        if (message.httpSendTimeout !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.httpSendTimeout }, writer.uint32(538).fork()).ldelim();
        }
        if (message.enableHttpCompression !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.enableHttpCompression }, writer.uint32(546).fork()).ldelim();
        }
        if (message.sendProgressInHttpHeaders !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.sendProgressInHttpHeaders }, writer.uint32(554).fork()).ldelim();
        }
        if (message.httpHeadersProgressInterval !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.httpHeadersProgressInterval }, writer.uint32(562).fork()).ldelim();
        }
        if (message.addHttpCorsHeader !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.addHttpCorsHeader }, writer.uint32(570).fork()).ldelim();
        }
...
exports.UserQuota = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.intervalDuration !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.intervalDuration }, writer.uint32(10).fork()).ldelim();
        }
        if (message.queries !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.queries }, writer.uint32(18).fork()).ldelim();
        }
        if (message.errors !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.errors }, writer.uint32(26).fork()).ldelim();
        }
        if (message.resultRows !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.resultRows }, writer.uint32(34).fork()).ldelim();
        }
        if (message.readRows !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.readRows }, writer.uint32(42).fork()).ldelim();
        }
        if (message.executionTime !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.executionTime }, writer.uint32(50).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
