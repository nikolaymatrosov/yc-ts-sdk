...
export const ClusterConfig = {
    ...
    fromJSON(object) {
        ...
        if (object.clickhouse !== undefined && object.clickhouse !== null) {
            message.clickhouse = ClusterConfig_Clickhouse.fromJSON(object.clickhouse);
        }
        else {
            message.clickhouse = undefined;
        }
        if (object.zookeeper !== undefined && object.zookeeper !== null) {
            message.zookeeper = ClusterConfig_Zookeeper.fromJSON(object.zookeeper);
        }
        else {
    ...
    fromPartial(object) {
        ...
        if (object.clickhouse !== undefined && object.clickhouse !== null) {
            message.clickhouse = ClusterConfig_Clickhouse.fromPartial(object.clickhouse);
        }
        else {
            message.clickhouse = undefined;
        }
        if (object.zookeeper !== undefined && object.zookeeper !== null) {
            message.zookeeper = ClusterConfig_Zookeeper.fromPartial(object.zookeeper);
        }
        else {
            message.zookeeper = undefined;
        }
...
export const ShardConfig = {
    ...
    fromJSON(object) {
        const message = { ...baseShardConfig };
        if (object.clickhouse !== undefined && object.clickhouse !== null) {
            message.clickhouse = ShardConfig_Clickhouse.fromJSON(object.clickhouse);
        }
        else {
            message.clickhouse = undefined;
        }
    ...
    fromPartial(object) {
        const message = { ...baseShardConfig };
        if (object.clickhouse !== undefined && object.clickhouse !== null) {
            message.clickhouse = ShardConfig_Clickhouse.fromPartial(object.clickhouse);
        }
        else {
            message.clickhouse = undefined;
        }
...
const baseCloudStorage = { enabled: false };
