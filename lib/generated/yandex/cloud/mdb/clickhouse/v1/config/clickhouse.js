...
exports.ClickhouseConfig = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.maxConnections !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxConnections }, writer.uint32(50).fork()).ldelim();
        }
        if (message.maxConcurrentQueries !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxConcurrentQueries }, writer.uint32(58).fork()).ldelim();
        }
        if (message.keepAliveTimeout !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.keepAliveTimeout }, writer.uint32(66).fork()).ldelim();
        }
        if (message.uncompressedCacheSize !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.uncompressedCacheSize }, writer.uint32(74).fork()).ldelim();
        }
        if (message.markCacheSize !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.markCacheSize }, writer.uint32(82).fork()).ldelim();
        }
        if (message.maxTableSizeToDrop !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxTableSizeToDrop }, writer.uint32(90).fork()).ldelim();
        }
        if (message.maxPartitionSizeToDrop !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxPartitionSizeToDrop }, writer.uint32(106).fork()).ldelim();
        }
        if (message.builtinDictionariesReloadInterval !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.builtinDictionariesReloadInterval }, writer.uint32(98).fork()).ldelim();
        }
        if (message.timezone !== '') {
        ...
        if (message.queryLogRetentionSize !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.queryLogRetentionSize }, writer.uint32(130).fork()).ldelim();
        }
        if (message.queryLogRetentionTime !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.queryLogRetentionTime }, writer.uint32(138).fork()).ldelim();
        }
        if (message.queryThreadLogEnabled !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.queryThreadLogEnabled }, writer.uint32(146).fork()).ldelim();
        }
        if (message.queryThreadLogRetentionSize !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.queryThreadLogRetentionSize }, writer.uint32(154).fork()).ldelim();
        }
        if (message.queryThreadLogRetentionTime !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.queryThreadLogRetentionTime }, writer.uint32(162).fork()).ldelim();
        }
        if (message.partLogRetentionSize !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.partLogRetentionSize }, writer.uint32(170).fork()).ldelim();
        }
        if (message.partLogRetentionTime !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.partLogRetentionTime }, writer.uint32(178).fork()).ldelim();
        }
        if (message.metricLogEnabled !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.metricLogEnabled }, writer.uint32(186).fork()).ldelim();
        }
        if (message.metricLogRetentionSize !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.metricLogRetentionSize }, writer.uint32(194).fork()).ldelim();
        }
        if (message.metricLogRetentionTime !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.metricLogRetentionTime }, writer.uint32(202).fork()).ldelim();
        }
        if (message.traceLogEnabled !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.traceLogEnabled }, writer.uint32(210).fork()).ldelim();
        }
        if (message.traceLogRetentionSize !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.traceLogRetentionSize }, writer.uint32(218).fork()).ldelim();
        }
        if (message.traceLogRetentionTime !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.traceLogRetentionTime }, writer.uint32(226).fork()).ldelim();
        }
        if (message.textLogEnabled !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.textLogEnabled }, writer.uint32(234).fork()).ldelim();
        }
        if (message.textLogRetentionSize !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.textLogRetentionSize }, writer.uint32(242).fork()).ldelim();
        }
        if (message.textLogRetentionTime !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.textLogRetentionTime }, writer.uint32(250).fork()).ldelim();
        }
        if (message.textLogLevel !== 0) {
            writer.uint32(256).int32(message.textLogLevel);
        }
        if (message.backgroundPoolSize !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.backgroundPoolSize }, writer.uint32(266).fork()).ldelim();
        }
        if (message.backgroundSchedulePoolSize !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.backgroundSchedulePoolSize }, writer.uint32(274).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromJSON(object) {
        ...
        if (object.mergeTree !== undefined && object.mergeTree !== null) {
            message.mergeTree = exports.ClickhouseConfig_MergeTree.fromJSON(object.mergeTree);
        }
        else {
        ...
        if (object.compression !== undefined && object.compression !== null) {
            for (const e of object.compression) {
                message.compression.push(exports.ClickhouseConfig_Compression.fromJSON(e));
            }
        }
        if (object.dictionaries !== undefined && object.dictionaries !== null) {
            for (const e of object.dictionaries) {
                message.dictionaries.push(exports.ClickhouseConfig_ExternalDictionary.fromJSON(e));
            }
        }
        if (object.graphiteRollup !== undefined &&
            object.graphiteRollup !== null) {
            for (const e of object.graphiteRollup) {
                message.graphiteRollup.push(exports.ClickhouseConfig_GraphiteRollup.fromJSON(e));
            }
        }
        if (object.kafka !== undefined && object.kafka !== null) {
            message.kafka = exports.ClickhouseConfig_Kafka.fromJSON(object.kafka);
        }
        else {
        ...
        if (object.kafkaTopics !== undefined && object.kafkaTopics !== null) {
            for (const e of object.kafkaTopics) {
                message.kafkaTopics.push(exports.ClickhouseConfig_KafkaTopic.fromJSON(e));
            }
        }
        if (object.rabbitmq !== undefined && object.rabbitmq !== null) {
            message.rabbitmq = exports.ClickhouseConfig_Rabbitmq.fromJSON(object.rabbitmq);
        }
        else {
    ...
    fromPartial(object) {
        ...
        if (object.mergeTree !== undefined && object.mergeTree !== null) {
            message.mergeTree = exports.ClickhouseConfig_MergeTree.fromPartial(object.mergeTree);
        }
        else {
            message.mergeTree = undefined;
        }
        if (object.compression !== undefined && object.compression !== null) {
            for (const e of object.compression) {
                message.compression.push(exports.ClickhouseConfig_Compression.fromPartial(e));
            }
        }
        if (object.dictionaries !== undefined && object.dictionaries !== null) {
            for (const e of object.dictionaries) {
                message.dictionaries.push(exports.ClickhouseConfig_ExternalDictionary.fromPartial(e));
            }
        }
        if (object.graphiteRollup !== undefined &&
            object.graphiteRollup !== null) {
            for (const e of object.graphiteRollup) {
                message.graphiteRollup.push(exports.ClickhouseConfig_GraphiteRollup.fromPartial(e));
            }
        }
        if (object.kafka !== undefined && object.kafka !== null) {
            message.kafka = exports.ClickhouseConfig_Kafka.fromPartial(object.kafka);
        }
        else {
            message.kafka = undefined;
        }
        if (object.kafkaTopics !== undefined && object.kafkaTopics !== null) {
            for (const e of object.kafkaTopics) {
                message.kafkaTopics.push(exports.ClickhouseConfig_KafkaTopic.fromPartial(e));
            }
        }
        if (object.rabbitmq !== undefined && object.rabbitmq !== null) {
            message.rabbitmq = exports.ClickhouseConfig_Rabbitmq.fromPartial(object.rabbitmq);
        }
        else {
            message.rabbitmq = undefined;
        }
...
exports.ClickhouseConfig_MergeTree = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.replicatedDeduplicationWindow !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.replicatedDeduplicationWindow }, writer.uint32(10).fork()).ldelim();
        }
        if (message.replicatedDeduplicationWindowSeconds !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.replicatedDeduplicationWindowSeconds }, writer.uint32(18).fork()).ldelim();
        }
        if (message.partsToDelayInsert !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.partsToDelayInsert }, writer.uint32(26).fork()).ldelim();
        }
        if (message.partsToThrowInsert !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.partsToThrowInsert }, writer.uint32(34).fork()).ldelim();
        }
        if (message.maxReplicatedMergesInQueue !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxReplicatedMergesInQueue }, writer.uint32(42).fork()).ldelim();
        }
        ...
        if (message.maxBytesToMergeAtMinSpaceInPool !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxBytesToMergeAtMinSpaceInPool }, writer.uint32(58).fork()).ldelim();
        }
        if (message.maxBytesToMergeAtMaxSpaceInPool !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxBytesToMergeAtMaxSpaceInPool }, writer.uint32(66).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
...
exports.ClickhouseConfig_KafkaTopic = {
    ...
    fromJSON(object) {
        ...
        if (object.settings !== undefined && object.settings !== null) {
            message.settings = exports.ClickhouseConfig_Kafka.fromJSON(object.settings);
        }
        else {
    ...
    fromPartial(object) {
        ...
        if (object.settings !== undefined && object.settings !== null) {
            message.settings = exports.ClickhouseConfig_Kafka.fromPartial(object.settings);
        }
        else {
            message.settings = undefined;
        }
    ...
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 3:
                    message.layout =
                        exports.ClickhouseConfig_ExternalDictionary_Layout.decode(reader, reader.uint32());
                    break;
                case 4:
...
exports.ClickhouseConfig_ExternalDictionary_MysqlSource = {
    ...
    fromJSON(object) {
        ...
        if (object.replicas !== undefined && object.replicas !== null) {
            for (const e of object.replicas) {
                message.replicas.push(exports.ClickhouseConfig_ExternalDictionary_MysqlSource_Replica.fromJSON(e));
            }
        }
    ...
    fromPartial(object) {
        ...
        if (object.replicas !== undefined && object.replicas !== null) {
            for (const e of object.replicas) {
                message.replicas.push(exports.ClickhouseConfig_ExternalDictionary_MysqlSource_Replica.fromPartial(e));
            }
        }
        if (object.where !== undefined && object.where !== null) {
...
exports.ClickhouseConfig_ExternalDictionary_Structure = {
    ...
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.id =
                        exports.ClickhouseConfig_ExternalDictionary_Structure_Id.decode(reader, reader.uint32());
                    break;
                case 3:
                    message.key =
    ...
    fromJSON(object) {
        ...
        if (object.attributes !== undefined && object.attributes !== null) {
            for (const e of object.attributes) {
                message.attributes.push(exports.ClickhouseConfig_ExternalDictionary_Structure_Attribute.fromJSON(e));
            }
        }
        return message;
    },
    ...
    fromPartial(object) {
        ...
        if (object.attributes !== undefined && object.attributes !== null) {
            for (const e of object.attributes) {
                message.attributes.push(exports.ClickhouseConfig_ExternalDictionary_Structure_Attribute.fromPartial(e));
            }
        }
        return message;
    },
...
exports.ClickhouseConfig_GraphiteRollup = {
    ...
    fromJSON(object) {
        ...
        if (object.patterns !== undefined && object.patterns !== null) {
            for (const e of object.patterns) {
                message.patterns.push(exports.ClickhouseConfig_GraphiteRollup_Pattern.fromJSON(e));
            }
        }
        return message;
    },
    toJSON(message) {
        ...
        if (message.patterns) {
            obj.patterns = message.patterns.map((e) => e
                ? exports.ClickhouseConfig_GraphiteRollup_Pattern.toJSON(e)
                : undefined);
        }
        else {
            obj.patterns = [];
    ...
    fromPartial(object) {
        ...
        if (object.patterns !== undefined && object.patterns !== null) {
            for (const e of object.patterns) {
                message.patterns.push(exports.ClickhouseConfig_GraphiteRollup_Pattern.fromPartial(e));
            }
        }
        return message;
    },
...
exports.ClickhouseConfig_GraphiteRollup_Pattern = {
    ...
    fromJSON(object) {
        ...
        if (object.retention !== undefined && object.retention !== null) {
            for (const e of object.retention) {
                message.retention.push(exports.ClickhouseConfig_GraphiteRollup_Pattern_Retention.fromJSON(e));
            }
        }
        return message;
    },
    ...
    fromPartial(object) {
        ...
        if (object.retention !== undefined && object.retention !== null) {
            for (const e of object.retention) {
                message.retention.push(exports.ClickhouseConfig_GraphiteRollup_Pattern_Retention.fromPartial(e));
            }
        }
        return message;
    },
...
exports.ClickhouseConfigSet = {
    ...
    fromJSON(object) {
        ...
        if (object.effectiveConfig !== undefined &&
            ...
            message.effectiveConfig = exports.ClickhouseConfig.fromJSON(object.effectiveConfig);
        }
        else {
            message.effectiveConfig = undefined;
        }
        if (object.userConfig !== undefined && object.userConfig !== null) {
            message.userConfig = exports.ClickhouseConfig.fromJSON(object.userConfig);
        }
        else {
        ...
        if (object.defaultConfig !== undefined &&
            ...
            message.defaultConfig = exports.ClickhouseConfig.fromJSON(object.defaultConfig);
        }
        else {
    ...
    fromPartial(object) {
        ...
        if (object.effectiveConfig !== undefined &&
            object.effectiveConfig !== null) {
            message.effectiveConfig = exports.ClickhouseConfig.fromPartial(object.effectiveConfig);
        }
        else {
            message.effectiveConfig = undefined;
        }
        if (object.userConfig !== undefined && object.userConfig !== null) {
            message.userConfig = exports.ClickhouseConfig.fromPartial(object.userConfig);
        }
        else {
            message.userConfig = undefined;
        }
        if (object.defaultConfig !== undefined &&
            object.defaultConfig !== null) {
            message.defaultConfig = exports.ClickhouseConfig.fromPartial(object.defaultConfig);
        }
        else {
            message.defaultConfig = undefined;
        }
