...
const baseUpdateDatabaseRequest = { clusterId: '', databaseName: '' };
...
const baseUpdateDatabaseMetadata = { clusterId: '', databaseName: '' };
...
export const DatabaseServiceClient = makeGenericClientConstructor(DatabaseServiceService, 'yandex.cloud.mdb.postgresql.v1.DatabaseService');
var globalThis = (() => {
