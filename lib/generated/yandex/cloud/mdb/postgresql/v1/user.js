...
exports.User = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.login !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.login }, writer.uint32(50).fork()).ldelim();
        }
...
exports.UserSpec = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.connLimit !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.connLimit }, writer.uint32(34).fork()).ldelim();
        }
        if (message.settings !== undefined) {
            exports.UserSettings.encode(message.settings, writer.uint32(42).fork()).ldelim();
        }
...
exports.UserSettings = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.lockTimeout !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.lockTimeout }, writer.uint32(18).fork()).ldelim();
        }
        if (message.logMinDurationStatement !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.logMinDurationStatement }, writer.uint32(26).fork()).ldelim();
        }
