...
exports.UpdateHostSpec = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.priority !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.priority }, writer.uint32(26).fork()).ldelim();
        }
        if (message.configSpec !== undefined) {
...
exports.HostSpec = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.priority !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.priority }, writer.uint32(42).fork()).ldelim();
        }
        if (message.configSpec !== undefined) {
...
exports.ConfigSpec = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.autofailover !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.autofailover }, writer.uint32(50).fork()).ldelim();
        }
        ...
        if (message.backupRetainPeriodDays !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.backupRetainPeriodDays }, writer.uint32(138).fork()).ldelim();
        }
