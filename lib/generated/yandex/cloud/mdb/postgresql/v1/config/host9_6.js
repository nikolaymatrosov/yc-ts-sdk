...
exports.Postgresqlhostconfig96 = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.sqlInheritance !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.sqlInheritance }, writer.uint32(426).fork()).ldelim();
        }
        if (message.effectiveIoConcurrency !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.effectiveIoConcurrency }, writer.uint32(434).fork()).ldelim();
        }
        if (message.effectiveCacheSize !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.effectiveCacheSize }, writer.uint32(442).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
