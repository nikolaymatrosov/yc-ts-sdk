...
exports.PostgresqlHostConfig11 = exports.postgresqlHostConfig11_BackslashQuoteToJSON = exports.postgresqlHostConfig11_BackslashQuoteFromJSON = exports.PostgresqlHostConfig11_BackslashQuote = exports.postgresqlHostConfig11_XmlOptionToJSON = exports.postgresqlHostConfig11_XmlOptionFromJSON = exports.PostgresqlHostConfig11_XmlOption = exports.postgresqlHostConfig11_XmlBinaryToJSON = exports.postgresqlHostConfig11_XmlBinaryFromJSON = exports.PostgresqlHostConfig11_XmlBinary = exports.postgresqlHostConfig11_ByteaOutputToJSON = exports.postgresqlHostConfig11_ByteaOutputFromJSON = exports.PostgresqlHostConfig11_ByteaOutput = exports.postgresqlHostConfig11_TransactionIsolationToJSON = exports.postgresqlHostConfig11_TransactionIsolationFromJSON = exports.PostgresqlHostConfig11_TransactionIsolation = exports.postgresqlHostConfig11_LogStatementToJSON = exports.postgresqlHostConfig11_LogStatementFromJSON = exports.PostgresqlHostConfig11_LogStatement = exports.postgresqlHostConfig11_LogErrorVerbosityToJSON = exports.postgresqlHostConfig11_LogErrorVerbosityFromJSON = exports.PostgresqlHostConfig11_LogErrorVerbosity = exports.postgresqlHostConfig11_LogLevelToJSON = exports.postgresqlHostConfig11_LogLevelFromJSON = exports.PostgresqlHostConfig11_LogLevel = exports.postgresqlHostConfig11_ForceParallelModeToJSON = exports.postgresqlHostConfig11_ForceParallelModeFromJSON = exports.PostgresqlHostConfig11_ForceParallelMode = exports.postgresqlHostConfig11_ConstraintExclusionToJSON = exports.postgresqlHostConfig11_ConstraintExclusionFromJSON = exports.PostgresqlHostConfig11_ConstraintExclusion = exports.protobufPackage = void 0;
/* eslint-disable */
    ...
    fromJSON(object) {
        ...
        if (object.constraintExclusion !== undefined &&
            ...
            message.constraintExclusion =
                postgresqlHostConfig11_ConstraintExclusionFromJSON(object.constraintExclusion);
        }
        else {
        ...
        if (object.forceParallelMode !== undefined &&
            ...
            message.forceParallelMode =
                postgresqlHostConfig11_ForceParallelModeFromJSON(object.forceParallelMode);
        }
        else {
        ...
        if (object.clientMinMessages !== undefined &&
            ...
            message.clientMinMessages = postgresqlHostConfig11_LogLevelFromJSON(object.clientMinMessages);
        }
        else {
        ...
        if (object.logMinMessages !== undefined &&
            ...
            message.logMinMessages = postgresqlHostConfig11_LogLevelFromJSON(object.logMinMessages);
        }
        else {
        ...
        if (object.logMinErrorStatement !== undefined &&
            ...
            message.logMinErrorStatement =
                postgresqlHostConfig11_LogLevelFromJSON(object.logMinErrorStatement);
        }
        else {
        ...
        if (object.logErrorVerbosity !== undefined &&
            ...
            message.logErrorVerbosity =
                postgresqlHostConfig11_LogErrorVerbosityFromJSON(object.logErrorVerbosity);
        }
        else {
        ...
        if (object.logStatement !== undefined && object.logStatement !== null) {
            message.logStatement = postgresqlHostConfig11_LogStatementFromJSON(object.logStatement);
        }
        else {
        ...
        if (object.defaultTransactionIsolation !== undefined &&
            ...
            message.defaultTransactionIsolation =
                postgresqlHostConfig11_TransactionIsolationFromJSON(object.defaultTransactionIsolation);
        }
        else {
        ...
        if (object.byteaOutput !== undefined && object.byteaOutput !== null) {
            message.byteaOutput = postgresqlHostConfig11_ByteaOutputFromJSON(object.byteaOutput);
        }
        else {
            message.byteaOutput = 0;
        }
        if (object.xmlbinary !== undefined && object.xmlbinary !== null) {
            message.xmlbinary = postgresqlHostConfig11_XmlBinaryFromJSON(object.xmlbinary);
        }
        else {
            message.xmlbinary = 0;
        }
        if (object.xmloption !== undefined && object.xmloption !== null) {
            message.xmloption = postgresqlHostConfig11_XmlOptionFromJSON(object.xmloption);
        }
        else {
            message.xmloption = 0;
        }
        ...
        if (object.backslashQuote !== undefined &&
            ...
            message.backslashQuote =
                postgresqlHostConfig11_BackslashQuoteFromJSON(object.backslashQuote);
        }
        else {
    ...
    toJSON(message) {
        ...
        message.constraintExclusion !== undefined &&
            (obj.constraintExclusion =
                postgresqlHostConfig11_ConstraintExclusionToJSON(message.constraintExclusion));
        message.cursorTupleFraction !== undefined &&
        ...
        message.forceParallelMode !== undefined &&
            (obj.forceParallelMode =
                postgresqlHostConfig11_ForceParallelModeToJSON(message.forceParallelMode));
        message.clientMinMessages !== undefined &&
            (obj.clientMinMessages = postgresqlHostConfig11_LogLevelToJSON(message.clientMinMessages));
        message.logMinMessages !== undefined &&
            (obj.logMinMessages = postgresqlHostConfig11_LogLevelToJSON(message.logMinMessages));
        message.logMinErrorStatement !== undefined &&
            (obj.logMinErrorStatement = postgresqlHostConfig11_LogLevelToJSON(message.logMinErrorStatement));
        message.logMinDurationStatement !== undefined &&
        ...
        message.logErrorVerbosity !== undefined &&
            (obj.logErrorVerbosity =
                postgresqlHostConfig11_LogErrorVerbosityToJSON(message.logErrorVerbosity));
        message.logLockWaits !== undefined &&
            (obj.logLockWaits = message.logLockWaits);
        message.logStatement !== undefined &&
            (obj.logStatement = postgresqlHostConfig11_LogStatementToJSON(message.logStatement));
        message.logTempFiles !== undefined &&
        ...
        message.defaultTransactionIsolation !== undefined &&
            (obj.defaultTransactionIsolation =
                postgresqlHostConfig11_TransactionIsolationToJSON(message.defaultTransactionIsolation));
        message.statementTimeout !== undefined &&
        ...
        message.byteaOutput !== undefined &&
            (obj.byteaOutput = postgresqlHostConfig11_ByteaOutputToJSON(message.byteaOutput));
        message.xmlbinary !== undefined &&
            (obj.xmlbinary = postgresqlHostConfig11_XmlBinaryToJSON(message.xmlbinary));
        message.xmloption !== undefined &&
            (obj.xmloption = postgresqlHostConfig11_XmlOptionToJSON(message.xmloption));
        message.ginPendingListLimit !== undefined &&
        ...
        message.backslashQuote !== undefined &&
            (obj.backslashQuote = postgresqlHostConfig11_BackslashQuoteToJSON(message.backslashQuote));
        message.defaultWithOids !== undefined &&
