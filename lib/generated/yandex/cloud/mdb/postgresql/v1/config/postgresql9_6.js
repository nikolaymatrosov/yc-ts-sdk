...
exports.Postgresqlconfig96 = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.sqlInheritance !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.sqlInheritance }, writer.uint32(586).fork()).ldelim();
        }
        if (message.autovacuumMaxWorkers !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.autovacuumMaxWorkers }, writer.uint32(594).fork()).ldelim();
        }
        if (message.autovacuumVacuumCostDelay !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.autovacuumVacuumCostDelay }, writer.uint32(602).fork()).ldelim();
        }
        if (message.autovacuumVacuumCostLimit !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.autovacuumVacuumCostLimit }, writer.uint32(610).fork()).ldelim();
        }
        if (message.autovacuumNaptime !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.autovacuumNaptime }, writer.uint32(618).fork()).ldelim();
        }
        if (message.archiveTimeout !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.archiveTimeout }, writer.uint32(626).fork()).ldelim();
        }
        if (message.trackActivityQuerySize !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.trackActivityQuerySize }, writer.uint32(634).fork()).ldelim();
        }
        if (message.effectiveIoConcurrency !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.effectiveIoConcurrency }, writer.uint32(642).fork()).ldelim();
        }
        if (message.effectiveCacheSize !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.effectiveCacheSize }, writer.uint32(650).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
