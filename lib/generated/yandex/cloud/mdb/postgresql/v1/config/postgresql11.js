...
exports.PostgresqlConfigSet11 = exports.PostgresqlConfig11 = exports.postgresqlConfig11_SharedPreloadLibrariesToJSON = exports.postgresqlConfig11_SharedPreloadLibrariesFromJSON = exports.PostgresqlConfig11_SharedPreloadLibraries = exports.postgresqlConfig11_PgHintPlanDebugPrintToJSON = exports.postgresqlConfig11_PgHintPlanDebugPrintFromJSON = exports.PostgresqlConfig11_PgHintPlanDebugPrint = exports.postgresqlConfig11_BackslashQuoteToJSON = exports.postgresqlConfig11_BackslashQuoteFromJSON = exports.PostgresqlConfig11_BackslashQuote = exports.postgresqlConfig11_XmlOptionToJSON = exports.postgresqlConfig11_XmlOptionFromJSON = exports.PostgresqlConfig11_XmlOption = exports.postgresqlConfig11_XmlBinaryToJSON = exports.postgresqlConfig11_XmlBinaryFromJSON = exports.PostgresqlConfig11_XmlBinary = exports.postgresqlConfig11_ByteaOutputToJSON = exports.postgresqlConfig11_ByteaOutputFromJSON = exports.PostgresqlConfig11_ByteaOutput = exports.postgresqlConfig11_TransactionIsolationToJSON = exports.postgresqlConfig11_TransactionIsolationFromJSON = exports.PostgresqlConfig11_TransactionIsolation = exports.postgresqlConfig11_LogStatementToJSON = exports.postgresqlConfig11_LogStatementFromJSON = exports.PostgresqlConfig11_LogStatement = exports.postgresqlConfig11_LogErrorVerbosityToJSON = exports.postgresqlConfig11_LogErrorVerbosityFromJSON = exports.PostgresqlConfig11_LogErrorVerbosity = exports.postgresqlConfig11_LogLevelToJSON = exports.postgresqlConfig11_LogLevelFromJSON = exports.PostgresqlConfig11_LogLevel = exports.postgresqlConfig11_ForceParallelModeToJSON = exports.postgresqlConfig11_ForceParallelModeFromJSON = exports.PostgresqlConfig11_ForceParallelMode = exports.postgresqlConfig11_ConstraintExclusionToJSON = exports.postgresqlConfig11_ConstraintExclusionFromJSON = exports.PostgresqlConfig11_ConstraintExclusion = exports.postgresqlConfig11_SynchronousCommitToJSON = exports.postgresqlConfig11_SynchronousCommitFromJSON = exports.PostgresqlConfig11_SynchronousCommit = exports.postgresqlConfig11_WalLevelToJSON = exports.postgresqlConfig11_WalLevelFromJSON = exports.PostgresqlConfig11_WalLevel = exports.protobufPackage = void 0;
/* eslint-disable */
...
exports.PostgresqlConfig11 = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.effectiveIoConcurrency !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.effectiveIoConcurrency }, writer.uint32(858).fork()).ldelim();
        }
        if (message.effectiveCacheSize !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.effectiveCacheSize }, writer.uint32(866).fork()).ldelim();
        }
        ...
        if (message.autoExplainLogMinDuration !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.autoExplainLogMinDuration }, writer.uint32(882).fork()).ldelim();
        }
        if (message.autoExplainLogAnalyze !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.autoExplainLogAnalyze }, writer.uint32(890).fork()).ldelim();
        }
        if (message.autoExplainLogBuffers !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.autoExplainLogBuffers }, writer.uint32(898).fork()).ldelim();
        }
        if (message.autoExplainLogTiming !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.autoExplainLogTiming }, writer.uint32(906).fork()).ldelim();
        }
        if (message.autoExplainLogTriggers !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.autoExplainLogTriggers }, writer.uint32(914).fork()).ldelim();
        }
        if (message.autoExplainLogVerbose !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.autoExplainLogVerbose }, writer.uint32(922).fork()).ldelim();
        }
        if (message.autoExplainLogNestedStatements !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.autoExplainLogNestedStatements }, writer.uint32(930).fork()).ldelim();
        }
        if (message.autoExplainSampleRate !== undefined) {
            wrappers_1.DoubleValue.encode({ value: message.autoExplainSampleRate }, writer.uint32(938).fork()).ldelim();
        }
        if (message.pgHintPlanEnableHint !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.pgHintPlanEnableHint }, writer.uint32(946).fork()).ldelim();
        }
        if (message.pgHintPlanEnableHintTable !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.pgHintPlanEnableHintTable }, writer.uint32(954).fork()).ldelim();
        }
...
exports.PostgresqlConfigSet11 = {
    ...
    fromJSON(object) {
        ...
        if (object.effectiveConfig !== undefined &&
            ...
            message.effectiveConfig = exports.PostgresqlConfig11.fromJSON(object.effectiveConfig);
        }
        else {
            message.effectiveConfig = undefined;
        }
        if (object.userConfig !== undefined && object.userConfig !== null) {
            message.userConfig = exports.PostgresqlConfig11.fromJSON(object.userConfig);
        }
        else {
        ...
        if (object.defaultConfig !== undefined &&
            ...
            message.defaultConfig = exports.PostgresqlConfig11.fromJSON(object.defaultConfig);
        }
        else {
    ...
    fromPartial(object) {
        ...
        if (object.effectiveConfig !== undefined &&
            object.effectiveConfig !== null) {
            message.effectiveConfig = exports.PostgresqlConfig11.fromPartial(object.effectiveConfig);
        }
        else {
            message.effectiveConfig = undefined;
        }
        if (object.userConfig !== undefined && object.userConfig !== null) {
            message.userConfig = exports.PostgresqlConfig11.fromPartial(object.userConfig);
        }
        else {
            message.userConfig = undefined;
        }
        if (object.defaultConfig !== undefined &&
            object.defaultConfig !== null) {
            message.defaultConfig = exports.PostgresqlConfig11.fromPartial(object.defaultConfig);
        }
        else {
            message.defaultConfig = undefined;
        }
