...
exports.Postgresqlhostconfig111c = exports.postgresqlhostconfig111c_BackslashQuoteToJSON = exports.postgresqlhostconfig111c_BackslashQuoteFromJSON = exports.Postgresqlhostconfig111c_BackslashQuote = exports.postgresqlhostconfig111c_XmlOptionToJSON = exports.postgresqlhostconfig111c_XmlOptionFromJSON = exports.Postgresqlhostconfig111c_XmlOption = exports.postgresqlhostconfig111c_XmlBinaryToJSON = exports.postgresqlhostconfig111c_XmlBinaryFromJSON = exports.Postgresqlhostconfig111c_XmlBinary = exports.postgresqlhostconfig111c_ByteaOutputToJSON = exports.postgresqlhostconfig111c_ByteaOutputFromJSON = exports.Postgresqlhostconfig111c_ByteaOutput = exports.postgresqlhostconfig111c_TransactionIsolationToJSON = exports.postgresqlhostconfig111c_TransactionIsolationFromJSON = exports.Postgresqlhostconfig111c_TransactionIsolation = exports.postgresqlhostconfig111c_LogStatementToJSON = exports.postgresqlhostconfig111c_LogStatementFromJSON = exports.Postgresqlhostconfig111c_LogStatement = exports.postgresqlhostconfig111c_LogErrorVerbosityToJSON = exports.postgresqlhostconfig111c_LogErrorVerbosityFromJSON = exports.Postgresqlhostconfig111c_LogErrorVerbosity = exports.postgresqlhostconfig111c_LogLevelToJSON = exports.postgresqlhostconfig111c_LogLevelFromJSON = exports.Postgresqlhostconfig111c_LogLevel = exports.postgresqlhostconfig111c_ForceParallelModeToJSON = exports.postgresqlhostconfig111c_ForceParallelModeFromJSON = exports.Postgresqlhostconfig111c_ForceParallelMode = exports.postgresqlhostconfig111c_ConstraintExclusionToJSON = exports.postgresqlhostconfig111c_ConstraintExclusionFromJSON = exports.Postgresqlhostconfig111c_ConstraintExclusion = exports.protobufPackage = void 0;
/* eslint-disable */
const wrappers_1 = require("../../../../../../google/protobuf/wrappers");
const long_1 = __importDefault(require("long"));
const minimal_1 = __importDefault(require("protobufjs/minimal"));
exports.protobufPackage = 'yandex.cloud.mdb.postgresql.v1.config';
var Postgresqlhostconfig111c_ConstraintExclusion;
(function (Postgresqlhostconfig111c_ConstraintExclusion) {
    Postgresqlhostconfig111c_ConstraintExclusion[Postgresqlhostconfig111c_ConstraintExclusion["CONSTRAINT_EXCLUSION_UNSPECIFIED"] = 0] = "CONSTRAINT_EXCLUSION_UNSPECIFIED";
    Postgresqlhostconfig111c_ConstraintExclusion[Postgresqlhostconfig111c_ConstraintExclusion["CONSTRAINT_EXCLUSION_ON"] = 1] = "CONSTRAINT_EXCLUSION_ON";
    Postgresqlhostconfig111c_ConstraintExclusion[Postgresqlhostconfig111c_ConstraintExclusion["CONSTRAINT_EXCLUSION_OFF"] = 2] = "CONSTRAINT_EXCLUSION_OFF";
    Postgresqlhostconfig111c_ConstraintExclusion[Postgresqlhostconfig111c_ConstraintExclusion["CONSTRAINT_EXCLUSION_PARTITION"] = 3] = "CONSTRAINT_EXCLUSION_PARTITION";
    Postgresqlhostconfig111c_ConstraintExclusion[Postgresqlhostconfig111c_ConstraintExclusion["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(Postgresqlhostconfig111c_ConstraintExclusion = exports.Postgresqlhostconfig111c_ConstraintExclusion || (exports.Postgresqlhostconfig111c_ConstraintExclusion = {}));
function postgresqlhostconfig111c_ConstraintExclusionFromJSON(object) {
    switch (object) {
        case 0:
        case 'CONSTRAINT_EXCLUSION_UNSPECIFIED':
            return Postgresqlhostconfig111c_ConstraintExclusion.CONSTRAINT_EXCLUSION_UNSPECIFIED;
        case 1:
        case 'CONSTRAINT_EXCLUSION_ON':
            return Postgresqlhostconfig111c_ConstraintExclusion.CONSTRAINT_EXCLUSION_ON;
        case 2:
        case 'CONSTRAINT_EXCLUSION_OFF':
            return Postgresqlhostconfig111c_ConstraintExclusion.CONSTRAINT_EXCLUSION_OFF;
        case 3:
        case 'CONSTRAINT_EXCLUSION_PARTITION':
            return Postgresqlhostconfig111c_ConstraintExclusion.CONSTRAINT_EXCLUSION_PARTITION;
        case -1:
        case 'UNRECOGNIZED':
        default:
            return Postgresqlhostconfig111c_ConstraintExclusion.UNRECOGNIZED;
    }
}
exports.postgresqlhostconfig111c_ConstraintExclusionFromJSON = postgresqlhostconfig111c_ConstraintExclusionFromJSON;
function postgresqlhostconfig111c_ConstraintExclusionToJSON(object) {
    switch (object) {
        case Postgresqlhostconfig111c_ConstraintExclusion.CONSTRAINT_EXCLUSION_UNSPECIFIED:
            return 'CONSTRAINT_EXCLUSION_UNSPECIFIED';
        case Postgresqlhostconfig111c_ConstraintExclusion.CONSTRAINT_EXCLUSION_ON:
            return 'CONSTRAINT_EXCLUSION_ON';
        case Postgresqlhostconfig111c_ConstraintExclusion.CONSTRAINT_EXCLUSION_OFF:
            return 'CONSTRAINT_EXCLUSION_OFF';
        case Postgresqlhostconfig111c_ConstraintExclusion.CONSTRAINT_EXCLUSION_PARTITION:
            return 'CONSTRAINT_EXCLUSION_PARTITION';
        default:
            return 'UNKNOWN';
    }
}
exports.postgresqlhostconfig111c_ConstraintExclusionToJSON = postgresqlhostconfig111c_ConstraintExclusionToJSON;
var Postgresqlhostconfig111c_ForceParallelMode;
(function (Postgresqlhostconfig111c_ForceParallelMode) {
    Postgresqlhostconfig111c_ForceParallelMode[Postgresqlhostconfig111c_ForceParallelMode["FORCE_PARALLEL_MODE_UNSPECIFIED"] = 0] = "FORCE_PARALLEL_MODE_UNSPECIFIED";
    Postgresqlhostconfig111c_ForceParallelMode[Postgresqlhostconfig111c_ForceParallelMode["FORCE_PARALLEL_MODE_ON"] = 1] = "FORCE_PARALLEL_MODE_ON";
    Postgresqlhostconfig111c_ForceParallelMode[Postgresqlhostconfig111c_ForceParallelMode["FORCE_PARALLEL_MODE_OFF"] = 2] = "FORCE_PARALLEL_MODE_OFF";
    Postgresqlhostconfig111c_ForceParallelMode[Postgresqlhostconfig111c_ForceParallelMode["FORCE_PARALLEL_MODE_REGRESS"] = 3] = "FORCE_PARALLEL_MODE_REGRESS";
    Postgresqlhostconfig111c_ForceParallelMode[Postgresqlhostconfig111c_ForceParallelMode["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(Postgresqlhostconfig111c_ForceParallelMode = exports.Postgresqlhostconfig111c_ForceParallelMode || (exports.Postgresqlhostconfig111c_ForceParallelMode = {}));
function postgresqlhostconfig111c_ForceParallelModeFromJSON(object) {
    switch (object) {
        case 0:
        case 'FORCE_PARALLEL_MODE_UNSPECIFIED':
            return Postgresqlhostconfig111c_ForceParallelMode.FORCE_PARALLEL_MODE_UNSPECIFIED;
        case 1:
        case 'FORCE_PARALLEL_MODE_ON':
            return Postgresqlhostconfig111c_ForceParallelMode.FORCE_PARALLEL_MODE_ON;
        case 2:
        case 'FORCE_PARALLEL_MODE_OFF':
            return Postgresqlhostconfig111c_ForceParallelMode.FORCE_PARALLEL_MODE_OFF;
        case 3:
        case 'FORCE_PARALLEL_MODE_REGRESS':
            return Postgresqlhostconfig111c_ForceParallelMode.FORCE_PARALLEL_MODE_REGRESS;
        case -1:
        case 'UNRECOGNIZED':
        default:
            return Postgresqlhostconfig111c_ForceParallelMode.UNRECOGNIZED;
    }
}
exports.postgresqlhostconfig111c_ForceParallelModeFromJSON = postgresqlhostconfig111c_ForceParallelModeFromJSON;
function postgresqlhostconfig111c_ForceParallelModeToJSON(object) {
    switch (object) {
        case Postgresqlhostconfig111c_ForceParallelMode.FORCE_PARALLEL_MODE_UNSPECIFIED:
            return 'FORCE_PARALLEL_MODE_UNSPECIFIED';
        case Postgresqlhostconfig111c_ForceParallelMode.FORCE_PARALLEL_MODE_ON:
            return 'FORCE_PARALLEL_MODE_ON';
        case Postgresqlhostconfig111c_ForceParallelMode.FORCE_PARALLEL_MODE_OFF:
            return 'FORCE_PARALLEL_MODE_OFF';
        case Postgresqlhostconfig111c_ForceParallelMode.FORCE_PARALLEL_MODE_REGRESS:
            return 'FORCE_PARALLEL_MODE_REGRESS';
        default:
            return 'UNKNOWN';
    }
}
exports.postgresqlhostconfig111c_ForceParallelModeToJSON = postgresqlhostconfig111c_ForceParallelModeToJSON;
var Postgresqlhostconfig111c_LogLevel;
(function (Postgresqlhostconfig111c_LogLevel) {
    Postgresqlhostconfig111c_LogLevel[Postgresqlhostconfig111c_LogLevel["LOG_LEVEL_UNSPECIFIED"] = 0] = "LOG_LEVEL_UNSPECIFIED";
    Postgresqlhostconfig111c_LogLevel[Postgresqlhostconfig111c_LogLevel["LOG_LEVEL_DEBUG5"] = 1] = "LOG_LEVEL_DEBUG5";
    Postgresqlhostconfig111c_LogLevel[Postgresqlhostconfig111c_LogLevel["LOG_LEVEL_DEBUG4"] = 2] = "LOG_LEVEL_DEBUG4";
    Postgresqlhostconfig111c_LogLevel[Postgresqlhostconfig111c_LogLevel["LOG_LEVEL_DEBUG3"] = 3] = "LOG_LEVEL_DEBUG3";
    Postgresqlhostconfig111c_LogLevel[Postgresqlhostconfig111c_LogLevel["LOG_LEVEL_DEBUG2"] = 4] = "LOG_LEVEL_DEBUG2";
    Postgresqlhostconfig111c_LogLevel[Postgresqlhostconfig111c_LogLevel["LOG_LEVEL_DEBUG1"] = 5] = "LOG_LEVEL_DEBUG1";
    Postgresqlhostconfig111c_LogLevel[Postgresqlhostconfig111c_LogLevel["LOG_LEVEL_LOG"] = 6] = "LOG_LEVEL_LOG";
    Postgresqlhostconfig111c_LogLevel[Postgresqlhostconfig111c_LogLevel["LOG_LEVEL_NOTICE"] = 7] = "LOG_LEVEL_NOTICE";
    Postgresqlhostconfig111c_LogLevel[Postgresqlhostconfig111c_LogLevel["LOG_LEVEL_WARNING"] = 8] = "LOG_LEVEL_WARNING";
    Postgresqlhostconfig111c_LogLevel[Postgresqlhostconfig111c_LogLevel["LOG_LEVEL_ERROR"] = 9] = "LOG_LEVEL_ERROR";
    Postgresqlhostconfig111c_LogLevel[Postgresqlhostconfig111c_LogLevel["LOG_LEVEL_FATAL"] = 10] = "LOG_LEVEL_FATAL";
    Postgresqlhostconfig111c_LogLevel[Postgresqlhostconfig111c_LogLevel["LOG_LEVEL_PANIC"] = 11] = "LOG_LEVEL_PANIC";
    Postgresqlhostconfig111c_LogLevel[Postgresqlhostconfig111c_LogLevel["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(Postgresqlhostconfig111c_LogLevel = exports.Postgresqlhostconfig111c_LogLevel || (exports.Postgresqlhostconfig111c_LogLevel = {}));
function postgresqlhostconfig111c_LogLevelFromJSON(object) {
    switch (object) {
        case 0:
        case 'LOG_LEVEL_UNSPECIFIED':
            return Postgresqlhostconfig111c_LogLevel.LOG_LEVEL_UNSPECIFIED;
        case 1:
        case 'LOG_LEVEL_DEBUG5':
            return Postgresqlhostconfig111c_LogLevel.LOG_LEVEL_DEBUG5;
        case 2:
        case 'LOG_LEVEL_DEBUG4':
            return Postgresqlhostconfig111c_LogLevel.LOG_LEVEL_DEBUG4;
        case 3:
        case 'LOG_LEVEL_DEBUG3':
            return Postgresqlhostconfig111c_LogLevel.LOG_LEVEL_DEBUG3;
        case 4:
        case 'LOG_LEVEL_DEBUG2':
            return Postgresqlhostconfig111c_LogLevel.LOG_LEVEL_DEBUG2;
        case 5:
        case 'LOG_LEVEL_DEBUG1':
            return Postgresqlhostconfig111c_LogLevel.LOG_LEVEL_DEBUG1;
        case 6:
        case 'LOG_LEVEL_LOG':
            return Postgresqlhostconfig111c_LogLevel.LOG_LEVEL_LOG;
        case 7:
        case 'LOG_LEVEL_NOTICE':
            return Postgresqlhostconfig111c_LogLevel.LOG_LEVEL_NOTICE;
        case 8:
        case 'LOG_LEVEL_WARNING':
            return Postgresqlhostconfig111c_LogLevel.LOG_LEVEL_WARNING;
        case 9:
        case 'LOG_LEVEL_ERROR':
            return Postgresqlhostconfig111c_LogLevel.LOG_LEVEL_ERROR;
        case 10:
        case 'LOG_LEVEL_FATAL':
            return Postgresqlhostconfig111c_LogLevel.LOG_LEVEL_FATAL;
        case 11:
        case 'LOG_LEVEL_PANIC':
            return Postgresqlhostconfig111c_LogLevel.LOG_LEVEL_PANIC;
        case -1:
        case 'UNRECOGNIZED':
        default:
            return Postgresqlhostconfig111c_LogLevel.UNRECOGNIZED;
    }
}
exports.postgresqlhostconfig111c_LogLevelFromJSON = postgresqlhostconfig111c_LogLevelFromJSON;
function postgresqlhostconfig111c_LogLevelToJSON(object) {
    switch (object) {
        case Postgresqlhostconfig111c_LogLevel.LOG_LEVEL_UNSPECIFIED:
            return 'LOG_LEVEL_UNSPECIFIED';
        case Postgresqlhostconfig111c_LogLevel.LOG_LEVEL_DEBUG5:
            return 'LOG_LEVEL_DEBUG5';
        case Postgresqlhostconfig111c_LogLevel.LOG_LEVEL_DEBUG4:
            return 'LOG_LEVEL_DEBUG4';
        case Postgresqlhostconfig111c_LogLevel.LOG_LEVEL_DEBUG3:
            return 'LOG_LEVEL_DEBUG3';
        case Postgresqlhostconfig111c_LogLevel.LOG_LEVEL_DEBUG2:
            return 'LOG_LEVEL_DEBUG2';
        case Postgresqlhostconfig111c_LogLevel.LOG_LEVEL_DEBUG1:
            return 'LOG_LEVEL_DEBUG1';
        case Postgresqlhostconfig111c_LogLevel.LOG_LEVEL_LOG:
            return 'LOG_LEVEL_LOG';
        case Postgresqlhostconfig111c_LogLevel.LOG_LEVEL_NOTICE:
            return 'LOG_LEVEL_NOTICE';
        case Postgresqlhostconfig111c_LogLevel.LOG_LEVEL_WARNING:
            return 'LOG_LEVEL_WARNING';
        case Postgresqlhostconfig111c_LogLevel.LOG_LEVEL_ERROR:
            return 'LOG_LEVEL_ERROR';
        case Postgresqlhostconfig111c_LogLevel.LOG_LEVEL_FATAL:
            return 'LOG_LEVEL_FATAL';
        case Postgresqlhostconfig111c_LogLevel.LOG_LEVEL_PANIC:
            return 'LOG_LEVEL_PANIC';
        default:
            return 'UNKNOWN';
    }
}
exports.postgresqlhostconfig111c_LogLevelToJSON = postgresqlhostconfig111c_LogLevelToJSON;
var Postgresqlhostconfig111c_LogErrorVerbosity;
(function (Postgresqlhostconfig111c_LogErrorVerbosity) {
    Postgresqlhostconfig111c_LogErrorVerbosity[Postgresqlhostconfig111c_LogErrorVerbosity["LOG_ERROR_VERBOSITY_UNSPECIFIED"] = 0] = "LOG_ERROR_VERBOSITY_UNSPECIFIED";
    Postgresqlhostconfig111c_LogErrorVerbosity[Postgresqlhostconfig111c_LogErrorVerbosity["LOG_ERROR_VERBOSITY_TERSE"] = 1] = "LOG_ERROR_VERBOSITY_TERSE";
    Postgresqlhostconfig111c_LogErrorVerbosity[Postgresqlhostconfig111c_LogErrorVerbosity["LOG_ERROR_VERBOSITY_DEFAULT"] = 2] = "LOG_ERROR_VERBOSITY_DEFAULT";
    Postgresqlhostconfig111c_LogErrorVerbosity[Postgresqlhostconfig111c_LogErrorVerbosity["LOG_ERROR_VERBOSITY_VERBOSE"] = 3] = "LOG_ERROR_VERBOSITY_VERBOSE";
    Postgresqlhostconfig111c_LogErrorVerbosity[Postgresqlhostconfig111c_LogErrorVerbosity["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(Postgresqlhostconfig111c_LogErrorVerbosity = exports.Postgresqlhostconfig111c_LogErrorVerbosity || (exports.Postgresqlhostconfig111c_LogErrorVerbosity = {}));
function postgresqlhostconfig111c_LogErrorVerbosityFromJSON(object) {
    switch (object) {
        case 0:
        case 'LOG_ERROR_VERBOSITY_UNSPECIFIED':
            return Postgresqlhostconfig111c_LogErrorVerbosity.LOG_ERROR_VERBOSITY_UNSPECIFIED;
        case 1:
        case 'LOG_ERROR_VERBOSITY_TERSE':
            return Postgresqlhostconfig111c_LogErrorVerbosity.LOG_ERROR_VERBOSITY_TERSE;
        case 2:
        case 'LOG_ERROR_VERBOSITY_DEFAULT':
            return Postgresqlhostconfig111c_LogErrorVerbosity.LOG_ERROR_VERBOSITY_DEFAULT;
        case 3:
        ...
        case 'UNRECOGNIZED':
        default:
            return Postgresqlhostconfig111c_LogErrorVerbosity.UNRECOGNIZED;
    }
}
exports.postgresqlhostconfig111c_LogErrorVerbosityFromJSON = postgresqlhostconfig111c_LogErrorVerbosityFromJSON;
function postgresqlhostconfig111c_LogErrorVerbosityToJSON(object) {
    switch (object) {
        case Postgresqlhostconfig111c_LogErrorVerbosity.LOG_ERROR_VERBOSITY_UNSPECIFIED:
            return 'LOG_ERROR_VERBOSITY_UNSPECIFIED';
        case Postgresqlhostconfig111c_LogErrorVerbosity.LOG_ERROR_VERBOSITY_TERSE:
            return 'LOG_ERROR_VERBOSITY_TERSE';
        case Postgresqlhostconfig111c_LogErrorVerbosity.LOG_ERROR_VERBOSITY_DEFAULT:
            return 'LOG_ERROR_VERBOSITY_DEFAULT';
        case Postgresqlhostconfig111c_LogErrorVerbosity.LOG_ERROR_VERBOSITY_VERBOSE:
            return 'LOG_ERROR_VERBOSITY_VERBOSE';
        default:
            return 'UNKNOWN';
    }
}
exports.postgresqlhostconfig111c_LogErrorVerbosityToJSON = postgresqlhostconfig111c_LogErrorVerbosityToJSON;
var Postgresqlhostconfig111c_LogStatement;
(function (Postgresqlhostconfig111c_LogStatement) {
    Postgresqlhostconfig111c_LogStatement[Postgresqlhostconfig111c_LogStatement["LOG_STATEMENT_UNSPECIFIED"] = 0] = "LOG_STATEMENT_UNSPECIFIED";
    Postgresqlhostconfig111c_LogStatement[Postgresqlhostconfig111c_LogStatement["LOG_STATEMENT_NONE"] = 1] = "LOG_STATEMENT_NONE";
    Postgresqlhostconfig111c_LogStatement[Postgresqlhostconfig111c_LogStatement["LOG_STATEMENT_DDL"] = 2] = "LOG_STATEMENT_DDL";
    Postgresqlhostconfig111c_LogStatement[Postgresqlhostconfig111c_LogStatement["LOG_STATEMENT_MOD"] = 3] = "LOG_STATEMENT_MOD";
    Postgresqlhostconfig111c_LogStatement[Postgresqlhostconfig111c_LogStatement["LOG_STATEMENT_ALL"] = 4] = "LOG_STATEMENT_ALL";
    Postgresqlhostconfig111c_LogStatement[Postgresqlhostconfig111c_LogStatement["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(Postgresqlhostconfig111c_LogStatement = exports.Postgresqlhostconfig111c_LogStatement || (exports.Postgresqlhostconfig111c_LogStatement = {}));
function postgresqlhostconfig111c_LogStatementFromJSON(object) {
    switch (object) {
        case 0:
        case 'LOG_STATEMENT_UNSPECIFIED':
            return Postgresqlhostconfig111c_LogStatement.LOG_STATEMENT_UNSPECIFIED;
        case 1:
        case 'LOG_STATEMENT_NONE':
            return Postgresqlhostconfig111c_LogStatement.LOG_STATEMENT_NONE;
        case 2:
        case 'LOG_STATEMENT_DDL':
            return Postgresqlhostconfig111c_LogStatement.LOG_STATEMENT_DDL;
        case 3:
        case 'LOG_STATEMENT_MOD':
            return Postgresqlhostconfig111c_LogStatement.LOG_STATEMENT_MOD;
        case 4:
        case 'LOG_STATEMENT_ALL':
            return Postgresqlhostconfig111c_LogStatement.LOG_STATEMENT_ALL;
        case -1:
        case 'UNRECOGNIZED':
        default:
            return Postgresqlhostconfig111c_LogStatement.UNRECOGNIZED;
    }
}
exports.postgresqlhostconfig111c_LogStatementFromJSON = postgresqlhostconfig111c_LogStatementFromJSON;
function postgresqlhostconfig111c_LogStatementToJSON(object) {
    switch (object) {
        case Postgresqlhostconfig111c_LogStatement.LOG_STATEMENT_UNSPECIFIED:
            return 'LOG_STATEMENT_UNSPECIFIED';
        case Postgresqlhostconfig111c_LogStatement.LOG_STATEMENT_NONE:
            return 'LOG_STATEMENT_NONE';
        case Postgresqlhostconfig111c_LogStatement.LOG_STATEMENT_DDL:
            return 'LOG_STATEMENT_DDL';
        case Postgresqlhostconfig111c_LogStatement.LOG_STATEMENT_MOD:
            return 'LOG_STATEMENT_MOD';
        case Postgresqlhostconfig111c_LogStatement.LOG_STATEMENT_ALL:
            return 'LOG_STATEMENT_ALL';
        default:
            return 'UNKNOWN';
    }
}
exports.postgresqlhostconfig111c_LogStatementToJSON = postgresqlhostconfig111c_LogStatementToJSON;
var Postgresqlhostconfig111c_TransactionIsolation;
(function (Postgresqlhostconfig111c_TransactionIsolation) {
    Postgresqlhostconfig111c_TransactionIsolation[Postgresqlhostconfig111c_TransactionIsolation["TRANSACTION_ISOLATION_UNSPECIFIED"] = 0] = "TRANSACTION_ISOLATION_UNSPECIFIED";
    Postgresqlhostconfig111c_TransactionIsolation[Postgresqlhostconfig111c_TransactionIsolation["TRANSACTION_ISOLATION_READ_UNCOMMITTED"] = 1] = "TRANSACTION_ISOLATION_READ_UNCOMMITTED";
    Postgresqlhostconfig111c_TransactionIsolation[Postgresqlhostconfig111c_TransactionIsolation["TRANSACTION_ISOLATION_READ_COMMITTED"] = 2] = "TRANSACTION_ISOLATION_READ_COMMITTED";
    Postgresqlhostconfig111c_TransactionIsolation[Postgresqlhostconfig111c_TransactionIsolation["TRANSACTION_ISOLATION_REPEATABLE_READ"] = 3] = "TRANSACTION_ISOLATION_REPEATABLE_READ";
    Postgresqlhostconfig111c_TransactionIsolation[Postgresqlhostconfig111c_TransactionIsolation["TRANSACTION_ISOLATION_SERIALIZABLE"] = 4] = "TRANSACTION_ISOLATION_SERIALIZABLE";
    Postgresqlhostconfig111c_TransactionIsolation[Postgresqlhostconfig111c_TransactionIsolation["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(Postgresqlhostconfig111c_TransactionIsolation = exports.Postgresqlhostconfig111c_TransactionIsolation || (exports.Postgresqlhostconfig111c_TransactionIsolation = {}));
function postgresqlhostconfig111c_TransactionIsolationFromJSON(object) {
    switch (object) {
        case 0:
        case 'TRANSACTION_ISOLATION_UNSPECIFIED':
            return Postgresqlhostconfig111c_TransactionIsolation.TRANSACTION_ISOLATION_UNSPECIFIED;
        case 1:
        case 'TRANSACTION_ISOLATION_READ_UNCOMMITTED':
            return Postgresqlhostconfig111c_TransactionIsolation.TRANSACTION_ISOLATION_READ_UNCOMMITTED;
        case 2:
        case 'TRANSACTION_ISOLATION_READ_COMMITTED':
            return Postgresqlhostconfig111c_TransactionIsolation.TRANSACTION_ISOLATION_READ_COMMITTED;
        case 3:
        case 'TRANSACTION_ISOLATION_REPEATABLE_READ':
            return Postgresqlhostconfig111c_TransactionIsolation.TRANSACTION_ISOLATION_REPEATABLE_READ;
        case 4:
        case 'TRANSACTION_ISOLATION_SERIALIZABLE':
            return Postgresqlhostconfig111c_TransactionIsolation.TRANSACTION_ISOLATION_SERIALIZABLE;
        case -1:
        case 'UNRECOGNIZED':
        default:
            return Postgresqlhostconfig111c_TransactionIsolation.UNRECOGNIZED;
    }
}
exports.postgresqlhostconfig111c_TransactionIsolationFromJSON = postgresqlhostconfig111c_TransactionIsolationFromJSON;
function postgresqlhostconfig111c_TransactionIsolationToJSON(object) {
    switch (object) {
        case Postgresqlhostconfig111c_TransactionIsolation.TRANSACTION_ISOLATION_UNSPECIFIED:
            return 'TRANSACTION_ISOLATION_UNSPECIFIED';
        case Postgresqlhostconfig111c_TransactionIsolation.TRANSACTION_ISOLATION_READ_UNCOMMITTED:
            return 'TRANSACTION_ISOLATION_READ_UNCOMMITTED';
        case Postgresqlhostconfig111c_TransactionIsolation.TRANSACTION_ISOLATION_READ_COMMITTED:
            return 'TRANSACTION_ISOLATION_READ_COMMITTED';
        case Postgresqlhostconfig111c_TransactionIsolation.TRANSACTION_ISOLATION_REPEATABLE_READ:
            return 'TRANSACTION_ISOLATION_REPEATABLE_READ';
        case Postgresqlhostconfig111c_TransactionIsolation.TRANSACTION_ISOLATION_SERIALIZABLE:
            return 'TRANSACTION_ISOLATION_SERIALIZABLE';
        default:
            return 'UNKNOWN';
    }
}
exports.postgresqlhostconfig111c_TransactionIsolationToJSON = postgresqlhostconfig111c_TransactionIsolationToJSON;
var Postgresqlhostconfig111c_ByteaOutput;
(function (Postgresqlhostconfig111c_ByteaOutput) {
    Postgresqlhostconfig111c_ByteaOutput[Postgresqlhostconfig111c_ByteaOutput["BYTEA_OUTPUT_UNSPECIFIED"] = 0] = "BYTEA_OUTPUT_UNSPECIFIED";
    Postgresqlhostconfig111c_ByteaOutput[Postgresqlhostconfig111c_ByteaOutput["BYTEA_OUTPUT_HEX"] = 1] = "BYTEA_OUTPUT_HEX";
    Postgresqlhostconfig111c_ByteaOutput[Postgresqlhostconfig111c_ByteaOutput["BYTEA_OUTPUT_ESCAPED"] = 2] = "BYTEA_OUTPUT_ESCAPED";
    Postgresqlhostconfig111c_ByteaOutput[Postgresqlhostconfig111c_ByteaOutput["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(Postgresqlhostconfig111c_ByteaOutput = exports.Postgresqlhostconfig111c_ByteaOutput || (exports.Postgresqlhostconfig111c_ByteaOutput = {}));
function postgresqlhostconfig111c_ByteaOutputFromJSON(object) {
    switch (object) {
        case 0:
        case 'BYTEA_OUTPUT_UNSPECIFIED':
            return Postgresqlhostconfig111c_ByteaOutput.BYTEA_OUTPUT_UNSPECIFIED;
        case 1:
        case 'BYTEA_OUTPUT_HEX':
            return Postgresqlhostconfig111c_ByteaOutput.BYTEA_OUTPUT_HEX;
        case 2:
        case 'BYTEA_OUTPUT_ESCAPED':
            return Postgresqlhostconfig111c_ByteaOutput.BYTEA_OUTPUT_ESCAPED;
        case -1:
        case 'UNRECOGNIZED':
        default:
            return Postgresqlhostconfig111c_ByteaOutput.UNRECOGNIZED;
    }
}
exports.postgresqlhostconfig111c_ByteaOutputFromJSON = postgresqlhostconfig111c_ByteaOutputFromJSON;
function postgresqlhostconfig111c_ByteaOutputToJSON(object) {
    switch (object) {
        case Postgresqlhostconfig111c_ByteaOutput.BYTEA_OUTPUT_UNSPECIFIED:
            return 'BYTEA_OUTPUT_UNSPECIFIED';
        case Postgresqlhostconfig111c_ByteaOutput.BYTEA_OUTPUT_HEX:
            return 'BYTEA_OUTPUT_HEX';
        case Postgresqlhostconfig111c_ByteaOutput.BYTEA_OUTPUT_ESCAPED:
            return 'BYTEA_OUTPUT_ESCAPED';
        default:
            return 'UNKNOWN';
    }
}
exports.postgresqlhostconfig111c_ByteaOutputToJSON = postgresqlhostconfig111c_ByteaOutputToJSON;
var Postgresqlhostconfig111c_XmlBinary;
(function (Postgresqlhostconfig111c_XmlBinary) {
    Postgresqlhostconfig111c_XmlBinary[Postgresqlhostconfig111c_XmlBinary["XML_BINARY_UNSPECIFIED"] = 0] = "XML_BINARY_UNSPECIFIED";
    Postgresqlhostconfig111c_XmlBinary[Postgresqlhostconfig111c_XmlBinary["XML_BINARY_BASE64"] = 1] = "XML_BINARY_BASE64";
    Postgresqlhostconfig111c_XmlBinary[Postgresqlhostconfig111c_XmlBinary["XML_BINARY_HEX"] = 2] = "XML_BINARY_HEX";
    Postgresqlhostconfig111c_XmlBinary[Postgresqlhostconfig111c_XmlBinary["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(Postgresqlhostconfig111c_XmlBinary = exports.Postgresqlhostconfig111c_XmlBinary || (exports.Postgresqlhostconfig111c_XmlBinary = {}));
function postgresqlhostconfig111c_XmlBinaryFromJSON(object) {
    switch (object) {
        case 0:
        case 'XML_BINARY_UNSPECIFIED':
            return Postgresqlhostconfig111c_XmlBinary.XML_BINARY_UNSPECIFIED;
        case 1:
        case 'XML_BINARY_BASE64':
            return Postgresqlhostconfig111c_XmlBinary.XML_BINARY_BASE64;
        case 2:
        case 'XML_BINARY_HEX':
            return Postgresqlhostconfig111c_XmlBinary.XML_BINARY_HEX;
        case -1:
        case 'UNRECOGNIZED':
        default:
            return Postgresqlhostconfig111c_XmlBinary.UNRECOGNIZED;
    }
}
exports.postgresqlhostconfig111c_XmlBinaryFromJSON = postgresqlhostconfig111c_XmlBinaryFromJSON;
function postgresqlhostconfig111c_XmlBinaryToJSON(object) {
    switch (object) {
        case Postgresqlhostconfig111c_XmlBinary.XML_BINARY_UNSPECIFIED:
            return 'XML_BINARY_UNSPECIFIED';
        case Postgresqlhostconfig111c_XmlBinary.XML_BINARY_BASE64:
            return 'XML_BINARY_BASE64';
        case Postgresqlhostconfig111c_XmlBinary.XML_BINARY_HEX:
            return 'XML_BINARY_HEX';
        default:
            return 'UNKNOWN';
    }
}
exports.postgresqlhostconfig111c_XmlBinaryToJSON = postgresqlhostconfig111c_XmlBinaryToJSON;
var Postgresqlhostconfig111c_XmlOption;
(function (Postgresqlhostconfig111c_XmlOption) {
    Postgresqlhostconfig111c_XmlOption[Postgresqlhostconfig111c_XmlOption["XML_OPTION_UNSPECIFIED"] = 0] = "XML_OPTION_UNSPECIFIED";
    Postgresqlhostconfig111c_XmlOption[Postgresqlhostconfig111c_XmlOption["XML_OPTION_DOCUMENT"] = 1] = "XML_OPTION_DOCUMENT";
    Postgresqlhostconfig111c_XmlOption[Postgresqlhostconfig111c_XmlOption["XML_OPTION_CONTENT"] = 2] = "XML_OPTION_CONTENT";
    Postgresqlhostconfig111c_XmlOption[Postgresqlhostconfig111c_XmlOption["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(Postgresqlhostconfig111c_XmlOption = exports.Postgresqlhostconfig111c_XmlOption || (exports.Postgresqlhostconfig111c_XmlOption = {}));
function postgresqlhostconfig111c_XmlOptionFromJSON(object) {
    switch (object) {
        case 0:
        case 'XML_OPTION_UNSPECIFIED':
            return Postgresqlhostconfig111c_XmlOption.XML_OPTION_UNSPECIFIED;
        case 1:
        case 'XML_OPTION_DOCUMENT':
            return Postgresqlhostconfig111c_XmlOption.XML_OPTION_DOCUMENT;
        case 2:
        case 'XML_OPTION_CONTENT':
            return Postgresqlhostconfig111c_XmlOption.XML_OPTION_CONTENT;
        case -1:
        case 'UNRECOGNIZED':
        default:
            return Postgresqlhostconfig111c_XmlOption.UNRECOGNIZED;
    }
}
exports.postgresqlhostconfig111c_XmlOptionFromJSON = postgresqlhostconfig111c_XmlOptionFromJSON;
function postgresqlhostconfig111c_XmlOptionToJSON(object) {
    switch (object) {
        case Postgresqlhostconfig111c_XmlOption.XML_OPTION_UNSPECIFIED:
            return 'XML_OPTION_UNSPECIFIED';
        case Postgresqlhostconfig111c_XmlOption.XML_OPTION_DOCUMENT:
            return 'XML_OPTION_DOCUMENT';
        case Postgresqlhostconfig111c_XmlOption.XML_OPTION_CONTENT:
            return 'XML_OPTION_CONTENT';
        default:
            return 'UNKNOWN';
    }
}
exports.postgresqlhostconfig111c_XmlOptionToJSON = postgresqlhostconfig111c_XmlOptionToJSON;
var Postgresqlhostconfig111c_BackslashQuote;
(function (Postgresqlhostconfig111c_BackslashQuote) {
    Postgresqlhostconfig111c_BackslashQuote[Postgresqlhostconfig111c_BackslashQuote["BACKSLASH_QUOTE_UNSPECIFIED"] = 0] = "BACKSLASH_QUOTE_UNSPECIFIED";
    Postgresqlhostconfig111c_BackslashQuote[Postgresqlhostconfig111c_BackslashQuote["BACKSLASH_QUOTE"] = 1] = "BACKSLASH_QUOTE";
    Postgresqlhostconfig111c_BackslashQuote[Postgresqlhostconfig111c_BackslashQuote["BACKSLASH_QUOTE_ON"] = 2] = "BACKSLASH_QUOTE_ON";
    Postgresqlhostconfig111c_BackslashQuote[Postgresqlhostconfig111c_BackslashQuote["BACKSLASH_QUOTE_OFF"] = 3] = "BACKSLASH_QUOTE_OFF";
    Postgresqlhostconfig111c_BackslashQuote[Postgresqlhostconfig111c_BackslashQuote["BACKSLASH_QUOTE_SAFE_ENCODING"] = 4] = "BACKSLASH_QUOTE_SAFE_ENCODING";
    Postgresqlhostconfig111c_BackslashQuote[Postgresqlhostconfig111c_BackslashQuote["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(Postgresqlhostconfig111c_BackslashQuote = exports.Postgresqlhostconfig111c_BackslashQuote || (exports.Postgresqlhostconfig111c_BackslashQuote = {}));
function postgresqlhostconfig111c_BackslashQuoteFromJSON(object) {
    switch (object) {
        case 0:
        case 'BACKSLASH_QUOTE_UNSPECIFIED':
            return Postgresqlhostconfig111c_BackslashQuote.BACKSLASH_QUOTE_UNSPECIFIED;
        case 1:
        case 'BACKSLASH_QUOTE':
            return Postgresqlhostconfig111c_BackslashQuote.BACKSLASH_QUOTE;
        case 2:
        case 'BACKSLASH_QUOTE_ON':
            return Postgresqlhostconfig111c_BackslashQuote.BACKSLASH_QUOTE_ON;
        case 3:
        case 'BACKSLASH_QUOTE_OFF':
            return Postgresqlhostconfig111c_BackslashQuote.BACKSLASH_QUOTE_OFF;
        case 4:
        case 'BACKSLASH_QUOTE_SAFE_ENCODING':
            return Postgresqlhostconfig111c_BackslashQuote.BACKSLASH_QUOTE_SAFE_ENCODING;
        case -1:
        case 'UNRECOGNIZED':
        default:
            return Postgresqlhostconfig111c_BackslashQuote.UNRECOGNIZED;
    }
}
exports.postgresqlhostconfig111c_BackslashQuoteFromJSON = postgresqlhostconfig111c_BackslashQuoteFromJSON;
function postgresqlhostconfig111c_BackslashQuoteToJSON(object) {
    switch (object) {
        case Postgresqlhostconfig111c_BackslashQuote.BACKSLASH_QUOTE_UNSPECIFIED:
            return 'BACKSLASH_QUOTE_UNSPECIFIED';
        case Postgresqlhostconfig111c_BackslashQuote.BACKSLASH_QUOTE:
            return 'BACKSLASH_QUOTE';
        case Postgresqlhostconfig111c_BackslashQuote.BACKSLASH_QUOTE_ON:
            return 'BACKSLASH_QUOTE_ON';
        case Postgresqlhostconfig111c_BackslashQuote.BACKSLASH_QUOTE_OFF:
            return 'BACKSLASH_QUOTE_OFF';
        case Postgresqlhostconfig111c_BackslashQuote.BACKSLASH_QUOTE_SAFE_ENCODING:
            return 'BACKSLASH_QUOTE_SAFE_ENCODING';
        default:
            return 'UNKNOWN';
    }
}
exports.postgresqlhostconfig111c_BackslashQuoteToJSON = postgresqlhostconfig111c_BackslashQuoteToJSON;
const basePostgresqlhostconfig111c = {
...
exports.Postgresqlhostconfig111c = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.tempFileLimit !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.tempFileLimit }, writer.uint32(42).fork()).ldelim();
        }
        if (message.backendFlushAfter !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.backendFlushAfter }, writer.uint32(50).fork()).ldelim();
        }
        if (message.oldSnapshotThreshold !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.oldSnapshotThreshold }, writer.uint32(58).fork()).ldelim();
        }
        if (message.maxStandbyStreamingDelay !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxStandbyStreamingDelay }, writer.uint32(66).fork()).ldelim();
        }
        ...
        if (message.cursorTupleFraction !== undefined) {
            wrappers_1.DoubleValue.encode({ value: message.cursorTupleFraction }, writer.uint32(82).fork()).ldelim();
        }
        if (message.fromCollapseLimit !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.fromCollapseLimit }, writer.uint32(90).fork()).ldelim();
        }
        if (message.joinCollapseLimit !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.joinCollapseLimit }, writer.uint32(98).fork()).ldelim();
        }
        ...
        if (message.logMinDurationStatement !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.logMinDurationStatement }, writer.uint32(138).fork()).ldelim();
        }
        if (message.logCheckpoints !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.logCheckpoints }, writer.uint32(146).fork()).ldelim();
        }
        if (message.logConnections !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.logConnections }, writer.uint32(154).fork()).ldelim();
        }
        if (message.logDisconnections !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.logDisconnections }, writer.uint32(162).fork()).ldelim();
        }
        if (message.logDuration !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.logDuration }, writer.uint32(170).fork()).ldelim();
        }
        if (message.logErrorVerbosity !== 0) {
            writer.uint32(176).int32(message.logErrorVerbosity);
        }
        if (message.logLockWaits !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.logLockWaits }, writer.uint32(186).fork()).ldelim();
        }
        if (message.logStatement !== 0) {
            writer.uint32(192).int32(message.logStatement);
        }
        if (message.logTempFiles !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.logTempFiles }, writer.uint32(202).fork()).ldelim();
        }
        if (message.searchPath !== '') {
            writer.uint32(210).string(message.searchPath);
        }
        if (message.rowSecurity !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.rowSecurity }, writer.uint32(218).fork()).ldelim();
        }
        ...
        if (message.statementTimeout !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.statementTimeout }, writer.uint32(234).fork()).ldelim();
        }
        if (message.lockTimeout !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.lockTimeout }, writer.uint32(242).fork()).ldelim();
        }
        if (message.idleInTransactionSessionTimeout !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.idleInTransactionSessionTimeout }, writer.uint32(250).fork()).ldelim();
        }
        ...
        if (message.ginPendingListLimit !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.ginPendingListLimit }, writer.uint32(282).fork()).ldelim();
        }
        if (message.deadlockTimeout !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.deadlockTimeout }, writer.uint32(290).fork()).ldelim();
        }
        if (message.maxLocksPerTransaction !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxLocksPerTransaction }, writer.uint32(298).fork()).ldelim();
        }
        if (message.maxPredLocksPerTransaction !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxPredLocksPerTransaction }, writer.uint32(306).fork()).ldelim();
        }
        if (message.arrayNulls !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.arrayNulls }, writer.uint32(314).fork()).ldelim();
        }
        if (message.backslashQuote !== 0) {
            writer.uint32(320).int32(message.backslashQuote);
        }
        if (message.defaultWithOids !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.defaultWithOids }, writer.uint32(330).fork()).ldelim();
        }
        if (message.escapeStringWarning !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.escapeStringWarning }, writer.uint32(338).fork()).ldelim();
        }
        if (message.loCompatPrivileges !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.loCompatPrivileges }, writer.uint32(346).fork()).ldelim();
        }
        if (message.operatorPrecedenceWarning !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.operatorPrecedenceWarning }, writer.uint32(354).fork()).ldelim();
        }
        if (message.quoteAllIdentifiers !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.quoteAllIdentifiers }, writer.uint32(362).fork()).ldelim();
        }
        if (message.standardConformingStrings !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.standardConformingStrings }, writer.uint32(370).fork()).ldelim();
        }
        if (message.synchronizeSeqscans !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.synchronizeSeqscans }, writer.uint32(378).fork()).ldelim();
        }
        if (message.transformNullEquals !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.transformNullEquals }, writer.uint32(386).fork()).ldelim();
        }
        if (message.exitOnError !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.exitOnError }, writer.uint32(394).fork()).ldelim();
        }
        if (message.seqPageCost !== undefined) {
            wrappers_1.DoubleValue.encode({ value: message.seqPageCost }, writer.uint32(402).fork()).ldelim();
        }
        if (message.randomPageCost !== undefined) {
            wrappers_1.DoubleValue.encode({ value: message.randomPageCost }, writer.uint32(410).fork()).ldelim();
        }
    ...
    fromJSON(object) {
        ...
        if (object.constraintExclusion !== undefined &&
            ...
            message.constraintExclusion =
                postgresqlhostconfig111c_ConstraintExclusionFromJSON(object.constraintExclusion);
        }
        else {
        ...
        if (object.forceParallelMode !== undefined &&
            ...
            message.forceParallelMode =
                postgresqlhostconfig111c_ForceParallelModeFromJSON(object.forceParallelMode);
        }
        else {
        ...
        if (object.clientMinMessages !== undefined &&
            ...
            message.clientMinMessages =
                postgresqlhostconfig111c_LogLevelFromJSON(object.clientMinMessages);
        }
        else {
        ...
        if (object.logMinMessages !== undefined &&
            ...
            message.logMinMessages = postgresqlhostconfig111c_LogLevelFromJSON(object.logMinMessages);
        }
        else {
        ...
        if (object.logMinErrorStatement !== undefined &&
            ...
            message.logMinErrorStatement =
                postgresqlhostconfig111c_LogLevelFromJSON(object.logMinErrorStatement);
        }
        else {
        ...
        if (object.logErrorVerbosity !== undefined &&
            ...
            message.logErrorVerbosity =
                postgresqlhostconfig111c_LogErrorVerbosityFromJSON(object.logErrorVerbosity);
        }
        else {
        ...
        if (object.logStatement !== undefined && object.logStatement !== null) {
            message.logStatement =
                postgresqlhostconfig111c_LogStatementFromJSON(object.logStatement);
        }
        else {
        ...
        if (object.defaultTransactionIsolation !== undefined &&
            ...
            message.defaultTransactionIsolation =
                postgresqlhostconfig111c_TransactionIsolationFromJSON(object.defaultTransactionIsolation);
        }
        else {
        ...
        if (object.byteaOutput !== undefined && object.byteaOutput !== null) {
            message.byteaOutput = postgresqlhostconfig111c_ByteaOutputFromJSON(object.byteaOutput);
        }
        else {
            message.byteaOutput = 0;
        }
        if (object.xmlbinary !== undefined && object.xmlbinary !== null) {
            message.xmlbinary = postgresqlhostconfig111c_XmlBinaryFromJSON(object.xmlbinary);
        }
        else {
            message.xmlbinary = 0;
        }
        if (object.xmloption !== undefined && object.xmloption !== null) {
            message.xmloption = postgresqlhostconfig111c_XmlOptionFromJSON(object.xmloption);
        }
        else {
            message.xmloption = 0;
        }
        ...
        if (object.backslashQuote !== undefined &&
            ...
            message.backslashQuote =
                postgresqlhostconfig111c_BackslashQuoteFromJSON(object.backslashQuote);
        }
        else {
    ...
    toJSON(message) {
        ...
        message.constraintExclusion !== undefined &&
            (obj.constraintExclusion =
                postgresqlhostconfig111c_ConstraintExclusionToJSON(message.constraintExclusion));
        message.cursorTupleFraction !== undefined &&
        ...
        message.forceParallelMode !== undefined &&
            (obj.forceParallelMode =
                postgresqlhostconfig111c_ForceParallelModeToJSON(message.forceParallelMode));
        message.clientMinMessages !== undefined &&
            (obj.clientMinMessages = postgresqlhostconfig111c_LogLevelToJSON(message.clientMinMessages));
        message.logMinMessages !== undefined &&
            (obj.logMinMessages = postgresqlhostconfig111c_LogLevelToJSON(message.logMinMessages));
        message.logMinErrorStatement !== undefined &&
            (obj.logMinErrorStatement = postgresqlhostconfig111c_LogLevelToJSON(message.logMinErrorStatement));
        message.logMinDurationStatement !== undefined &&
        ...
        message.logErrorVerbosity !== undefined &&
            (obj.logErrorVerbosity =
                postgresqlhostconfig111c_LogErrorVerbosityToJSON(message.logErrorVerbosity));
        message.logLockWaits !== undefined &&
            (obj.logLockWaits = message.logLockWaits);
        message.logStatement !== undefined &&
            (obj.logStatement = postgresqlhostconfig111c_LogStatementToJSON(message.logStatement));
        message.logTempFiles !== undefined &&
        ...
        message.defaultTransactionIsolation !== undefined &&
            (obj.defaultTransactionIsolation =
                postgresqlhostconfig111c_TransactionIsolationToJSON(message.defaultTransactionIsolation));
        message.statementTimeout !== undefined &&
        ...
        message.byteaOutput !== undefined &&
            (obj.byteaOutput = postgresqlhostconfig111c_ByteaOutputToJSON(message.byteaOutput));
        message.xmlbinary !== undefined &&
            (obj.xmlbinary = postgresqlhostconfig111c_XmlBinaryToJSON(message.xmlbinary));
        message.xmloption !== undefined &&
            (obj.xmloption = postgresqlhostconfig111c_XmlOptionToJSON(message.xmloption));
        message.ginPendingListLimit !== undefined &&
        ...
        message.backslashQuote !== undefined &&
            (obj.backslashQuote = postgresqlhostconfig111c_BackslashQuoteToJSON(message.backslashQuote));
        message.defaultWithOids !== undefined &&
