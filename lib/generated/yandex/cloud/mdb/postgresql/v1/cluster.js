...
exports.ConnectionPoolerConfig = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.poolDiscard !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.poolDiscard }, writer.uint32(18).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
...
exports.Host = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.priority !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.priority }, writer.uint32(82).fork()).ldelim();
        }
        if (message.config !== undefined) {
