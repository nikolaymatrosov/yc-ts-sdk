...
exports.AuthProvider = {
    ...
    fromJSON(object) {
        ...
        if (object.saml !== undefined && object.saml !== null) {
            message.saml = exports.SamlSettings.fromJSON(object.saml);
        }
        else {
    ...
    toJSON(message) {
        ...
        message.saml !== undefined &&
            (obj.saml = message.saml
                ? exports.SamlSettings.toJSON(message.saml)
                : undefined);
        return obj;
    },
    fromPartial(object) {
        ...
        if (object.saml !== undefined && object.saml !== null) {
            message.saml = exports.SamlSettings.fromPartial(object.saml);
        }
        else {
            message.saml = undefined;
        }
