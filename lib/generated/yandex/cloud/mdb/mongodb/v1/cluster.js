...
export const Mongodb50 = {
    ...
    fromJSON(object) {
        ...
        if (object.mongoinfra !== undefined && object.mongoinfra !== null) {
            message.mongoinfra = Mongodb50_MongoInfra.fromJSON(object.mongoinfra);
        }
        else {
            message.mongoinfra = undefined;
        }
    ...
    fromPartial(object) {
        ...
        if (object.mongoinfra !== undefined && object.mongoinfra !== null) {
            message.mongoinfra = Mongodb50_MongoInfra.fromPartial(object.mongoinfra);
        }
        else {
            message.mongoinfra = undefined;
        }
...
export const Mongodb50_MongoInfra = {
    ...
    fromJSON(object) {
        const message = { ...baseMongodb50_MongoInfra };
        if (object.configMongos !== undefined && object.configMongos !== null) {
            message.configMongos = Mongosconfigset50.fromJSON(object.configMongos);
        }
        else {
            message.configMongos = undefined;
        }
        if (object.configMongocfg !== undefined &&
            object.configMongocfg !== null) {
            message.configMongocfg = Mongocfgconfigset50.fromJSON(object.configMongocfg);
        }
        else {
            message.configMongocfg = undefined;
        }
    ...
    fromPartial(object) {
        const message = { ...baseMongodb50_MongoInfra };
        if (object.configMongos !== undefined && object.configMongos !== null) {
            message.configMongos = Mongosconfigset50.fromPartial(object.configMongos);
        }
        else {
            message.configMongos = undefined;
        }
        if (object.configMongocfg !== undefined &&
            object.configMongocfg !== null) {
            message.configMongocfg = Mongocfgconfigset50.fromPartial(object.configMongocfg);
        }
        else {
            message.configMongocfg = undefined;
        }
