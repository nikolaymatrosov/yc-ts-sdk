...
exports.Mongodconfig36_Storage_Journal = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.enabled !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.enabled }, writer.uint32(10).fork()).ldelim();
        }
        if (message.commitInterval !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.commitInterval }, writer.uint32(18).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
