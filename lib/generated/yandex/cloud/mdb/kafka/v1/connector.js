...
exports.ConnectorSpec = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.tasksMax !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.tasksMax }, writer.uint32(18).fork()).ldelim();
        }
        Object.entries(message.properties).forEach(([key, value]) => {
            exports.ConnectorSpec_PropertiesEntry.encode({ key: key, value }, writer.uint32(26).fork()).ldelim();
        });
...
exports.Connector = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        Object.entries(message.properties).forEach(([key, value]) => {
            exports.Connector_PropertiesEntry.encode({ key: key, value }, writer.uint32(26).fork()).ldelim();
        });
        if (message.health !== 0) {
