...
exports.Cluster = {
    ...
    fromJSON(object) {
        ...
        if (object.config !== undefined && object.config !== null) {
            message.config = exports.ConfigSpec.fromJSON(object.config);
        }
        else {
    ...
    fromPartial(object) {
        ...
        if (object.config !== undefined && object.config !== null) {
            message.config = exports.ConfigSpec.fromPartial(object.config);
        }
        else {
            message.config = undefined;
        }
...
exports.ConfigSpec = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.brokersCount !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.brokersCount }, writer.uint32(42).fork()).ldelim();
        }
    ...
    fromJSON(object) {
        ...
        if (object.kafka !== undefined && object.kafka !== null) {
            message.kafka = exports.ConfigSpec_Kafka.fromJSON(object.kafka);
        }
        else {
        ...
        if (object.schemaRegistry !== undefined &&
    ...
    fromPartial(object) {
        ...
        if (object.kafka !== undefined && object.kafka !== null) {
            message.kafka = exports.ConfigSpec_Kafka.fromPartial(object.kafka);
        }
        else {
            message.kafka = undefined;
        }
...
exports.ConfigSpec_Kafka = {
    ...
    fromJSON(object) {
        ...
        if (object.kafkaConfig21 !== undefined &&
            ...
            message.kafkaConfig21 = exports.Kafkaconfig21.fromJSON(object.kafkaConfig21);
        }
        else {
        ...
        if (object.kafkaConfig26 !== undefined &&
            ...
            message.kafkaConfig26 = exports.Kafkaconfig26.fromJSON(object.kafkaConfig26);
        }
        else {
            message.kafkaConfig26 = undefined;
        }
        if (object.kafkaConfig28 !== undefined &&
            object.kafkaConfig28 !== null) {
            message.kafkaConfig28 = exports.Kafkaconfig28.fromJSON(object.kafkaConfig28);
        }
        else {
    ...
    fromPartial(object) {
        ...
        if (object.kafkaConfig21 !== undefined &&
            object.kafkaConfig21 !== null) {
            message.kafkaConfig21 = exports.Kafkaconfig21.fromPartial(object.kafkaConfig21);
        }
        else {
            message.kafkaConfig21 = undefined;
        }
        if (object.kafkaConfig26 !== undefined &&
            object.kafkaConfig26 !== null) {
            message.kafkaConfig26 = exports.Kafkaconfig26.fromPartial(object.kafkaConfig26);
        }
        else {
            message.kafkaConfig26 = undefined;
        }
        if (object.kafkaConfig28 !== undefined &&
            object.kafkaConfig28 !== null) {
            message.kafkaConfig28 = exports.Kafkaconfig28.fromPartial(object.kafkaConfig28);
        }
        else {
            message.kafkaConfig28 = undefined;
        }
...
exports.Kafkaconfig21 = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.logFlushIntervalMessages !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.logFlushIntervalMessages }, writer.uint32(18).fork()).ldelim();
        }
        if (message.logFlushIntervalMs !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.logFlushIntervalMs }, writer.uint32(26).fork()).ldelim();
        }
        if (message.logFlushSchedulerIntervalMs !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.logFlushSchedulerIntervalMs }, writer.uint32(34).fork()).ldelim();
        }
        if (message.logRetentionBytes !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.logRetentionBytes }, writer.uint32(42).fork()).ldelim();
        }
        if (message.logRetentionHours !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.logRetentionHours }, writer.uint32(50).fork()).ldelim();
        }
        if (message.logRetentionMinutes !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.logRetentionMinutes }, writer.uint32(58).fork()).ldelim();
        }
        if (message.logRetentionMs !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.logRetentionMs }, writer.uint32(66).fork()).ldelim();
        }
        if (message.logSegmentBytes !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.logSegmentBytes }, writer.uint32(74).fork()).ldelim();
        }
        if (message.logPreallocate !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.logPreallocate }, writer.uint32(82).fork()).ldelim();
        }
        if (message.socketSendBufferBytes !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.socketSendBufferBytes }, writer.uint32(90).fork()).ldelim();
        }
        if (message.socketReceiveBufferBytes !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.socketReceiveBufferBytes }, writer.uint32(98).fork()).ldelim();
        }
        if (message.autoCreateTopicsEnable !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.autoCreateTopicsEnable }, writer.uint32(106).fork()).ldelim();
        }
        if (message.numPartitions !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.numPartitions }, writer.uint32(114).fork()).ldelim();
        }
        if (message.defaultReplicationFactor !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.defaultReplicationFactor }, writer.uint32(122).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
...
const baseKafkaconfig28 = { compressionType: 0 };
exports.Kafkaconfig28 = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = { ...baseKafkaconfig28 };
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
