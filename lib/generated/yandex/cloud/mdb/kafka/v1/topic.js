...
export var Topicconfig28_CleanupPolicy;
...
})(Topicconfig28_CleanupPolicy || (Topicconfig28_CleanupPolicy = {}));
export function topicconfig28_CleanupPolicyFromJSON(object) {
    switch (object) {
        case 0:
        case 'CLEANUP_POLICY_UNSPECIFIED':
...
export function topicconfig28_CleanupPolicyToJSON(object) {
    switch (object) {
...
export const Topic = {
    ...
    fromJSON(object) {
        ...
        if (object.topicConfig28 !== undefined &&
            ...
            message.topicConfig28 = Topicconfig28.fromJSON(object.topicConfig28);
        }
        else {
    ...
    fromPartial(object) {
        ...
        if (object.topicConfig28 !== undefined &&
            object.topicConfig28 !== null) {
            message.topicConfig28 = Topicconfig28.fromPartial(object.topicConfig28);
        }
        else {
            message.topicConfig28 = undefined;
        }
