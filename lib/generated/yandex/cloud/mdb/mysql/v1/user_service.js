...
exports.UpdateUserRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.connectionLimits !== undefined) {
            user_1.ConnectionLimits.encode(message.connectionLimits, writer.uint32(58).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 6:
                    ...
                    break;
                case 7:
                    message.connectionLimits = user_1.ConnectionLimits.decode(reader, reader.uint32());
                    break;
                case 8:
    ...
    fromJSON(object) {
        ...
        if (object.globalPermissions !== undefined &&
            ...
            for (const e of object.globalPermissions) {
                message.globalPermissions.push((0, user_1.globalPermissionFromJSON)(e));
            }
        }
        if (object.connectionLimits !== undefined &&
            object.connectionLimits !== null) {
            message.connectionLimits = user_1.ConnectionLimits.fromJSON(object.connectionLimits);
        }
        else {
        ...
        if (object.authenticationPlugin !== undefined &&
            ...
            message.authenticationPlugin = (0, user_1.authPluginFromJSON)(object.authenticationPlugin);
        }
        else {
    ...
    toJSON(message) {
        ...
        if (message.globalPermissions) {
            obj.globalPermissions = message.globalPermissions.map((e) => (0, user_1.globalPermissionToJSON)(e));
        }
        else {
        ...
        message.connectionLimits !== undefined &&
            (obj.connectionLimits = message.connectionLimits
                ? user_1.ConnectionLimits.toJSON(message.connectionLimits)
                : undefined);
        message.authenticationPlugin !== undefined &&
            (obj.authenticationPlugin = (0, user_1.authPluginToJSON)(message.authenticationPlugin));
        return obj;
    },
    fromPartial(object) {
        const message = { ...baseUpdateUserRequest };
        ...
        if (object.connectionLimits !== undefined &&
            object.connectionLimits !== null) {
            message.connectionLimits = user_1.ConnectionLimits.fromPartial(object.connectionLimits);
        }
        else {
            message.connectionLimits = undefined;
        }
...
exports.UserServiceClient = (0, grpc_js_1.makeGenericClientConstructor)(exports.UserServiceService, 'yandex.cloud.mdb.mysql.v1.UserService');
var globalThis = (() => {
