...
exports.User = {
    ...
    fromJSON(object) {
        ...
        if (object.connectionLimits !== undefined &&
            ...
            message.connectionLimits = exports.ConnectionLimits.fromJSON(object.connectionLimits);
        }
        else {
    ...
    fromPartial(object) {
        ...
        if (object.connectionLimits !== undefined &&
            object.connectionLimits !== null) {
            message.connectionLimits = exports.ConnectionLimits.fromPartial(object.connectionLimits);
        }
        else {
            message.connectionLimits = undefined;
        }
...
exports.ConnectionLimits = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.maxQuestionsPerHour !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxQuestionsPerHour }, writer.uint32(10).fork()).ldelim();
        }
        if (message.maxUpdatesPerHour !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxUpdatesPerHour }, writer.uint32(18).fork()).ldelim();
        }
        if (message.maxConnectionsPerHour !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxConnectionsPerHour }, writer.uint32(26).fork()).ldelim();
        }
        if (message.maxUserConnections !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.maxUserConnections }, writer.uint32(34).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
