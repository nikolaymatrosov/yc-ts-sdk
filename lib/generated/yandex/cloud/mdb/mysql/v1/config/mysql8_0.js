...
export var Mysqlconfig80_SQLMode;
...
})(Mysqlconfig80_SQLMode || (Mysqlconfig80_SQLMode = {}));
export function mysqlconfig80_SQLModeFromJSON(object) {
    switch (object) {
        case 0:
...
export function mysqlconfig80_SQLModeToJSON(object) {
    switch (object) {
...
export var Mysqlconfig80_AuthPlugin;
...
})(Mysqlconfig80_AuthPlugin || (Mysqlconfig80_AuthPlugin = {}));
export function mysqlconfig80_AuthPluginFromJSON(object) {
    switch (object) {
        case 0:
...
export function mysqlconfig80_AuthPluginToJSON(object) {
    switch (object) {
...
export var Mysqlconfig80_TransactionIsolation;
...
})(Mysqlconfig80_TransactionIsolation || (Mysqlconfig80_TransactionIsolation = {}));
export function mysqlconfig80_TransactionIsolationFromJSON(object) {
    switch (object) {
        case 0:
...
export function mysqlconfig80_TransactionIsolationToJSON(object) {
    switch (object) {
...
export var Mysqlconfig80_BinlogRowImage;
...
})(Mysqlconfig80_BinlogRowImage || (Mysqlconfig80_BinlogRowImage = {}));
export function mysqlconfig80_BinlogRowImageFromJSON(object) {
    switch (object) {
        case 0:
...
export function mysqlconfig80_BinlogRowImageToJSON(object) {
    switch (object) {
...
export var Mysqlconfig80_SlaveParallelType;
...
})(Mysqlconfig80_SlaveParallelType || (Mysqlconfig80_SlaveParallelType = {}));
export function mysqlconfig80_SlaveParallelTypeFromJSON(object) {
    switch (object) {
        case 0:
...
export function mysqlconfig80_SlaveParallelTypeToJSON(object) {
    switch (object) {
...
export const Mysqlconfig80 = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.regexpTimeLimit !== undefined) {
            Int64Value.encode({ value: message.regexpTimeLimit }, writer.uint32(402).fork()).ldelim();
        }
        if (message.mdbPreserveBinlogBytes !== undefined) {
            Int64Value.encode({ value: message.mdbPreserveBinlogBytes }, writer.uint32(410).fork()).ldelim();
        }
        if (message.interactiveTimeout !== undefined) {
            Int64Value.encode({ value: message.interactiveTimeout }, writer.uint32(418).fork()).ldelim();
        }
        if (message.waitTimeout !== undefined) {
            Int64Value.encode({ value: message.waitTimeout }, writer.uint32(426).fork()).ldelim();
        }
        if (message.mdbOfflineModeEnableLag !== undefined) {
            Int64Value.encode({ value: message.mdbOfflineModeEnableLag }, writer.uint32(434).fork()).ldelim();
        }
        if (message.mdbOfflineModeDisableLag !== undefined) {
            Int64Value.encode({ value: message.mdbOfflineModeDisableLag }, writer.uint32(442).fork()).ldelim();
        }
        if (message.rangeOptimizerMaxMemSize !== undefined) {
            Int64Value.encode({ value: message.rangeOptimizerMaxMemSize }, writer.uint32(450).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
...
export const Mysqlconfigset80 = {
    ...
    fromJSON(object) {
        ...
        if (object.effectiveConfig !== undefined &&
            ...
            message.effectiveConfig = Mysqlconfig80.fromJSON(object.effectiveConfig);
        }
        else {
        ...
        if (object.defaultConfig !== undefined &&
            ...
            message.defaultConfig = Mysqlconfig80.fromJSON(object.defaultConfig);
        }
        else {
    ...
    fromPartial(object) {
        ...
        if (object.effectiveConfig !== undefined &&
            object.effectiveConfig !== null) {
            message.effectiveConfig = Mysqlconfig80.fromPartial(object.effectiveConfig);
        }
        else {
            message.effectiveConfig = undefined;
        }
        ...
        if (object.defaultConfig !== undefined &&
            object.defaultConfig !== null) {
            message.defaultConfig = Mysqlconfig80.fromPartial(object.defaultConfig);
        }
        else {
            message.defaultConfig = undefined;
        }
