...
exports.Mysqlconfig57 = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.mdbPreserveBinlogBytes !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.mdbPreserveBinlogBytes }, writer.uint32(402).fork()).ldelim();
        }
        if (message.interactiveTimeout !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.interactiveTimeout }, writer.uint32(410).fork()).ldelim();
        }
        if (message.waitTimeout !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.waitTimeout }, writer.uint32(418).fork()).ldelim();
        }
        if (message.mdbOfflineModeEnableLag !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.mdbOfflineModeEnableLag }, writer.uint32(426).fork()).ldelim();
        }
        if (message.mdbOfflineModeDisableLag !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.mdbOfflineModeDisableLag }, writer.uint32(434).fork()).ldelim();
        }
        if (message.rangeOptimizerMaxMemSize !== undefined) {
            wrappers_1.Int64Value.encode({ value: message.rangeOptimizerMaxMemSize }, writer.uint32(442).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
