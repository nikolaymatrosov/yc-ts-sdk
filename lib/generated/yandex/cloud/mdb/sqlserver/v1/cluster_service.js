...
import { Cluster, Host, Resources, Access, cluster_EnvironmentFromJSON, cluster_EnvironmentToJSON, } from '../../../../../yandex/cloud/mdb/sqlserver/v1/cluster';
...
export const ConfigSpec = {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    message.sqlserverConfig2016sp2std =
                        SQLServerConfig2016sp2std.decode(reader, reader.uint32());
                    break;
                case 5:
                    message.sqlserverConfig2016sp2ent =
                        SQLServerConfig2016sp2ent.decode(reader, reader.uint32());
                    break;
                case 3:
    ...
    fromJSON(object) {
        ...
        if (object.sqlserverConfig2016sp2std !== undefined &&
            ...
            message.sqlserverConfig2016sp2std =
                SQLServerConfig2016sp2std.fromJSON(object.sqlserverConfig2016sp2std);
        }
        else {
        ...
        if (object.sqlserverConfig2016sp2ent !== undefined &&
            ...
            message.sqlserverConfig2016sp2ent =
                SQLServerConfig2016sp2ent.fromJSON(object.sqlserverConfig2016sp2ent);
        }
        else {
...
export const ClusterServiceClient = makeGenericClientConstructor(ClusterServiceService, 'yandex.cloud.mdb.sqlserver.v1.ClusterService');
var globalThis = (() => {
