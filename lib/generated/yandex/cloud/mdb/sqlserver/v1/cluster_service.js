...
const backup_1 = require("../../../../../yandex/cloud/mdb/sqlserver/v1/backup");
const cluster_1 = require("../../../../../yandex/cloud/mdb/sqlserver/v1/cluster");
...
const user_1 = require("../../../../../yandex/cloud/mdb/sqlserver/v1/user");
...
(function (ListClusterLogsRequest_ServiceType) {
    ...
    ListClusterLogsRequest_ServiceType[ListClusterLogsRequest_ServiceType["SQLSERVER_ERROR"] = 1] = "SQLSERVER_ERROR";
    /** SQLSERVER_APPLICATION - SQL Server application log. */
    ListClusterLogsRequest_ServiceType[ListClusterLogsRequest_ServiceType["SQLSERVER_APPLICATION"] = 2] = "SQLSERVER_APPLICATION";
...
exports.RestoreClusterRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        Object.entries(message.labels).forEach(([key, value]) => {
            exports.RestoreClusterRequest_LabelsEntry.encode({ key: key, value }, writer.uint32(50).fork()).ldelim();
        });
        if (message.environment !== 0) {
...
exports.ConfigSpec = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.sqlserverConfig2016sp2std !== undefined) {
            sqlserver2016sp2_1.SQLServerConfig2016sp2std.encode(message.sqlserverConfig2016sp2std, writer.uint32(18).fork()).ldelim();
        }
        if (message.sqlserverConfig2016sp2ent !== undefined) {
            sqlserver2016sp2_1.SQLServerConfig2016sp2ent.encode(message.sqlserverConfig2016sp2ent, writer.uint32(42).fork()).ldelim();
        }
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    message.sqlserverConfig2016sp2std =
                        sqlserver2016sp2_1.SQLServerConfig2016sp2std.decode(reader, reader.uint32());
                    break;
                case 5:
                    message.sqlserverConfig2016sp2ent =
                        sqlserver2016sp2_1.SQLServerConfig2016sp2ent.decode(reader, reader.uint32());
                    break;
                case 3:
    ...
    fromJSON(object) {
        ...
        if (object.sqlserverConfig2016sp2std !== undefined &&
            ...
            message.sqlserverConfig2016sp2std =
                sqlserver2016sp2_1.SQLServerConfig2016sp2std.fromJSON(object.sqlserverConfig2016sp2std);
        }
        else {
        ...
        if (object.sqlserverConfig2016sp2ent !== undefined &&
            ...
            message.sqlserverConfig2016sp2ent =
                sqlserver2016sp2_1.SQLServerConfig2016sp2ent.fromJSON(object.sqlserverConfig2016sp2ent);
        }
        else {
    ...
    toJSON(message) {
        ...
        message.sqlserverConfig2016sp2std !== undefined &&
            (obj.sqlserverConfig2016sp2std = message.sqlserverConfig2016sp2std
                ? sqlserver2016sp2_1.SQLServerConfig2016sp2std.toJSON(message.sqlserverConfig2016sp2std)
                : undefined);
        message.sqlserverConfig2016sp2ent !== undefined &&
            (obj.sqlserverConfig2016sp2ent = message.sqlserverConfig2016sp2ent
                ? sqlserver2016sp2_1.SQLServerConfig2016sp2ent.toJSON(message.sqlserverConfig2016sp2ent)
                : undefined);
        message.resources !== undefined &&
    ...
    fromPartial(object) {
        ...
        if (object.sqlserverConfig2016sp2std !== undefined &&
            object.sqlserverConfig2016sp2std !== null) {
            message.sqlserverConfig2016sp2std =
                sqlserver2016sp2_1.SQLServerConfig2016sp2std.fromPartial(object.sqlserverConfig2016sp2std);
        }
        else {
            message.sqlserverConfig2016sp2std = undefined;
        }
        if (object.sqlserverConfig2016sp2ent !== undefined &&
            object.sqlserverConfig2016sp2ent !== null) {
            message.sqlserverConfig2016sp2ent =
                sqlserver2016sp2_1.SQLServerConfig2016sp2ent.fromPartial(object.sqlserverConfig2016sp2ent);
        }
        else {
            message.sqlserverConfig2016sp2ent = undefined;
        }
...
exports.ClusterServiceClient = (0, grpc_js_1.makeGenericClientConstructor)(exports.ClusterServiceService, 'yandex.cloud.mdb.sqlserver.v1.ClusterService');
var globalThis = (() => {
