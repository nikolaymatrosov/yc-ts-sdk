...
exports.DnsZone = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        Object.entries(message.labels).forEach(([key, value]) => {
            exports.DnsZone_LabelsEntry.encode({ key: key, value }, writer.uint32(50).fork()).ldelim();
        });
        if (message.zone !== '') {
...
const baseDnsZone_LabelsEntry = { key: '', value: '' };
...
const baseRecordSet = { name: '', type: '', ttl: 0, data: '' };
exports.RecordSet = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.name !== '') {
...
const basePrivateVisibility = { networkIds: '' };
