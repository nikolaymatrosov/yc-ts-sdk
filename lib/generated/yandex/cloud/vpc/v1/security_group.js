...
export var SecurityGroup_Status;
...
})(SecurityGroup_Status || (SecurityGroup_Status = {}));
export function securityGroup_StatusFromJSON(object) {
    switch (object) {
        case 0:
...
export function securityGroup_StatusToJSON(object) {
    switch (object) {
...
export var SecurityGroupRule_Direction;
...
})(SecurityGroupRule_Direction || (SecurityGroupRule_Direction = {}));
export function securityGroupRule_DirectionFromJSON(object) {
    switch (object) {
        case 0:
...
export function securityGroupRule_DirectionToJSON(object) {
    switch (object) {
...
export const SecurityGroup = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        Object.entries(message.labels).forEach(([key, value]) => {
            SecurityGroup_LabelsEntry.encode({ key: key, value }, writer.uint32(50).fork()).ldelim();
        });
    ...
    fromJSON(object) {
        ...
        if (object.rules !== undefined && object.rules !== null) {
            for (const e of object.rules) {
                message.rules.push(SecurityGroupRule.fromJSON(e));
            }
        }
    ...
    fromPartial(object) {
        ...
        if (object.rules !== undefined && object.rules !== null) {
            for (const e of object.rules) {
                message.rules.push(SecurityGroupRule.fromPartial(e));
            }
        }
        if (object.defaultForNetwork !== undefined &&
            object.defaultForNetwork !== null) {
...
const baseSecurityGroup_LabelsEntry = { key: '', value: '' };
...
export const SecurityGroupRule = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        Object.entries(message.labels).forEach(([key, value]) => {
            SecurityGroupRule_LabelsEntry.encode({ key: key, value }, writer.uint32(26).fork()).ldelim();
        });
...
const baseSecurityGroupRule_LabelsEntry = { key: '', value: '' };
...
const basePortRange = { fromPort: 0, toPort: 0 };
...
const baseCidrBlocks = { v4CidrBlocks: '', v6CidrBlocks: '' };
