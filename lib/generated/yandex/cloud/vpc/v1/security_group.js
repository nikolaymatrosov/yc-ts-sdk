...
exports.SecurityGroup = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        Object.entries(message.labels).forEach(([key, value]) => {
            exports.SecurityGroup_LabelsEntry.encode({ key: key, value }, writer.uint32(50).fork()).ldelim();
        });
...
exports.SecurityGroupRule = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        Object.entries(message.labels).forEach(([key, value]) => {
            exports.SecurityGroupRule_LabelsEntry.encode({ key: key, value }, writer.uint32(26).fork()).ldelim();
        });
