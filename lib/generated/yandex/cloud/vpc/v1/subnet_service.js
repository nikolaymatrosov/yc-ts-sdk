...
export const SubnetServiceService = {
    ...
    addCidrBlocks: {
        ...
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(AddSubnetCidrBlocksRequest.encode(value).finish()),
        requestDeserialize: (value) => AddSubnetCidrBlocksRequest.decode(value),
        responseSerialize: (value) => Buffer.from(Operation.encode(value).finish()),
        responseDeserialize: (value) => Operation.decode(value),
    },
    /**
    ...
    removeCidrBlocks: {
        ...
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(RemoveSubnetCidrBlocksRequest.encode(value).finish()),
        requestDeserialize: (value) => RemoveSubnetCidrBlocksRequest.decode(value),
        responseSerialize: (value) => Buffer.from(Operation.encode(value).finish()),
        responseDeserialize: (value) => Operation.decode(value),
    },
