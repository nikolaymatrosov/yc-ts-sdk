...
export const RouteTable = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        Object.entries(message.labels).forEach(([key, value]) => {
            RouteTable_LabelsEntry.encode({ key: key, value }, writer.uint32(50).fork()).ldelim();
        });
...
const baseRouteTable_LabelsEntry = { key: '', value: '' };
...
export const StaticRoute = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        Object.entries(message.labels).forEach(([key, value]) => {
            StaticRoute_LabelsEntry.encode({ key: key, value }, writer.uint32(26).fork()).ldelim();
        });
        return writer;
    },
    decode(input, length) {
    ...
    fromJSON(object) {
        const message = { ...baseStaticRoute };
        message.labels = {};
        if (object.destinationPrefix !== undefined &&
        ...
        if (object.nextHopAddress !== undefined &&
...
const baseStaticRoute_LabelsEntry = { key: '', value: '' };
