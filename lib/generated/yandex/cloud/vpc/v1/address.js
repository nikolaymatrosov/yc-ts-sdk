...
export function address_TypeFromJSON(object) {
    switch (object) {
        case 0:
...
export function address_TypeToJSON(object) {
    switch (object) {
...
export function address_IpVersionFromJSON(object) {
    switch (object) {
        case 0:
...
export function address_IpVersionToJSON(object) {
    switch (object) {
...
export const Address = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        Object.entries(message.labels).forEach(([key, value]) => {
            Address_LabelsEntry.encode({ key: key, value }, writer.uint32(50).fork()).ldelim();
        });
...
const baseAddress_LabelsEntry = { key: '', value: '' };
...
const baseExternalIpv4Address = { address: '', zoneId: '' };
