...
export var AlertEvaluationStatus;
...
})(AlertEvaluationStatus || (AlertEvaluationStatus = {}));
export function alertEvaluationStatusFromJSON(object) {
    switch (object) {
        case 0:
...
export function alertEvaluationStatusToJSON(object) {
    switch (object) {
...
export const Database = {
    ...
    fromJSON(object) {
        ...
        if (object.monitoringConfig !== undefined &&
            ...
            message.monitoringConfig = MonitoringConfig.fromJSON(object.monitoringConfig);
        }
        else {
    ...
    fromPartial(object) {
        ...
        if (object.monitoringConfig !== undefined &&
            object.monitoringConfig !== null) {
            message.monitoringConfig = MonitoringConfig.fromPartial(object.monitoringConfig);
        }
        else {
            message.monitoringConfig = undefined;
        }
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    message.integerParameterValue =
                        AlertParameter_IntegerParameterValue.decode(reader, reader.uint32());
                    break;
                case 3:
                    message.textParameterValue =
                        AlertParameter_TextParameterValue.decode(reader, reader.uint32());
                    break;
                case 4:
                    message.textListParameterValue =
                        AlertParameter_TextListParameterValue.decode(reader, reader.uint32());
                    break;
                case 5:
                    message.labelListParameterValue =
                        AlertParameter_LabelListParameterValue.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    toJSON(message) {
        ...
        message.doubleParameterValue !== undefined &&
            (obj.doubleParameterValue = message.doubleParameterValue
                ? AlertParameter_DoubleParameterValue.toJSON(message.doubleParameterValue)
                : undefined);
        message.integerParameterValue !== undefined &&
            (obj.integerParameterValue = message.integerParameterValue
                ? AlertParameter_IntegerParameterValue.toJSON(message.integerParameterValue)
                : undefined);
        message.textParameterValue !== undefined &&
        ...
        message.textListParameterValue !== undefined &&
            (obj.textListParameterValue = message.textListParameterValue
                ? AlertParameter_TextListParameterValue.toJSON(message.textListParameterValue)
                : undefined);
        message.labelListParameterValue !== undefined &&
            (obj.labelListParameterValue = message.labelListParameterValue
                ? AlertParameter_LabelListParameterValue.toJSON(message.labelListParameterValue)
                : undefined);
        return obj;
    },
    fromPartial(object) {
...
export const Alert = {
    ...
    fromJSON(object) {
        ...
        if (object.notificationChannels !== undefined &&
            ...
            for (const e of object.notificationChannels) {
                message.notificationChannels.push(NotificationChannel.fromJSON(e));
            }
        }
    ...
    toJSON(message) {
        ...
        if (message.notificationChannels) {
            obj.notificationChannels = message.notificationChannels.map((e) => e ? NotificationChannel.toJSON(e) : undefined);
        }
        else {
            obj.notificationChannels = [];
        }
        if (message.alertParameters) {
            obj.alertParameters = message.alertParameters.map((e) => e ? AlertParameter.toJSON(e) : undefined);
        }
        else {
            obj.alertParameters = [];
        }
        if (message.alertThresholds) {
            obj.alertThresholds = message.alertThresholds.map((e) => e ? AlertParameter.toJSON(e) : undefined);
        }
        else {
            obj.alertThresholds = [];
        }
    ...
    fromPartial(object) {
        ...
        if (object.notificationChannels !== undefined &&
            object.notificationChannels !== null) {
            for (const e of object.notificationChannels) {
                message.notificationChannels.push(NotificationChannel.fromPartial(e));
            }
        }
        if (object.alertParameters !== undefined &&
            object.alertParameters !== null) {
