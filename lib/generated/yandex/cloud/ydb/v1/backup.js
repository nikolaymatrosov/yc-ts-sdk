...
export var BackupSettings_StorageClass;
...
})(BackupSettings_StorageClass || (BackupSettings_StorageClass = {}));
export function backupSettings_StorageClassFromJSON(object) {
    switch (object) {
        case 0:
...
export function backupSettings_StorageClassToJSON(object) {
    switch (object) {
...
export const BackupSchedule = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.recurringBackupSchedule !== undefined) {
            RecurringBackupSchedule.encode(message.recurringBackupSchedule, writer.uint32(34).fork()).ldelim();
        }
    ...
    fromJSON(object) {
        ...
        if (object.recurringBackupSchedule !== undefined &&
            ...
            message.recurringBackupSchedule = RecurringBackupSchedule.fromJSON(object.recurringBackupSchedule);
        }
        else {
