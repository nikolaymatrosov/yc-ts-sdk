...
export const RoleServiceService = {
    ...
    get: {
        ...
        requestSerialize: (value) => Buffer.from(GetRoleRequest.encode(value).finish()),
        requestDeserialize: (value) => GetRoleRequest.decode(value),
        responseSerialize: (value) => Buffer.from(Role.encode(value).finish()),
        responseDeserialize: (value) => Role.decode(value),
    },
    ...
    list: {
        ...
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(ListRolesRequest.encode(value).finish()),
        requestDeserialize: (value) => ListRolesRequest.decode(value),
        responseSerialize: (value) => Buffer.from(ListRolesResponse.encode(value).finish()),
        responseDeserialize: (value) => ListRolesResponse.decode(value),
    },
};
export const RoleServiceClient = makeGenericClientConstructor(RoleServiceService, 'yandex.cloud.iam.v1.RoleService');
var globalThis = (() => {
