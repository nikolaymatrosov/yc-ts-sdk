...
const baseGetServiceAccountRequest = { serviceAccountId: '' };
...
const baseListServiceAccountsResponse = { nextPageToken: '' };
export const ListServiceAccountsResponse = {
    ...
    toJSON(message) {
        ...
        if (message.serviceAccounts) {
            obj.serviceAccounts = message.serviceAccounts.map((e) => e ? ServiceAccount.toJSON(e) : undefined);
        }
        else {
            obj.serviceAccounts = [];
        }
...
const baseCreateServiceAccountMetadata = { serviceAccountId: '' };
...
const baseUpdateServiceAccountMetadata = { serviceAccountId: '' };
...
const baseDeleteServiceAccountRequest = { serviceAccountId: '' };
...
const baseDeleteServiceAccountMetadata = { serviceAccountId: '' };
...
const baseListServiceAccountOperationsResponse = { nextPageToken: '' };
...
export const ServiceAccountServiceService = {
    ...
    get: {
        ...
        requestSerialize: (value) => Buffer.from(GetServiceAccountRequest.encode(value).finish()),
        requestDeserialize: (value) => GetServiceAccountRequest.decode(value),
        responseSerialize: (value) => Buffer.from(ServiceAccount.encode(value).finish()),
        responseDeserialize: (value) => ServiceAccount.decode(value),
    },
    ...
    list: {
        ...
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(ListServiceAccountsRequest.encode(value).finish()),
        requestDeserialize: (value) => ListServiceAccountsRequest.decode(value),
        responseSerialize: (value) => Buffer.from(ListServiceAccountsResponse.encode(value).finish()),
        responseDeserialize: (value) => ListServiceAccountsResponse.decode(value),
    },
    ...
    create: {
        ...
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(CreateServiceAccountRequest.encode(value).finish()),
        requestDeserialize: (value) => CreateServiceAccountRequest.decode(value),
    ...
    update: {
        ...
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(UpdateServiceAccountRequest.encode(value).finish()),
        requestDeserialize: (value) => UpdateServiceAccountRequest.decode(value),
        responseSerialize: (value) => Buffer.from(Operation.encode(value).finish()),
        responseDeserialize: (value) => Operation.decode(value),
    },
    ...
    delete: {
        ...
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(DeleteServiceAccountRequest.encode(value).finish()),
        requestDeserialize: (value) => DeleteServiceAccountRequest.decode(value),
        responseSerialize: (value) => Buffer.from(Operation.encode(value).finish()),
        responseDeserialize: (value) => Operation.decode(value),
    },
    ...
    listOperations: {
        ...
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(ListServiceAccountOperationsRequest.encode(value).finish()),
        requestDeserialize: (value) => ListServiceAccountOperationsRequest.decode(value),
        responseSerialize: (value) => Buffer.from(ListServiceAccountOperationsResponse.encode(value).finish()),
        responseDeserialize: (value) => ListServiceAccountOperationsResponse.decode(value),
    },
};
export const ServiceAccountServiceClient = makeGenericClientConstructor(ServiceAccountServiceService, 'yandex.cloud.iam.v1.ServiceAccountService');
var globalThis = (() => {
