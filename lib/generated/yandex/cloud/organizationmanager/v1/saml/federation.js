...
export function bindingTypeFromJSON(object) {
    switch (object) {
        case 0:
...
export function bindingTypeToJSON(object) {
    switch (object) {
...
export const Federation = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        Object.entries(message.labels).forEach(([key, value]) => {
            Federation_LabelsEntry.encode({ key: key, value }, writer.uint32(106).fork()).ldelim();
        });
        return writer;
    },
    decode(input, length) {
