...
const baseGetFolderRequest = { folderId: '' };
...
const baseListFoldersResponse = { nextPageToken: '' };
...
export const CreateFolderRequest = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        Object.entries(message.labels).forEach(([key, value]) => {
            CreateFolderRequest_LabelsEntry.encode({ key: key, value }, writer.uint32(34).fork()).ldelim();
        });
        return writer;
    },
    decode(input, length) {
...
const baseCreateFolderRequest_LabelsEntry = { key: '', value: '' };
...
const baseCreateFolderMetadata = { folderId: '' };
...
export const UpdateFolderRequest = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        Object.entries(message.labels).forEach(([key, value]) => {
            UpdateFolderRequest_LabelsEntry.encode({ key: key, value }, writer.uint32(42).fork()).ldelim();
        });
        return writer;
    },
    decode(input, length) {
...
const baseUpdateFolderRequest_LabelsEntry = { key: '', value: '' };
...
const baseUpdateFolderMetadata = { folderId: '' };
...
const baseDeleteFolderRequest = { folderId: '' };
...
const baseDeleteFolderMetadata = { folderId: '' };
...
const baseListFolderOperationsResponse = { nextPageToken: '' };
...
export const FolderServiceService = {
    ...
    get: {
        ...
        requestSerialize: (value) => Buffer.from(GetFolderRequest.encode(value).finish()),
        requestDeserialize: (value) => GetFolderRequest.decode(value),
        responseSerialize: (value) => Buffer.from(Folder.encode(value).finish()),
        responseDeserialize: (value) => Folder.decode(value),
    },
    ...
    list: {
        ...
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(ListFoldersRequest.encode(value).finish()),
        requestDeserialize: (value) => ListFoldersRequest.decode(value),
        responseSerialize: (value) => Buffer.from(ListFoldersResponse.encode(value).finish()),
        responseDeserialize: (value) => ListFoldersResponse.decode(value),
    },
    ...
    create: {
        ...
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(CreateFolderRequest.encode(value).finish()),
        requestDeserialize: (value) => CreateFolderRequest.decode(value),
    ...
    update: {
        ...
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(UpdateFolderRequest.encode(value).finish()),
        requestDeserialize: (value) => UpdateFolderRequest.decode(value),
        responseSerialize: (value) => Buffer.from(Operation.encode(value).finish()),
        responseDeserialize: (value) => Operation.decode(value),
    },
    ...
    delete: {
        ...
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(DeleteFolderRequest.encode(value).finish()),
        requestDeserialize: (value) => DeleteFolderRequest.decode(value),
        responseSerialize: (value) => Buffer.from(Operation.encode(value).finish()),
        responseDeserialize: (value) => Operation.decode(value),
    },
    ...
    listOperations: {
        ...
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(ListFolderOperationsRequest.encode(value).finish()),
        requestDeserialize: (value) => ListFolderOperationsRequest.decode(value),
        responseSerialize: (value) => Buffer.from(ListFolderOperationsResponse.encode(value).finish()),
        responseDeserialize: (value) => ListFolderOperationsResponse.decode(value),
    },
...
export const FolderServiceClient = makeGenericClientConstructor(FolderServiceService, 'yandex.cloud.resourcemanager.v1.FolderService');
var globalThis = (() => {
