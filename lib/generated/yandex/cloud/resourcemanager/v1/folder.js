...
export function folder_StatusFromJSON(object) {
    switch (object) {
        case 0:
...
export function folder_StatusToJSON(object) {
    switch (object) {
...
export const Folder = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        Object.entries(message.labels).forEach(([key, value]) => {
            Folder_LabelsEntry.encode({ key: key, value }, writer.uint32(50).fork()).ldelim();
        });
        if (message.status !== 0) {
...
const baseFolder_LabelsEntry = { key: '', value: '' };
