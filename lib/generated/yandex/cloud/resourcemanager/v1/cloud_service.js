...
exports.CreateCloudRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        Object.entries(message.labels).forEach(([key, value]) => {
            exports.CreateCloudRequest_LabelsEntry.encode({ key: key, value }, writer.uint32(34).fork()).ldelim();
        });
        return writer;
    },
    decode(input, length) {
...
const baseCreateCloudRequest_LabelsEntry = { key: '', value: '' };
...
const baseCreateCloudMetadata = { cloudId: '' };
...
exports.UpdateCloudRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        Object.entries(message.labels).forEach(([key, value]) => {
            exports.UpdateCloudRequest_LabelsEntry.encode({ key: key, value }, writer.uint32(42).fork()).ldelim();
        });
        return writer;
    },
    decode(input, length) {
...
const baseUpdateCloudRequest_LabelsEntry = { key: '', value: '' };
