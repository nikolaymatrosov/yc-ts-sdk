...
exports.CreateOriginRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.enabled !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.enabled }, writer.uint32(34).fork()).ldelim();
        }
        if (message.backup !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.backup }, writer.uint32(42).fork()).ldelim();
        }
