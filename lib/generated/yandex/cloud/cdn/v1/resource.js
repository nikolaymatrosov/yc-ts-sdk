...
exports.ResourceOptions_StringsMapOption = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        Object.entries(message.value).forEach(([key, value]) => {
            exports.ResourceOptions_StringsMapOption_ValueEntry.encode({ key: key, value }, writer.uint32(18).fork()).ldelim();
        });
        return writer;
    },
    decode(input, length) {
...
exports.ResourceOptions_CachingTimes = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        Object.entries(message.customValues).forEach(([key, value]) => {
            exports.ResourceOptions_CachingTimes_CustomValuesEntry.encode({ key: key, value }, writer.uint32(18).fork()).ldelim();
        });
        return writer;
    },
    decode(input, length) {
...
exports.ResourceOptions_StringVariableMapOption = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        Object.entries(message.value).forEach(([key, value]) => {
            exports.ResourceOptions_StringVariableMapOption_ValueEntry.encode({ key: key, value }, writer.uint32(18).fork()).ldelim();
        });
        return writer;
    },
    decode(input, length) {
