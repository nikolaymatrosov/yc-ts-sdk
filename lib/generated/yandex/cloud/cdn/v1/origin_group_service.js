...
exports.CreateOriginGroupRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.useNext !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.useNext }, writer.uint32(26).fork()).ldelim();
        }
...
exports.UpdateOriginGroupRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.groupName !== undefined) {
            wrappers_1.StringValue.encode({ value: message.groupName }, writer.uint32(26).fork()).ldelim();
        }
        if (message.useNext !== undefined) {
            wrappers_1.BoolValue.encode({ value: message.useNext }, writer.uint32(34).fork()).ldelim();
        }
        for (const v of message.origins) {
